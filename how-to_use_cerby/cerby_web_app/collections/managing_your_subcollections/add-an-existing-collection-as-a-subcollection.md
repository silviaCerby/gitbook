...
4. Click the **More** **options** (<img src="../../../../../.gitbook/assets/unnamed_65.png" alt="">) icon. A menu is displayed.
  1. Alternatively, click the **Settings** (<img src="../../../../../.gitbook/assets/unnamed_66.png" alt="">) icon from the corresponding collection card. The collection detail page is displayed with the **General** tab activated.
