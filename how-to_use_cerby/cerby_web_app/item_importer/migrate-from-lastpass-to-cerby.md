...
To import LastPass folders and items to Cerby, you must complete the following main steps:
  ...
  1. [Select your login method for LastPass](migrate-from-lastpass-to-cerby.md#id-1.-select-your-login-method-for-lastpass)
  2. [Import folders, subfolders, and items to Cerby](migrate-from-lastpass-to-cerby.md#id-2.-import-folders-subfolders-and-items-to-cerby)
  3. [Review the import report](migrate-from-lastpass-to-cerby.md#id-3.-review-the-import-report)
  4. [Take action on onboarded items](migrate-from-lastpass-to-cerby.md#id-4.-take-action-on-onboarded-items)
...
The import process is different depending on the login method for your LastPass account. Cerby supports the following methods:
  ...
  * [SSO authentication](migrate-from-lastpass-to-cerby.md#h_671b214494)
  * [Standard login](migrate-from-lastpass-to-cerby.md#h_a273caccec)
...
To select SSO authentication as your login method and start the import, you must complete the following steps:
  ...
  7. Click the **Review** button. One of the following scenarios occur depending on whether you have an active session in your IdP instance or not:
     ...
     * **Active session:** The Cerby browser extension identifies your login information and saves a hidden LastPass SSO account in your Cerby workspace. The **Verify Cerby’s location** page of the wizard is displayed.
       ...
       1. Continue to step [2. Import folders, subfolders, and items to Cerby](migrate-from-lastpass-to-cerby.md#id-2.-import-folders-subfolders-and-items-to-cerby).
     ...
     * **Inactive session:** Your IdP’s login page is displayed.
       ...
       2. Continue to step [2. Import folders, subfolders, and items to Cerby](migrate-from-lastpass-to-cerby.md#id-2.-import-folders-subfolders-and-items-to-cerby).
...
<img src="../../../../.gitbook/assets/AD_4nXegXbzS-UiaQCyC1knqUoa5LM6PNQ83F_oBCruIaxeVNf8m2WzqgvTLWX3DsBBMOZmidYPOMFOjxeb2Oosz4KPfmpGV89sE6XlxwC-R-nrAhTUN5bxqguFV8RuEvqZ0_ryrJmN8Jt1L1ODONoCqR-SoWH0.png" alt="">
...
**Figure 1.** **Enter your login credentials** page of the Password Manager Importer wizard
  ...
  10. Continue to step [2. Import folders, subfolders, and items to Cerby](migrate-from-lastpass-to-cerby.md#id-2.-import-folders-subfolders-and-items-to-cerby).
...
<img src="../../../../.gitbook/assets/AD_4nXfTU1Gk1g5ddUfEM3Blhe9_cbZxvVVPTljomVLMFpne68WXHup77KoLp9bfyjV48FM4jokL-Dnm33KDXxZ_kXH-45BT2cfWFmt29h0vP7jQzzJmd8XgCHSRcRT90FSZwzg33nXnKQNskygDTSREGENNLAKR.png" alt="">
...
The next step is [3. Review the import report](migrate-from-lastpass-to-cerby.md#id-3.-review-the-import-report), which you must complete from the **Import Report** view.
...
<img src="../../../../.gitbook/assets/98952b62-487a-403b-b0a4-f1172450ae73.png" alt="Screenshot of the Cerby dashboard with the Import report view open and displaying the report of items imported from a password manager to Cerby.">
...
To add the missing account details, you must complete the following steps:
  ...
  3. Click the **Edit** (<img src="../../../../.gitbook/assets/unnamed_19.png" alt="">) icon of the corresponding field to make it editable.
  4. Enter the information in the field.
  5. Click the **Done** (<img src="../../../../.gitbook/assets/unnamed_20.png" alt="">) icon to save the changes.
...
<img src="../../../../.gitbook/assets/ESgI82C2Vy-w9Wm_dE5WTyVXig3TtcwSMw_XzJd4pGHWTFXCm0KfPWXZ-nsBRZqJgqot1gp3jYzb3XKhwVUWjsGVEM1xSF22l5Oy9Os7e3K6e1cNai3fFuDqj2cTjBI7_X5Vh9J3czzE1lWTWt5Ma5Y.png" alt="">
...
To import the missing team members in bulk from LastPass to their corresponding teams, you must complete the following main steps:
  ...
  1. [Generate a CSV file](migrate-from-lastpass-to-cerby.md#id-1.-generate-a-csv-file)
  2. [Import team members with a CSV file](migrate-from-lastpass-to-cerby.md#id-2.-import-team-members-with-a-csv-file)
