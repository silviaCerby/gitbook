...
With Cerby, all users within a workspace, regardless of their role, have a secure and centralized way to store and view messages sent to the Cerby-managed email addresses they create and set up for their accounts.

The Cerby inbox is a feature that enables you to perform some of the automated tasks to log in to your accounts when a Cerby-managed email address is configured as a verification method for multi-factor authentication (MFA).

However, in some cases, you or your colleagues may need to take action on the messages. For example, when you are asked to verify a login attempt or want to reply to the sender. In this scenario, you can forward the message to yourself or your colleagues, and only to an email address linked to a Cerby account.

{% hint style="danger" %}


**IMPORTANT:** SMS forwarding is limited to email messages in the Cerby inbox.
...
To forward a message from your Cerby inbox, you must complete the following steps:
  ...
  3. Select the corresponding option from the**Forward to** drop-down list:
     ...
     **NOTE:** For the **Selected distribution list** and **Selected users** options,**a search bar is displayed to search** for distribution lists and users, respectively.

  4. Click the **Forward Message** button. The dialog box closes, and a success message box is displayed, with the message sent to the email address of the selected recipient.
