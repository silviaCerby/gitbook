...
2. Click the **Settings** (<img src="../../../../.gitbook/assets/unnamed_51.png" alt="">) icon of the corresponding account card. The account details page is displayed with the **Settings** tab activated.
3. Activate the **Teams** tab. The **Teams** section is displayed with a table of teams who have shared access to the account.
4. Click the **More options** (<img src="../../../../.gitbook/assets/unnamed_52.png" alt="">) icon of the corresponding team. A drop-down list is displayed.
