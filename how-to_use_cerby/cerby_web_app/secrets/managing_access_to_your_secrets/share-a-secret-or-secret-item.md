...
intercom_id: 8705424
description: >-
  This article describes how to share a secret or secret item with other
...
3. Click the **Share secret** (![](../../../../.gitbook/assets/unnamed_60.png)) icon of the corresponding secret card. A drop-down list is displayed.
...
5. Tap the **Share** (![](../../../../.gitbook/assets/unnamed_60.png)) icon on Android or the **Share** (![](../../../../.gitbook/assets/unnamed_62.png)) icon on iOS located at the top right of the screen. The **Share item** screen is displayed.
...
To share access to a secret or secret item with external users via a link, follow the instructions in the article [How to share items with external users via a link](https://help.cerby.com/en/articles/8308908-how-to-share-items-with-external-users-via-a-link).
