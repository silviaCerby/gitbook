...
3. Click the **Settings** (<img src="../../../../.gitbook/assets/unnamed_53.png" alt="">) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
