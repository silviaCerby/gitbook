...
3. Click the **Settings** (<img src="../../../../.gitbook/assets/unnamed_46.png" alt="">) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
...
5. Click the **More options** (<img src="../../../../.gitbook/assets/unnamed_47.png" alt="">) icon of the corresponding team. A drop-down list is displayed.
