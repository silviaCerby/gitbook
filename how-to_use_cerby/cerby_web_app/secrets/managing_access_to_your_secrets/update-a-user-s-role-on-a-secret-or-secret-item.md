...
intercom_id: 9483752
description: >-
  This article describes how to update the role of other workspace members on
  your secrets and secret items.
---
...
* **NOTE:** For the Cerby mobile app, read the article [Update a user’s role on a secret using the Cerby mobile app](https://help.cerby.com/en/articles/9742174-update-a-user-s-role-on-a-secret-using-the-cerby-mobile-app)
{% endhint %}
...
3. Click the **Settings** (![](../../../../.gitbook/assets/unnamed.png)) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
...
2. Activate the **Members** tab. The **User Overview** section is displayed with a table of users who have shared access to the secret or secret item.
3.  Select the option from the **Cerby role** drop-down list that corresponds to the new role on the secret or secret item:
