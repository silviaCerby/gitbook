...
3. Click the **Settings** (<img src="../../../../.gitbook/assets/unnamed_48.png" alt="">) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
...
5. Click the **More options** (<img src="../../../../.gitbook/assets/unnamed_49.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
