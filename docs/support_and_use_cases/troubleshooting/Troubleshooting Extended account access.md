...
To sync only one extended account, you must complete the following steps:
  ...
  4. Click the **More options** (![](images/AD_4nXf8BKn1FJnO-TOXXSKtLrD5oRk7pbik2EkBDYcxtg6izQkqBbqt6-6_nKvzIvOl90pJUKl2A_1WhNyZbG6-ntYPVONmHk0GudUNDJGTnnA2VTA3flhq60eOEILNrG8Y644yQppSJd8RZfyBljiuEEKnDOyo)) icon. A drop-down list is displayed.
