...
For instructions on configuring a Cerby-managed email address, read the article [Set up and associate a Cerby-managed email address for your account](https://help.cerby.com/en/articles/5457533-release-notes-march-30-2021).
...
**NOTE:** To turn on MFA manually, follow the instructions in the video [How to turn on MFA manually for your accounts](https://help.cerby.com/en/articles/6393776-video-how-to-turn-on-mfa-manually-for-your-accounts) or the article [How to use two-factor authentication](https://help.x.com/en/managing-your-account/two-factor-authentication) in the X Help Center.
...
For more information on the logging-in process, see the video [How to log in to your accounts with username and password using the Cerby mobile app](https://help.cerby.com/en/articles/5620250-video-how-to-log-in-to-your-accounts-with-username-and-password-using-the-cerby-mobile-app).
