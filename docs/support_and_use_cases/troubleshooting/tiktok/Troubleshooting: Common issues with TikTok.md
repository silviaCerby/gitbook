...
TikTok is one of the apps supported by Cerby, with an automation workflow to
turn on multi-factor authentication (MFA) by simply activating a switch in the
**Settings** tab of the account details page.
