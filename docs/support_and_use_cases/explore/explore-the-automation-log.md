...
**IMPORTANT:** You must be a workspace **Owner** , **Super** **Admin** , or **Admin** to access the Automation Log.
...
<figure><img src="../../../.gitbook/assets/image_18.png" alt="Screenshot of the Cerby web app dashboard. The Automation Log page is displayed with a table of automation jobs and their status"><figcaption></figcaption></figure>
...
* [Filter jobs in the Automation Log](https://cerby-test.gitbook.io/cerby-test/management/automation-log/filter-jobs-in-the-automation-log)
* [View the details of a nested job in the Automation Log](https://cerby-test.gitbook.io/cerby-test/management/automation-log/view-the-details-of-a-nested-job-in-the-automation-log)
