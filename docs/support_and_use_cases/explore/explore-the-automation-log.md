...
<img src="../../../.gitbook/assets/image_18.png" alt="Screenshot of the Cerby web app dashboard. The Automation Log page is displayed with a table of automation jobs and their status">
