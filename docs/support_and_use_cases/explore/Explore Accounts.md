...
encryption scheme chosen by your organization: cloud and local encryption. If
you would like more information about our encryption schemes, you can read the
...
All users, except those with the **Login-only** or **Guest user** role, can
...
accounts in the **All accounts** page of the Cerby web app dashboard.

![](images/T08O8UyQMj8nlwBP6IvFUSbgsZE7ee3C2GKACLugboVd5011viRyjua-
Yl8N7cyT6pUFGTMwUb5gcH7O7S9VhOy8WF4C2t1CFS9bUNtnWRlHQvhT7_me0C2mjp4wuMQQUE51Y15B1rhpxxqkYAEsTCw)

**Figure 1.** Account cards in the **All accounts** page of the Cerby web app
dashboard
...
extension automatically fills in your credentials. If you have multi-factor
authentication (MFA) managed by Cerby, the verification codes are also
...
catalog. If you would like us to support a specific application or service
provider, please send your request via email to the Customer Support team at
...
URL and on how complex the app’s user interface is. If you would like us to
support a specific app or service provider, please send your request via email
to the Customer Support team at [support@cerby.com](mailto:support@cerby.com).  
---  
...
No URL accounts are for non-integrated apps that you access locally, not
through a website. Therefore, when you add them to Cerby, the login URL is not
mandatory, and the rest of the account details are optional.

Some apps that can be accessed without a URL account are hardware devices and
desktop applications. Cerby doesn’t support security automated tasks for these
accounts. No URL accounts are identified visually in the Cerby dashboard, as
shown in **Figure 2**.
