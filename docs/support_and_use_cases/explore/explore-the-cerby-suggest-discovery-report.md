...
* Only available for Cerby Suggest


{% endhint %}

As a workspace **Owner** , **Admin** , or **Super** **Admin** with [Cerby Suggest](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-cerby-suggest) enabled, you can use the Discovery Report to gain insights into user interactions. These interactions are captured by Cerby Suggest when users engage with the dialog box shown while attempting to create an account for a sanctioned app. The report collects data on all login and signup events detected by Cerby Suggest based on the app domain or URL visited. As a result, you can track and monitor application usage across your organization, ensure compliance, and identify any potential gaps.
...
To see the details of the events in the Discovery Report, you must complete the following steps:
...
To download a CSV file of the Discovery Report for Cerby Suggest, you must complete the following steps:

**IMPORTANT:** This feature is temporarily unavailable in Cerby. The Cerby team is working on restoring this known issue. If you need support, contact us at [support@cerby.com](mailto:support@cerby.com).
---
