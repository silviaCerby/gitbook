...
![Screenshot of
Scout](images/AD_4nXdXAu1YH2unkib1NWwfAVlMDE58bdxT_bF8Hu74ZLo5VJXkEgA4lSEF2psFPE4FBvMbJrARdA3YavybL1tARO5zQ4zpBJwKeC33zIywNq8IoUqwsFXOu4ADy7yqCnPdR_Y9GdRPfjdluC_WgjD9o3_Q4qNa)
...
workloads; therefore, we aim to alleviate that burden. Scout allows us to work
asynchronously with our customers on their schedule, not ours. We believe in
effective collaboration without requesting direct access to your applications
...
The following are the best scouting practices and general tips for scouting
your workflows:
...
secret key or token. If this option is unavailable, complete the setup as your
app requires.
...
seat-based or paid social app, view the table of users with a seat in your
app, and access your assets, if applicable.
...
{% hint style="danger" %} **IMPORTANT:** If your app supports assets that are
relevant to your team, scout all actions from steps 2 to 6 by navigating to
the table of users and assets. Preferably, scout the flow of only granting
access to an asset for an existing user. {% endhint %}
...
{% hint style="danger" %} **IMPORTANT:** If your app supports assets and they
are relevant to your team, record all actions from steps 2 to 6 by navigating
to the tables of users and assets. Preferably, scout the flow of only updating
the role of an existing user on an asset. {% endhint %}
...
{% hint style="danger" %} **IMPORTANT:** If your app supports assets and they
are relevant to your team, record all actions from steps 2 to 6 by navigating
to the tables of users and assets. Preferably, scout the flow of only removing
access to an asset for an existing user. {% endhint %}
