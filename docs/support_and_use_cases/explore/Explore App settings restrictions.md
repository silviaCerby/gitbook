...
{% hint style="danger" %} **IMPORTANT:** Any password or member settings
restrictions apply only to workspace **Users**. Workspace **Owners** ,
**Admins** , and **Super** **Admins** are unaffected by these restrictions. {%
endhint %}
...
{% hint style="danger" %} **IMPORTANT:** For the feature to work correctly,
users must have the Cerby browser extension installed and logged in. It is not
available in the Cerby mobile app. {% endhint %}
...
![](images/AD_4nXcpXX2h0-mX2YAXDEY5rfBM_WooymhgXM-
qOqBA13ZhWKmf7wQFAOetVCy9tDIsEvRXaZ3kDjFfCX0TkHqifwgBEEcSdjlXP-
ge082Ov8EA_TN8K4fS8Ms8mBep3Yvz8xO9kPYOgQ)

**Figure 1.** Error messages displayed in the app when the password or user
...
![](images/AD_4nXfaiXcSIMQMFiRFQitwVVUspwp3t_k5kzBZtLRoHjrlP7KQQm126J-iu_POe71M-8Za0iCmZTPxMHQjYC5tm3R-5Xk3pvgsG4bSq4x2BZQYz_czZph2Sx9OuzWSePQOxHWlzEdKlA)

**Figure 2.** Information messages displayed in the app when the password and
user settings are recommended to be modified on Cerby
