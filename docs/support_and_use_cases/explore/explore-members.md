...
Meanwhile, user accounts in local user workspaces are provisioned by Cerby and managed by IT admins. For more information, read the article[ How to create and configure a local user workspace](https://help.cerby.com/en/articles/8011381-how-to-create-and-configure-a-local-user-workspace).
...
For more information about roles, read the article [How Cerby manages roles](https://help.cerby.com/en/articles/8500649-how-cerby-manages-roles?q=universal+logout).
