...
For more information about this report, read the article [Explore the Cerby Suggest Discovery Report](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-the-cerby-suggest-discovery-report).
...
Now that you know the basic concepts of Cerby Suggest, get to know more of the actions end users can perform with Cerby Suggest in the [Get started as a Cerby Suggest user](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/use-cases/get-started-as-a-cerby-suggest-user) article.
...
To add and manage a team, follow the instructions in the article [How to use Teams](https://cerby-test.gitbook.io/cerby-test/management/workspace-configuration/user-management/teams/how-to-use-teams). You can also see the video [How to add a self-managed team](https://cerby-test.gitbook.io/cerby-test/management/workspace-configuration/user-management/teams/video-how-to-add-a-self-managed-team).
