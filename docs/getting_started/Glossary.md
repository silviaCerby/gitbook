...
It is an account-level role with basic permissions to log in to the accounts added to Cerby and with the roles assigned to those accounts. For the detailed permissions of this role, read the [Accounts](https://help.cerby.com/en/articles/8500649-how-cerby-manages-roles#h_1745875704) section in the article [How Cerby manages roles](https://help.cerby.com/en/articles/8500649-how-cerby-manages-roles).

## Account Owner

It is an account-level role with permissions to manage the accounts added to Cerby and their security and also manage the **Account Collaborators**. For the detailed permissions of this role, see the [Accounts](https://help.cerby.com/en/articles/8500649-how-cerby-manages-roles#h_1745875704) section in the article [How Cerby manages roles](https://help.cerby.com/en/articles/8500649-how-cerby-manages-roles).
