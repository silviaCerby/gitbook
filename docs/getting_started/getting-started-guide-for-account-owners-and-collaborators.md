...
Let’s get started. This guide contains the following sections:
  ...
  * [How do I set up Cerby?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-set-up-cerby)
  * [How do I add my accounts?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-add-my-accounts)
  * [How do I protect my accounts?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-protect-my-accounts)
  * [How do I share an account?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-share-an-account)
  * [How do I delete an account?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-delete-an-account)
  * [How do I receive notifications on my mobile phone?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-receive-notifications-on-my-mobile-phone)
  * [How do I log in to my apps using the Cerby mobile app?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-log-in-to-my-apps-using-the-cerby-mobile-app)
  * [How do I see activity on my accounts?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-see-activity-on-my-accounts)
* * *
...
The following are the instructions you must follow depending on the type of account:
  ...
  * [Add a regular account](getting-started-guide-for-account-owners-and-collaborators.md#add-a-regular-account)
  * [Add a business center account](getting-started-guide-for-account-owners-and-collaborators.md#add-a-business-center-account)
...
**Figure 2. Select App Page of the Add Account Wizard**
  ...
  **NOTE:** If you see the **Next** button instead of **Finish** , perform the following actions:
  ...
  5. Enable at least one additional management factor through Cerby by following the corresponding instructions in the [How Do I Protect My Accounts?](getting-started-guide-for-account-owners-and-collaborators.md#how-do-i-protect-my-accounts) section.
...
With your apps added, why not shield them? The following are the instructions you must follow to protect your accounts through Cerby:
  ...
  * [Create a Cerby-managed email address](getting-started-guide-for-account-owners-and-collaborators.md#create-a-cerby-managed-email-address)
  * [Create a Cerby-managed phone number](getting-started-guide-for-account-owners-and-collaborators.md#create-a-cerby-managed-phone-number)
  * [Turn on MFA automatically and manually](getting-started-guide-for-account-owners-and-collaborators.md#turn-on-mfa-automatically-and-manually)
  * [Rotate passwords automatically](getting-started-guide-for-account-owners-and-collaborators.md#rotate-passwords-automatically)
...
We have the following two features ready for you:
  ...
  * [Share an individual account](getting-started-guide-for-account-owners-and-collaborators.md#share-an-individual-account)
  * [Create and share a collection](getting-started-guide-for-account-owners-and-collaborators.md#create-and-share-a-collection)
  * [Share a business center account](getting-started-guide-for-account-owners-and-collaborators.md#share-a-business-center-account-and-assets)
