...
As a user with the **Account Owner** or **Account Collaborator** role, you can access the following features of Cerby:
...
Let’s get started. This guide contains the following sections:
  ...
  * [How do I set up Cerby?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-set-up-cerby)
  * [How do I add my accounts?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-add-my-accounts)
  * [How do I protect my accounts?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-protect-my-accounts)
  * [How do I share an account?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-share-an-account)
  * [How do I delete an account?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-delete-an-account)
  * [How do I receive notifications on my mobile phone?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-receive-notifications-on-my-mobile-phone)
  * [How do I log in to my apps using the Cerby mobile app?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-log-in-to-my-apps-using-the-cerby-mobile-app)
  * [How do I see activity on my accounts?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-see-activity-on-my-accounts)
* * *

## How Do I Set Up Cerby?

As an account owner or collaborator, the access to your team’s workspace in Cerby is ready, you only have to use your corporate identity with your configured single sign-on (SSO) provider. However, you must complete the following three steps to set up Cerby:

1. [Log in with my corporate identity](getting-started-guide-for-account-owners-and-collaborators.md#id-1.-log-in-with-my-corporate-identity)
2. [Install the Cerby browser extension](getting-started-guide-for-account-owners-and-collaborators.md#id-2.-install-the-cerby-browser-extension)
3. [Install the Cerby mobile app](getting-started-guide-for-account-owners-and-collaborators.md#id-3.-install-the-cerby-mobile-app)
...
<img src="../../.gitbook/assets/hRY7FOk9HfKptJJ2dSZXRN7uPGw4HHODSc6XeXk5SnWJlDiylFFjga86zRGvDFX4lTYhDBuXTBDiQuYSwAGSHnBznbsXMLfo6vQ_DRYzu6rNttab51LBn13ZUbdSVSKU3LuxVelHebGVRRVlPw.png" alt="">
...
Verify with your IT team to determine for which browsers the Cerby extension has been approved. Then, log in and complete the following steps in that browser:
...
**TIP:** For more instructions to install the browser extension, see the [How to install the Cerby browser extension](https://cerby-test.gitbook.io/cerby-test/getting-started/cerby-browser-extension/video-how-to-install-the-cerby-browser-extension) video.

Now you have set up Cerby on your desktop computer. Proceed with the next step to use Cerby on your mobile phone.
...
**IMPORTANT:** Click the **Allow** button if a dialog box appears asking you to allow notifications.
...
8. Select Cerby as the autofill service for your device. This process is different depending on your operating system:
   ...
   * Android
     ...
     **TIP:** To navigate to the **Autofill screen** easily, you can use the search bar from the **Settings** screen.

2. Select the **Cerby** option from the list.

**TIP:** For more instructions to install the mobile application, see the [How to install and set up the Cerby mobile application](https://cerby-test.gitbook.io/cerby-test/getting-started/cerby-mobile-app/video-how-to-install-and-set-up-the-cerby-mobile-app) video.
...
Cerby helps you manage and access the accounts of the apps you use, but first, you must add them. We have the **Add Account** wizard ready to guide you through the process.

The following are the instructions you must follow depending on the type of account:

  * [Add a regular account](getting-started-guide-for-account-owners-and-collaborators.md#id-add-a-regular-account)
  * [Add a business center account](getting-started-guide-for-account-owners-and-collaborators.md#id-add-a-business-center-account)
...
<img src="../../.gitbook/assets/1ek1ZWST49BcWaaKe699XYoQRdngLT4koCDjjW-rpWlceqU25TPmakh-6Wje7pnfGlI4b_EkxwID1R1LVIg-9ggWkKabVHnkbv1hUx331O-vdYSBcCtpoZV6aHMZxqXp_7qGlwD1rKbiB0cKfA.png" alt="">
...
**Figure 2. Select App Page of the Add Account Wizard**
  ...
  3. Enter your account information in the corresponding fields:
     ...
     **NOTE:** The email and phone number fields may be mandatory or optional depending on the app. However, we highly recommended to include them in all cases.
  ...
  **NOTE:** If you see the **Next** button instead of **Finish** , perform the following actions:
  ...
  5. Enable at least one additional management factor through Cerby by following the corresponding instructions in the [How Do I Protect My Accounts?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-protect-my-accounts) section.

### Add a Business Center Account

Business center accounts enable you to manage provisioning and deprovisioning of access to your pages and assets in social media from Cerby.

To add business center accounts, complete the corresponding detailed instructions we prepared for you in our Help Center:
...
With your apps added, why not shield them? The following are the instructions you must follow to protect your accounts through Cerby:

  * [Create a Cerby-managed email address](getting-started-guide-for-account-owners-and-collaborators.md#id-create-a-cerby-managed-email-address)
  * [Create a Cerby-managed phone number](getting-started-guide-for-account-owners-and-collaborators.md#id-create-a-cerby-managed-phone-number)
  * [Turn on MFA automatically and manually](getting-started-guide-for-account-owners-and-collaborators.md#id-turn-on-mfa-automatically-and-manually)
  * [Rotate passwords automatically](getting-started-guide-for-account-owners-and-collaborators.md#id-rotate-passwords-automatically)

### Create a Cerby-Managed Email Address

Cerby provides and manages securely generated email addresses you can use for your accounts and across your organization.

By managing this service, Cerby can improve the logging-in process of your applications by automatically filling your verification codes when MFA is turned on with an email address as a verification method. These codes are retrieved from your **Shared Inbox** in Cerby.

You can create a Cerby-managed email address through the web app after adding an account to Cerby.
...
Cerby provides and manages securely generated phone numbers you can use for your accounts and across your organization.

By managing this service, Cerby can improve the logging-in process of your applications by automatically filling your verification codes when MFA is turned on with a phone number as a verification method. These codes are retrieved from your **Shared Inbox** in Cerby.

You can only create a Cerby-managed phone number through the web app after adding an account to Cerby.
...
Cerby helps you implement MFA to improve the security of your accounts significantly.

You can configure the Cerby mobile app as an authenticator and use Cerby-managed email addresses and phone numbers as verification methods to improve your logging-in process and secure your accounts.

Unlike other authenticator apps, when you turn on MFA with Cerby, verification codes are distributed to all the account members whenever they need them.
...
To turn on MFA for your accounts, you have the following options:
  ...
  * Using Cerby-managed email addresses or phone numbers as verification methods
    ...
    1. Go to the account settings of your app.
    2. Create the email address or phone number through Cerby by following the corresponding instructions in the [Create a Cerby-managed email address](getting-started-guide-for-account-owners-and-collaborators.md#id-create-a-cerby-managed-email-address) and [Create a Cerby-managed phone number](getting-started-guide-for-account-owners-and-collaborators.md#id-create-a-cerby-managed-phone-number) sections.
    ...
    **NOTE:** After turning on MFA manually and configuring the authenticator and verification methods with Cerby, you will be able to retrieve verification codes from the Cerby browser extension or the Cerby mobile app when logging in to their apps.

### Rotate Passwords Automatically

Cerby can rotate passwords automatically, with a single click, and provide secure and robust new passwords for your accounts. This feature is only enabled for supported apps through the Cerby web app.
...
Your accounts are now protected with security best practices. Don’t wait more; start sharing them securely with your team members through Cerby to improve collaboration.

We have the following two features ready for you:

  * [Share an individual account](getting-started-guide-for-account-owners-and-collaborators.md#id-share-an-individual-account)
  * [Create and share a collection](getting-started-guide-for-account-owners-and-collaborators.md#id-create-and-share-a-collection)
  * [Share a business center account](getting-started-guide-for-account-owners-and-collaborators.md#id-share-a-business-center-account-and-assets)

### Share an Individual Account

Cerby enables you to share an existing individual account with another user from your workspace through the Cerby web app.
...
Cerby enables you to create collections to group your accounts and share access to them with one or multiple users at a time. Collections also help you keep your accounts organized in the dashboard.
...
To create and share a collection, complete the following steps:
  ...
  **TIP:** You can use the search bars to look for specific accounts both in the **All accounts** and **Added accounts** lists.

  6. Click the **Share Collection** button after you completed adding accounts. The **Share Collection** page is displayed.

  **NOTE:** If you click the **Create Collection** button, the collection is created and will only be visible to you. You can share the collection later with other team members by clicking the **Settings** button of the collection and selecting the **Share Collection** option. The **Share Collection** wizard is displayed, and you can follow steps 7 to 11 to complete the process.
...
When you share a business center account with your team members, you must first share access to the business center and later to its assets, such as ad accounts, pixels, and pages.
...
When you no longer need to manage an account through Cerby, you can delete it from the dashboard.
...
To delete an account, complete the following steps:
  ...
  **IMPORTANT:** To confirm your identity, you must have installed and logged in to the Cerby mobile app to receive push notifications. For more information, see the [How do I receive notifications on my mobile phone?](getting-started-guide-for-account-owners-and-collaborators.md#id-how-do-i-receive-notifications-on-my-mobile-phone) section.
  ...
  **IMPORTANT** : If you don’t receive a push notification on your Cerby mobile app, log out of your Cerby mobile app and log back in. This will re-register your mobile phone so Cerby knows where to send the push notification.
  ...
  **NOTE:** When you delete an account, we temporarily store the last account password in the account configuration. This is done for your convenience when offboarding accounts from Cerby. Also, for reference, you can see the past activity of your account through the **Activity** view.

* * *

## How Do I Receive Notifications on My Mobile Phone?

This is a general section on receiving notifications on your mobile phone via the Cerby mobile app.

To receive notifications, complete the following steps:

  1. Ensure you have installed the Cerby Mobile app. See the instructions in the [3. Install the Cerby Mobile App](getting-started-guide-for-account-owners-and-collaborators.md#id-3.-install-the-cerby-mobile-app) section.
...
Now, you will receive notifications from Cerby during key actions that require you to confirm your identity.

* * *

## How Do I Log In to My Apps Using the Cerby Mobile App?

The Cerby mobile app helps you easily log in to your apps by auto-filling the credentials of the accounts you added to Cerby.

To log in to your apps, complete the following steps depending on your operating system:
  ...
  * iOS
    ...
    **NOTE:** Depending on the app, you may have to click a button to move to the next screen to fill all of the input fields. Repeat steps 3 and 4 as necessary, and ensure you select the same account in Cerby to autofill.

    5. Click the **Log in** button.

    **NOTE:** For accounts with MFA turned on, you may have to enter the verification code in an additional screen. Perform the following actions to retrieve the code depending on your verification method:
  ...
  * Android
    ...
    **NOTE:** For accounts with MFA turned on, you may have to enter the verification code in an additional screen. Perform the following actions to retrieve the code depending on your verification method:
       ...
       **TIP:** For more instructions to log in to your mobile apps, see the [How to log in to your Cerby-managed accounts on mobile](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-mobile-app/accounts/video-how-to-log-in-to-your-accounts-with-username-and-password-using-the-cerby-mobile-app) video.

* * *

## How Do I See Activity on My Accounts?

The **Activity** view, as shown in **Figure 5** , contains information about user activity within a workspace. As an account owner or collaborator, you can see the activity of the accounts for which you are an owner.

<img src="../../.gitbook/assets/9d7i67X8iIC-q4j_-LxZSJOlAKSW950JkpU5POVl6cN9MUJJUmkEHIgk9qJE6kkQf9Wpl4nmcCfnIt9Vw0cF4qEkPyQDvOTe4IvGBm-YJ9u38IUPtaug5IBsG6djGyEdCMqY5gztJIPHuT5Obw.png" alt="">

**Figure 5. Activity View of the Cerby Dashboard**

Just click the **Activity** button from the left navigation drawer to display the Activity view. You can perform the following actions from this view:
