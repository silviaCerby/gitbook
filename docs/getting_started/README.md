...
intercom_id: 6395363
description: >-
  This article describes the key steps you must perform to start using Cerby as
  an account owner or collaborator.
---
...
* **Browser extension:** It enables you to log in to your accounts by automatically filling the credentials you store in Cerby in the corresponding fields of your apps. It also helps automate all of the security hygiene tasks available in Cerby. The Cerby browser extension is available for the following browsers:
...
* [How do I set up Cerby?](./#how-do-i-set-up-cerby)
* [How do I add my accounts?](./#id-how-do-i-add-my-accounts)
* [How do I protect my accounts?](./#id-how-do-i-protect-my-accounts)
* [How do I share an account?](./#id-how-do-i-share-an-account)
* [How do I delete an account?](./#id-how-do-i-delete-an-account)
* [How do I receive notifications on my mobile phone?](./#id-how-do-i-receive-notifications-on-my-mobile-phone)
* [How do I log in to my apps using the Cerby mobile app?](./#id-how-do-i-log-in-to-my-apps-using-the-cerby-mobile-app)
* [How do I see activity on my accounts?](./#id-how-do-i-see-activity-on-my-accounts)
...
1. [Log in with my corporate identity](./#id-1.-log-in-with-my-corporate-identity)
2. [Install the Cerby browser extension](./#id-2.-install-the-cerby-browser-extension)
3. [Install the Cerby mobile app](./#id-3.-install-the-cerby-mobile-app)
...
![](.gitbook/assets/hRY7FOk9HfKptJJ2dSZXRN7uPGw4HHODSc6XeXk5SnWJlDiylFFjga86zRGvDFX4lTYhDBuXTBDiQuYSwAGSHnBznbsXMLfo6vQ_DRYzu6rNttab51LBn13ZUbdSVSKU3LuxVelHebGVRRVlPw.png)
...
9. Select the **Cerby** option from the list.
...
* [Add a regular account](./#id-add-a-regular-account)
* [Add a business center account](./#id-add-a-business-center-account)
...
![](.gitbook/assets/1ek1ZWST49BcWaaKe699XYoQRdngLT4koCDjjW-rpWlceqU25TPmakh-6Wje7pnfGlI4b_EkxwID1R1LVIg-9ggWkKabVHnkbv1hUx331O-vdYSBcCtpoZV6aHMZxqXp_7qGlwD1rKbiB0cKfA.png)
...
5\. Enable at least one additional management factor through Cerby by following the corresponding instructions in the [How Do I Protect My Accounts?](./#id-how-do-i-protect-my-accounts) section.
...
* [Create a Cerby-managed email address](./#id-create-a-cerby-managed-email-address)
* [Create a Cerby-managed phone number](./#id-create-a-cerby-managed-phone-number)
* [Turn on MFA automatically and manually](./#id-turn-on-mfa-automatically-and-manually)
* [Rotate passwords automatically](./#id-rotate-passwords-automatically)
...
*   Using Cerby-managed email addresses or phone numbers as verification methods
    ...
    1. Go to the account settings of your app.
    2. Create the email address or phone number through Cerby by following the corresponding instructions in the [Create a Cerby-managed email address](./#id-create-a-cerby-managed-email-address) and [Create a Cerby-managed phone number](./#id-create-a-cerby-managed-phone-number) sections.
...
* [Share an individual account](./#id-share-an-individual-account)
* [Create and share a collection](./#id-create-and-share-a-collection)
* [Share a business center account](./#id-share-a-business-center-account-and-assets)
...
**IMPORTANT:** To confirm your identity, you must have installed and logged in to the Cerby mobile app to receive push notifications. For more information, see the [How do I receive notifications on my mobile phone?](./#id-how-do-i-receive-notifications-on-my-mobile-phone) section.
...
1. Ensure you have installed the Cerby Mobile app. See the instructions in the [3. Install the Cerby Mobile App](./#id-3.-install-the-cerby-mobile-app) section.
...
![](.gitbook/assets/9d7i67X8iIC-q4j_-LxZSJOlAKSW950JkpU5POVl6cN9MUJJUmkEHIgk9qJE6kkQf9Wpl4nmcCfnIt9Vw0cF4qEkPyQDvOTe4IvGBm-YJ9u38IUPtaug5IBsG6djGyEdCMqY5gztJIPHuT5Obw.png)
