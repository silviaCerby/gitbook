...
To delete an API key, you must complete the following steps:
  ...
  4. Click the **More options** (<figure><img src="../.gitbook/assets/unnamed_49.png" alt=""><figcaption></figcaption></figure>) icon. A drop-down list is displayed.
...
**IMPORTANT:** When you delete an API key, all access and associated functionalities are revoked. Make sure to update any services or applications relying on this key.
