...
* The [Teams](https://cerby-test.gitbook.io/cerby-test/updates-and-releases/marketing-articles/what-are-teams) feature is now available to help our customers share accounts quickly and securely with groups of users. Currently, users can create teams from their Okta groups, but for the subsequent releases, Azure AD groups will be supported, as well as teams built from scratch with any member of the corporate directory in Cerby.
* The [Partners](https://cerby-test.gitbook.io/cerby-test/updates-and-releases/marketing-articles/what-are-partners) feature is now available to help our customers share access to their accounts securely with external parties without handing over the username and password.
