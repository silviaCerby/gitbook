...
* Remember how excited you were in April with the beta release of the [Save credentials at login](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-browser-extension/autosave-an-account-at-login-or-signup-with-the-cerby-browser-extension) feature? Guess what!? We improved the experience, and now you can add accounts to Cerby whether you have an active session with the Cerby browser extension or not.
