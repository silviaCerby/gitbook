...
![](images/c836e2bc-bd2c-4b73-8c9d-b60fb29c2fc5)

**Figure 1.** **Password generator** dialog box in the account details page

It’s never been easier to give every single one of your accounts the strong
login credentials it deserves.
...
![](images/ea4a925f-91cc-4b2f-8eed-054e9720a0e2)
...
You can filter by category or secret type, and sort by alphabetical order,
...
![](images/605e6ffe-7313-4c29-8018-c14c9e6cc061)

**Figure 3.** **Activity** screen related to an account

This feature allows you to quickly monitor the last seven days of events and
actions associated with the account. This feature was released in iOS v1.0.268
and Android v1.0.216. For more information, read the article [View the details
of an account using the Cerby mobile
app](https://help.cerby.com/en/articles/12454986-view-the-details-of-an-
...
![](images/72549de6-602a-41db-849c-7cf6aa398b9e)
