...
If you want to learn more, read the blog [Extending Okta's Universal Logout: Cerby Boosts Security Across Applications](https://www.cerby.com/resources/blog/extending-oktas-universal-logout) or the article [Explore Universal Logout](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-universal-logout).
...
This feature is available in Okta-based workspaces with [extended account access](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-extended-account-access) turned on, and we are working to support other IdPs in future releases. Contact your Customer Success representative for more information.

### Flexibility meets security: Use your AWS KMS environment in Cerby

Following the success of our [Azure Key Vault](https://cerby-test.gitbook.io/cerby-test/management/credential-management/vaults/set-up-an-azure-key-vault-integration) integration, we are excited to announce the addition of **AWS Key Management Service (KMS) support**! Integrate your AWS KMS environment with Cerby to protect your accounts and secrets and take full control of data encryption and decryption.
...
Ready to set it up or want more information? Take a look at the article [Set up an AWS KMS vault integration](https://cerby-test.gitbook.io/cerby-test/management/credential-management/vaults/set-up-an-aws-kms-vault-integration). **Figure 1** shows how an AWS KMS vault is displayed in the Cerby web app.

<figure><img src="../../../.gitbook/assets/AD_4nXeRRWjW5xR8qFArOpn1pbJO2VyS8R36dSFRjRcMa466YDOF6T1S56D4u17FLFTEIBhv2686s2-2ASAYOXlLC-0NBkI4hiL5FKXfDIwugkpNvl5DWCF6Yi9i7-1H-3n8rE8YhVNc.png" alt=""><figcaption></figcaption></figure>

**Figure 1.** **Privacy and security** tab in the **Workspace Configuration** page of the Cerby web app dashboard
...
For more information on how this feature works, read the article [Explore App settings restrictions](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-app-settings-restrictions). Explore the extension settings, as shown in **Figure 2** , where you can manage this feature.

<figure><img src="../../../.gitbook/assets/AD_4nXcvYNMvd9KUMGLmEhGGOpWR8YOAYZb1P9oxhnn5Bl_SpavzhiiNUGZFHL6KU_rUAC5tu8WKxtgDIirYFy-rE23qg_aRsjOmlcRLcV9b1fI5VhNzWt-hr2gIDdDdnfEfcW4AfWAHKQ.png" alt=""><figcaption></figcaption></figure>

**Figure 2. Extension settings** tab in the **Workspace Configuration** page of the Cerby web app dashboard
...
In addition to our importers for [LastPass](https://cerby-test.gitbook.io/cerby-test/management/credential-management/item-importer/migrate-from-lastpass-to-cerby) and [1Password](https://cerby-test.gitbook.io/cerby-test/management/credential-management/item-importer/migrate-from-1password-to-cerby), we’ve designed a universal and flexible method for migrating your items from your enterprise password manager (EPM). You just need to upload a CSV file to Cerby, and we’ll do the rest.

So, prepare your file and take control of your data migration. Check out the instructions and template in our article [Import your items from a CSV file to Cerby](https://cerby-test.gitbook.io/cerby-test/management/credential-management/item-importer/import-your-items-from-a-csv-file-to-cerby).
...
If you want to learn more about the Security Hub and orphaned accounts, take a look at the articles [Explore Security Hub](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-security-hub) and [Assign Owners to orphan accounts in your workspace](https://cerby-test.gitbook.io/cerby-test/management/security-and-policy/security-hub/assign-owners-to-orphaned-accounts-in-your-workspace).
...
As shown in **Figure 3** , those who prefer switching tabs and copy-pasting their login credentials can now find the codes on the account details page when Cerby manages multi-factor authentication (MFA).

**Figure 3.** MFA codes in the account details page of the Cerby web app dashboard

<figure><img src="../../../.gitbook/assets/AD_4nXfSGONjeI-y7uibWiPKa9j-JwRoIh_xk3s5WIVpSOMV0xgkLPR46pOE0Mksjh_YeCploJy3z5Gt9FIVopRGXLY41tlTBjKJ5IcNEBmoZJu-Ay009OJUM4ILdCFA-la0mXLbYx1w_g.png" alt=""><figcaption></figcaption></figure>
...
* Check the new features and improvements in the business hub user experience:
    ...
    * You can now disconnect the token of a native partner. Just go to the corresponding tab in the business hub details page and select **Disconnect token** from the **More options** (<figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1417318520/f547cfbf14a000f9eed969c4574a/AD_4nXeUCE5crjTJ-oX0QthVR1jJo4lFlhSzG3Mjs1kgJdhw9NLW3LdHYznfqTmOXLZu1sMyoD0GVys_gQqeZmEFf23LxarPsKsbMk6IBrz9ht_sYd9pi2ezAe0RoKoP-8QHYtMydRIJGw?expires=1765314000&signature=7b1329e2006f9ebe6852481c0d65f1ebe0ce8f64913e6f082843e8d50ac8b387&req=dSQmEcp%2FlYRdWfMW3Hu4gfwq383MqOhjDAjTqnxFq5%2BT2cW%2Bqixfv44W6tRE%0A0A%3D%3D%0A" alt=""><figcaption></figcaption></figure>) drop-down menu.
...
**Figure 4.** **Enforced account autosave** settings in the Cerby web app dashboard

<figure><img src="../../../.gitbook/assets/AD_4nXeOXyU1vrnfzkXLX8CmMwEuFKLmlXRi1llSnOOeiR7KXiBfR3PomwtWZ-NI0Ui2arFCeH2ZjZc9FsZGTTJvKXiSh_RDcbcnDfoooYNWO6P8whSC0y5NbQrYzgRrfRhd5rsPsSbxWA.png" alt=""><figcaption></figcaption></figure>
...
This feature is compatible with Face ID or Touch ID on iOS and Face Lock or Fingerprint recognition on Android. For guidance on setting up your biometrics, read the article [Turn on the Biometrics Login feature](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-mobile-app/app-configuration/turn-on-the-biometrics-login-feature).
**Figure 5** illustrates the user experience of this feature.

**Figure 5.** Biometrics in the Cerby mobile app

<figure><img src="../../../.gitbook/assets/AD_4nXe_lAYNDyf7b2hJF9_FBIj3tMX7iEzMCJoNIsWYStY9lntvwf2qFls2-l_IytGWymHN5XxO_93reddIEuJZT_ah8_Cp8HFz2-RkxidczkqhHd7jVgn7YcGv-CWwLh5Vaxz0w7XSsA.png" alt=""><figcaption></figcaption></figure>
...
The code is generated in the Cerby web app. After scanning the code and seeing the login credentials, you can launch the app and use the phone’s autofill functionality to log in to the account. You can also manually copy and paste the values.
For more information on how to use this feature, read the article [Access an account via a QR code using the Cerby mobile app](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-mobile-app/accounts/access-an-account-via-a-qr-code-using-the-cerby-mobile-app). It is available in iOS v1.0.222 and Android v1.0.189 onwards.
