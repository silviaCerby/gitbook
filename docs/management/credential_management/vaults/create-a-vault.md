...
3. Activate the **Privacy and Security** tab. A table with a list of vaults is displayed in the **Vault management** section, as shown in **Figure 1**. **Figure 1.** Table with a list of vaults in the **Vault management** section of the **Privacy and security** tab

<figure><img src="../../.gitbook/assets/AD_4nXfV0StRwqddawbjXurc__dId8Xr_AXVIWURWLDEmD2juGdZjf15UP4VXCQIN9Gx8VnUk87K-cFfXJu3TjS2wUHkzcz7D_KB-Xc30_e2hJt5bmJ6moRWu5Jsg5AfwC7LS4IMbZG2AkvPE2hIV8QX3XigMoan.png" alt=""><figcaption></figcaption></figure>
