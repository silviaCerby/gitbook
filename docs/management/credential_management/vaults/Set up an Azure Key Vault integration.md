...
don't see it available in your workspace, email our Sales team at
...
The Azure Key Vault integration encrypts a Cerby vault key that is then used
...
**Figure 1. Permission model** section in the **Access configuration** tab,
with the **Azure role-based access control** option selected
...
**IMPORTANT:** The role with the least access privileges is Key Vault Crypto
User, and the role with the highest access is **Key Vault Administrator**.
...
**Figure 2.** Table with the list of vaults in the **Vault management**
