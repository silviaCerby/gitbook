...
1. Discard the existing recovery key by following the instructions in the Discard recovery key section. **NOTE:** If you have already used the recovery key to regain access to your vault, continue in step 2.
...
5. Select the **Create recovery key** option from the list. A recovery key is generated, and the **Store the recovery key** dialog box is displayed. **NOTE:** To access the **Store the recovery key** dialog box, you can also perform the following actions from the **Vault management** section:
