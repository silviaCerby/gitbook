...
{% hint style="info" %} **Who can use this capability?** * Workspace**Owners**
, **Super Admins** , and **Admins** * Only supported using the Cerby web app.
{% endhint %}

As a workspace **Owner** , **Super** **Admin** , or **Admin** , you can create
and set up the **Vault Backup** capability to back up the login credentials
saved in your Cerby workspace to CyberArk.

This capability provides a reliable recovery system, ensuring that your data
remains backed up in the event of an incident. For more information, read the
article [Explore Vault
Backup](https://help.cerby.com/en/articles/12004415-explore-vault-backup).

{% hint style="danger" %} **IMPORTANT:** After setting up the workspace vault
backup, any account added to Cerby or updated is automatically backed up to
CyberArk. {% endhint %}
...
**IMPORTANT:** The values in this section must be exclusive to the
CyberArk–Cerby connection. To ensure proper isolation, you must create a new
platform and a new safe in CyberArk for this purpose
...
**IMPORTANT:** The service account must have the proper role to create and
update accounts and passwords in CyberArk
...
​**IMPORTANT:** If you want to use a domain other than <cyberark.cloud>,
contact [support@cerby.com](mailto:support@cerby.com)
...
To add a vault backup in CyberArk for your workspace, you must complete the
following steps:
...
Any account added or updated after configuring vault backup is automatically
backed up to CyberArk.
