...
As a workspace **Owner** , **Super** **Admin** , or **Admin** , you can edit
the configuration credentials to update the connection between Cerby and
CyberArk.
...
**IMPORTANT:** The **CyberArk auth URL** or **CyberArk base URL** values
cannot be edited in the **Connect to CyberArk** section.
...
**IMPORTANT:** A known issue occurs when incorrect **Client ID** or **Client
Secret** values are entered, which disables the CyberArk–Cerby connection. If
this happens, you must re-establish the connection with the correct values.  
---  
