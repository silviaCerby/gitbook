...
7. Move the installation file to the `/usr/local/bin/` folder:
   ...
   3. Move the `cerby-macos` file to the `/usr/local/bin/` folder using the following command: `sudo mv cerby-macos /usr/local/bin/`
...
4. Select the **Cerby** ![](../../.gitbook/assets/unnamed_10.png) option. The **Credentials** window opens.
...
6. Log in to Cerby by completing the following steps:
   ...
   2. Click the three-dots (![](../../.gitbook/assets/unnamed_11.png)) icon on the right side of the **Account** field. The Cerby login page is displayed.
...
11. (Optional) Select the RDM folder where you want to locate the Cerby account: 1. Click the three-dots (![](../../.gitbook/assets/unnamed_12.png)) icon on the right side of the **Folder** field. The **Folder** window opens. 2. Select the folder where you want to locate the Cerby account. 3. Click the **Select** button. The window closes, and the folder name is displayed in the **Folder** field.
