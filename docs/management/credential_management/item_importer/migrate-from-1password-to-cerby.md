...
6. Enter the corresponding information in the following fields:
   ...
   * **Secret key**
     1. Enter your 1Password secret key. ​**NOTE:** For instructions on how to find your secret key, read the [Requirements](migrate-from-1password-to-cerby.md#requirements) section.
...
![](../../.gitbook/assets/AD_4nXfy-pwXmrztzcYr1tghWwh4KKQZIk8k5V0x9Af3Mugn2yT3rBY2rr3K607s4t_x6-BPQBZ5FvwcLix8T7M63ucVcCiichpy8xTQpZmUzzEiu4zL4jH1Fk3LeAQxwZ1oy_FNlgpGXoSfJTfL8F_LscdkrUMO.png)
