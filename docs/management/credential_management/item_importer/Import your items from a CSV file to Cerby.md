...
and flexible method for migrating items by using exported CSV files as a
general-purpose import format. Cerby ensures compatibility with your EPM,
...
The format of the supported CSV file is compatible with 1Password’s export
...
To import your items to Cerby from a CSV file, you must complete the following
steps:
  ...
  12. Click the **Confirm** button. The previous steps must display the check (![](https://downloads.intercomcdn.com/i/o/pc0ldyqu/1336562891/152259451b0bee991dbf8d84f742/AD_4nXfQIWWgHkKYMrIl7ERe2MYoA4294ILneRSZAnxqz6XVuLjwDcK5eyqXsLbGpREl8mxoAzaQkO5FXnbcJLOFLYk-bacPD_wzZsM0xPs1fxqE0D2KNFheqU1kWF3OcBPDUuoVibAg?expires=1757808000&signature=91113709c741009720aca1d1f36565a4546040ee3ecd2ed18e4079c17ec273b6&req=dSMkEMx4n4lWWPMW3Hu4gfsReTTezQc5yvrZeMAByggrs48H3%2BL1zV50obpp%0ARg%3D%3D%0A)) icon to confirm everything is correct.
...
to import. A success message box is displayed when the import is complete, and
an email is sent.
...
display any information because, for the current release, the CSV File Import
does not import users.
...
solve the issues. For more information about this report, read the section How
to interpret the downloadable import report.

The next step is 3\. View item settings.

## **3\. View item settings**

After importing a collection, account, or secret to Cerby, you can view its
...
and permission. If an item is identified as having `skipped` or `failed`
status, the**Import report** also describes why it was not imported, so you
...
The **Import Report** displays two statuses and values that help you determine
a successful collection import. When you see `collection` as the item type in
the corresponding column and the successful status and value, the vault from
which you exported the file was imported to Cerby without any issues.
...
label each field. Use it as a reference or template when preparing your data.
