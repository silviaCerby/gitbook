...
To add the missing account details, you must complete the following steps:
  ...
  3. Click the **Edit** (<img src="../../../../.gitbook/assets/unnamed_72.png" alt="">) icon of the corresponding field to make it editable.
  4. Enter the information in the field.
  5. Click the **Done** (<img src="../../../../.gitbook/assets/unnamed_73.png" alt="">) icon to save the changes.
