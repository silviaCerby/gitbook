...
**Who can use this feature?**
  ...
  * Collection **Owners**
  * Supported using the Cerby web app and mobile app. For the mobile app instructions, read the article [Share a collection using the Cerby mobile app](https://help.cerby.com/en/articles/9718995-share-a-collection-in-the-cerby-mobile-app)
...
To share a collection, you must complete the following steps using the Cerby web app:
  ...
  3. Click the **Share**(<figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1481364251/4c687886ce44983e75b6f7a2d304/AD_4nXegaXoUF8_54QeQY36Cxxq2fhp4zCs8ot8VywKRI1WrhIXd2RS_6bUoqWfHLPkNZO8qRLGCE9Q59L_v1ty5fvFf-G1tLzH71luHyye9S1h63Ukdf2swtZuNN4llQpA1yKdT-ycRIE4Qm1eI3HM98BcrMKo?expires=1759320000&signature=016fe1797eed7438cb8e9f7cfa125fcabd599a15a5872436f689e0969159c720&req=dSQvF8p4mYNaWPMW3Hu4gdVoTB7%2BRIqK6Oe7Fqwzv4BVmGT29E37HfMFV6yr%0Acw%3D%3D%0A" alt=""><figcaption></figcaption></figure>) icon that appears when hovering over the corresponding collection card. The **Share Access** dialog box is displayed.
​**TIP:** You can also open the **Share Access** dialog box by performing the following actions:

     1. Click the **Settings** (<figure><img src="../.gitbook/assets/unnamed_66.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding collection card. The collection details page is displayed with the **General** tab activated.
...
**NOTE:** When you share a collection containing business hubs and assets, Cerby sends emails for users to claim access to the integration. After users claim access, Cerby triggers the automation jobs to add these users to the external apps. For more information, read the article [Manage access to business hubs and assets with collections](https://help.cerby.com/en/articles/11102692-manage-access-to-business-hubs-and-assets-with-collections).
