...
intercom_id: 8981907
description: >-
  This article describes how to share a collection with other workspace members
  and teams.
---
...
3.  Click the **Share**(
    ...
    <figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1481364251/4c687886ce44983e75b6f7a2d304/AD_4nXegaXoUF8_54QeQY36Cxxq2fhp4zCs8ot8VywKRI1WrhIXd2RS_6bUoqWfHLPkNZO8qRLGCE9Q59L_v1ty5fvFf-G1tLzH71luHyye9S1h63Ukdf2swtZuNN4llQpA1yKdT-ycRIE4Qm1eI3HM98BcrMKo?expires=1765908000&#x26;signature=b4c3145e597e206e36b2c0aa11f80363cc79e2fbe6323c4b34e0e7b1a890b9cf&#x26;req=dSQvF8p4mYNaWPMW3Hu4gdVoTB79SICI4Oe7Fqwzv4D%2FaEGq%2FzF5dJc9tknN%0AoA%3D%3D%0A" alt=""><figcaption></figcaption></figure>

    ) icon that appears when hovering over the corresponding collection card. The **Share Access** dialog box is displayed. ​**TIP:** You can also open the **Share Access** dialog box by performing the following actions:

    1.  Click the **Settings** (

        <figure><img src="../../.gitbook/assets/unnamed_66.png" alt=""><figcaption></figcaption></figure>

        ) icon of the corresponding collection card. The collection details page is displayed with the **General** tab activated.
...
7. Select the role to assign to the members and teams on the collection from the **Access** drop-down menu: **NOTE:** When you select a member with the **Login-only** or **Guest User** role, you can only select the **Collaborator** role for them.
