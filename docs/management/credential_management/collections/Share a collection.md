...
**NOTE:** When you select a member with the **Login-only** or **Guest User**
role, you can only select the **Collaborator** role for them.
...
integration. After users claim access, Cerby triggers the automation jobs to
