...
using the Cerby web app:
  ...
  5. Click the **More options** (![](images/AD_4nXdkXB4bJQKagu9Z2asBmo16ViDtW2v8ItGFGuIWbdkPqK5fGuFMVdt-u_Sa2Du7QCcWLohoPlJZn2lV1k6ajt1zlFGU2s0q-zI7VngnoI_VpF6d0MFxZ8hNd5U6WhVAWgZGklmvED2YlLa4iz-p5aPZaDIl)) icon of the corresponding user. A drop-down menu is displayed.
...
containing business hubs and assets, Cerby triggers the automation jobs to
