...
3.  Click the **More options**(
    ...
    ) icon of the corresponding collection card. A drop-down menu is displayed.
...
5. Select how you want to delete the collection:
   ...
   * **Delete the collection, the access, and the items inside it from your workspace:** Items within the collection are also deleted. ​**IMPORTANT:** Be careful when selecting this option because accounts and business hub integrations can be restored by their item **Owners** , but secrets cannot.
