...
4. Click the **More** **options** (<img src="../../../../../.gitbook/assets/unnamed_63.png" alt="">) icon. A menu is displayed.
   1. Alternatively, click the **Settings** (<img src="../../../../../.gitbook/assets/unnamed_64.png" alt="">) icon from the corresponding collection card. The collection detail page is displayed with the **General** tab activated.
