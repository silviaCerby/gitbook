...
their items, inheriting all permission settings bottom-down. {% endhint %}
  ...
  5. Click the **Share** (![](images/tTybgPBAuYaCpykXsEAsgQ5XkDi-C7LwsEbfMkEsTA604oDJJfJawnrhilAtc7lsNuUzfizNUzxpTu2DLUoVQxedhjQxViUIYMF8nJ6l15Lj0QmOkEqMQr5CzjYhVp3xG2R8KH4HdRvoQ6yzWUFvI_A)) icon. The Share Access dialog box is displayed. 
