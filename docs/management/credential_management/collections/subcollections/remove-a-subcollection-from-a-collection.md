...
intercom_id: 8982984
description: >-
  This article describes how to remove a subcollection from a collection, thus
  converting it to a root collection.
---

# Remove a subcollection from a collection

To remove a subcollection from a collection, you must complete the following steps:
...
5.  Click the **More options** (
    ...
    <figure><img src="../../../.gitbook/assets/unnamed_61.png" alt=""><figcaption></figcaption></figure>
