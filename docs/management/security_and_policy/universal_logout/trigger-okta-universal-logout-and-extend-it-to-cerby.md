...
description: >-
  This article describes how to trigger Okta Universal Logout from the Okta
  Dashboard and extend it to Cerby.
---
...
​**Figure 1.** **Clear sessions and revoke access** dialog box **IMPORTANT:** You must select this option to extend Okta’s Universal Logout to Cerby.
