...
6. Click the **Copy** button to copy the SCIM API authentication token to the clipboard. **TIP:** Keep the **Show Token** dialog box open, as shown in **Figure 2** , to copy the token at any time. You need the token to configure automatic provisioning with your IdP tenant.
