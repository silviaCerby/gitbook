...
intercom_id: 5560674
description: >-
  This article describes how to configure Google Workspace as your IdP to enable
  SSO for Cerby using a custom SAML app.
---
...
* An invitation sent from Cerby Support via email to create a workspace ​**IMPORTANT:** If you have not received an invitation, send an email to [support@cerby.com](mailto:support@cerby.com) with your request.
...
1. [Set up a workspace in Cerby](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-1.-set-up-a-new-workspace-in-cerby)
2. [Add a custom SAML app in Google Workspace](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-2.-add-a-custom-saml-app-in-google-workspace)
3. [Retrieve metadata information from Google Workspace and enter it in Cerby](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-3.-retrieve-metadata-information-from-google-workspace-and-enter-it-in-cerby)
...
![](../../.gitbook/assets/54d331fd-730c-4fcd-9129-e6ad2ac9ad6a.png)
...
![](../../.gitbook/assets/a783891d-ff6f-4660-beb2-cd521bf3b6db.png)
...
![](../../.gitbook/assets/9f72aa71-5146-4957-9999-5926db79b71d.png)
...
The next step is [2. Add a custom SAML app in Google Workspace](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-2.-add-a-custom-saml-app-in-google-workspace).
...
![](../../.gitbook/assets/cd6e6615-4fbb-4a41-ba12-81bfa7ef9e4a.png)
...
![](../../.gitbook/assets/f665e6b4-94a6-4667-a0ba-d8ffaf520b2a.png)

**Figure 5.** Cerby logo

```
    2. Click the **Camera** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1696413103/e3f1a40e409a672a87d73c44b70c/d1022570-bd48-4284-aaae-7329baacb8e2?expires=1756458000&signature=eee90eeec3c111a0a40fe947d615c5076b363813d86d8e8a884e4276a3346f44&req=dSYuEM1%2FnoBfWvMW3Hu4gUfb7vTn9XkhPe4qnbRgcIlNeLqLdDk4ELzO086X%0AfA%3D%3D%0A" alt="">) icon.
...
7. Copy the values from the browser tab you left open when completing step [1. Set up a new workspace in Cerby](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-1.-set-up-a-new-workspace-in-cerby) to paste them into their corresponding fields in the Google Admin Console, as shown in **Figure 6** :
   * **ACS URL**
   * **Entity ID** ​

![](../../.gitbook/assets/18436bbe-1c86-433b-a3e0-4125fb342350.png)
...
The next step is [3. Retrieve metadata information from Google Workspace and enter it in Cerby](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-3.-retrieve-metadata-information-from-google-workspace-and-enter-it-in-cerby).
...
The following table shows the attribute mappings in Google Directory you must configure as part of step [2. Add a SAML-based custom app to your Google Workspace](configure-sso-between-cerby-and-google-workspace-with-saml.md#id-2.-add-a-custom-saml-app-in-google-workspace):
...
![](../../.gitbook/assets/492ffb0b-02fd-471a-ba17-85e1f8b123ac.png)

**Figure 7.** “Error: app\_not\_configured\_for\_user” message in your web browser
