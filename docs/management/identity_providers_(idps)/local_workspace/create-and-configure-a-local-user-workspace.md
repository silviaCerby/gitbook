...
intercom_id: 8011381
description: >-
  This article describes how to create and configure a local user workspace in
  which Cerby manages the identity and authentication of users.
---
...
1. Click the **Create your Workspace** button from the invite that Cerby sent to your email address. The **Welcome to Cerby** page is displayed, as shown in **Figure 1**. **Figure 1. Welcome to Cerby** page

<figure><img src="../../.gitbook/assets/omhnlZhbqMvnuxx_f-dvvdhsjlp1JMAcekC7irwlP173Hpfac-Mu1hqqhLOFz_EpgazGd9MVNNPTpSgzHmuW4WFi2BaqeRPwx2Ett8WtbKMWnAA73nsc6ZEv2PBJrgclOta2BpwUFq-VzCet9bdsKsI.png" alt="Screenshot of the Welcome to Cerby page, where multiple buttons are displayed with the different options to sign in to Cerby."><figcaption></figcaption></figure>
...
7. Click the **Login** button. The authentication page for Cerby is displayed, as shown in **Figure 2**. **Figure 2.** Authentication page for Cerby

<figure><img src="../../.gitbook/assets/fjvDT_e3XX1qG2QG2bIxkfTKz8Z13UZxSXDlWGpJqwmgMsgdw19IUBN4REDa2MKQOgTPeTMn6c1N8x3PaiCM9VXj8phSn90gcFC7xjGWIVTpQBjedILhQ8Y8Crv8_ncC6gYMkeBphHMPMTgZOJHT9v4.png" alt="Screenshot of the authentication page for Cerby with the Username and Password input fields and the Log in button."><figcaption></figcaption></figure>
...
9. Click the **Sign in** button. The homepage of the Cerby dashboard is displayed, as shown in **Figure 3**. **Figure 3.** Homepage of the Cerby dashboard

<figure><img src="../../.gitbook/assets/Li9ZMsx_xS6rM_HSQ4bVWCUrD9vdGiArRGMrzzZeZzK7uaHAbOE_gIr4164ewWMhza-rkm70T4oscjvGA0aYHSNxgSw2p6SWYXCZ9k8w-3Ex8qL3dZZaTBfU12epZ64OBqp9CTQUogZH4LADu6ji3KA.png" alt="Screenshot of the homepage of the Cerby dashboard, comprised by a left navigation drawer and a main section."><figcaption></figcaption></figure>
...
1. Install the Cerby browser extension by following the instructions in the [How to install the Cerby browser extension](https://cerby-test.gitbook.io/cerby-test/getting-started/cerby-browser-extension/video-how-to-install-the-cerby-browser-extension) video.
...
To turn on multi-factor authentication (MFA) for your Cerby account with an authentication app, you must complete the following steps from the homepage of your Cerby dashboard:
...
1. Select the **All members** option from the left navigation drawer. The **All Members** view is displayed, as shown in **Figure 4**. **Figure 4. All members** view of the Cerby dashboard

<figure><img src="../../.gitbook/assets/GAsXOJLLmi39iFRZjeQsTMzN-ARMTmPAyH2M-RmzobX9E8vnfVTPIq1fw9vPsnFD_2Fk7lUDpTI-DJ8EDO-3jZGNrv9dlPbXS5Tf7jtW2GYI0kEgO04m32RPFEUFd0PyjVPjIHwtYC8lnN7jFZOtvCY.png" alt="Screenshot of the All members view of the Cerby dashboard, which contains a table of users with their workspace role, accounts, joined date, and status."><figcaption></figcaption></figure>
...
4. Click the **Next** button. The user is added to a list in the **MEMBER** section **NOTE:** To add multiple users, enter each email address individually and press Enter. Each one is added to the list in the **MEMBER** section.
...
6. Click the **Send Invite** button. The dialog box closes, a success message box is displayed, and an email is sent to the user to join Cerby with a temporary password. **IMPORTANT:** The temporary password expires in 48 hours. After this time, users need a new invite.

### Reset MFA

To reset MFA for a user in a local user workspace, you must complete the following steps:
...
1. Select the **All members** option from the left navigation drawer. The **All Members** view is displayed.
2. Click the **More options** icon of the corresponding user. A drop-down list is displayed.
3. Select the **Remove from Workspace** option from the list. The **Remove ?** dialog box is displayed.
...
When you try to turn on MFA for a Cerby account that belongs to a local user workspace, and you haven’t set your mobile phone time as automatic, the “We couldn’t turn MFA on for your profile” message may appear, as shown in **Figure 5**.

<figure><img src="../../.gitbook/assets/m5vB4WQ4MI4LtMRX_H8dHxvjh4Bj7RFacSUPbM0V_igXrNtPPjrFtsOIPxwNUpGH_LYGRZS2Hhoqvw8_wEjsFScj4SyoEleTpM5GhxBUpEUyzF7KHfVijZQs7J-usgdd6JZpFgfGQwgWuFVQzLRB4bw.png" alt="Screenshot of the “We couldn’t turn 2FA on for your profile” message when trying to verify the authentication code in the Try the authentication code dialog box."><figcaption></figcaption></figure>
...
Now, try to turn on MFA again by following the steps in step 3. Turn on MFA for your Cerby account section.
