...
4. Click the **More options**(<img src="../../../../.gitbook/assets/unnamed_15.png" alt="">) icon of the field you want to update. A drop-down list is displayed.
...
8. Click the **Done** (<img src="../../../../.gitbook/assets/unnamed_16.png" alt="">) icon. A success message box is displayed.
