...
The fields related to the **Extended account access** feature are **IDP Domain** and **API Token**.

  4. Click the **More options**(<figure><img src="../.gitbook/assets/unnamed_15.png" alt=""><figcaption></figcaption></figure>) icon of the field you want to update. A drop-down list is displayed.
...
**TIP:** Click the **Test connection** button for the **API Token** field to verify Cerby can connect with Okta with the new token.
  ...
  8. Click the **Done** (<figure><img src="../.gitbook/assets/unnamed_16.png" alt=""><figcaption></figcaption></figure>) icon. A success message box is displayed.
