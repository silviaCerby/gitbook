...
4. Click the **More options**(![](../../.gitbook/assets/unnamed_15.png)) icon of the field you want to update. A drop-down list is displayed.
...
8. Click the **Done** (![](../../.gitbook/assets/unnamed_16.png)) icon. A success message box is displayed.
