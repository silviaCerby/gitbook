...
As an account **Owner** who has synced and [extended an account to Okta](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-extended-account-access), you can view its status to take action and [sync it manually](https://docs.google.com/document/d/1kGue74pgf97WZpQBK64hkCiGZ_ccQ364t5s2c-w_MWs/edit#heading=h.2getrvi37mad).
