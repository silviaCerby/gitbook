...
* Search for the app you want to remove from the list by clicking the **Search** (![](../../.gitbook/assets/AD_4nXfY4DLRU7ykotOPh_AhLVqVMElflGtc--uA4dwTlimydBVKc6jsz5f4Pb8LGlVLRYA7F9lc2u8ELZh2D6csafWEAZBdUAld8cL5_Fcpxe52TicRZHz-rFyFrUkkOOwj23BYLhFw1g.png)) icon, which displays the search field. As you type in the characters of the app, a list of matching apps is displayed below.
* Sort the list by recently added, earlier added, A to Z, or Z to A using the **Sort by** ( ![](../../.gitbook/assets/AD_4nXey1jRuSBA3e3jjYkr3a5acXS-_DMyzZl0Pe6JUddNTvhNSS5IRA75Zl3rglc3QvrLIcvv0V4wyLrXdf_dqEEMyqAY-mTCKZ1KBqs_Kbo3yV4ObFTNn5vB-2uIEUXLCy_1cElVM3g.png)) button next to the search field.
...
5. Click the **Remove app restrictions** button in the menu at the bottom. A success message appears, and the selected apps are removed from the list.
