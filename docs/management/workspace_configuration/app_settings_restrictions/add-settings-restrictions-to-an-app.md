...
![](../../.gitbook/assets/AD_4nXc3tBuGC1cKYA01OWrnnqDKzAnuZmw-W0DV6TffNtN-Ay_M5ILKH2uGQacXHMqhvh2jV9P_BqMIpDCpLyO2Uk49b9SZnmNq6_n1vJmSaSghP1oJuHacwbwSIwD84fY8KJAABozaCQ.png)

**Figure 1. Set up restrictions for you app** page of the wizard with the options to restrict password or member settings
...
**IMPORTANT:** Restrictions take five minutes to apply in the app and apply only to workspace **Users**. Workspace **Owners** , **Admins** , and **Super** **Admins** are unaffected by these restrictions.
