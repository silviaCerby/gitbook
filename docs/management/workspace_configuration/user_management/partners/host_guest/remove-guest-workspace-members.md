...
When you have your Cerby guest workspace configured as a local user workspace, user removal is manual through the **All members** view of the Cerby web app dashboard. Follow the instructions from the [Remove user from workspace](https://cerby-test.gitbook.io/cerby-test/management/identity-providers-idps/local-workspace/create-and-configure-a-local-user-workspace) section of the article [How to create and configure a local user workspace](https://cerby-test.gitbook.io/cerby-test/management/identity-providers-idps/local-workspace/create-and-configure-a-local-user-workspace).
