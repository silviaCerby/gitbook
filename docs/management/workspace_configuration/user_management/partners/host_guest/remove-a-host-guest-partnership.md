...
**NOTE:** When removing a partner, all access to accounts shared via the host-guest partnership is also removed. Host workspace members with the account **Owner** role retain access.
