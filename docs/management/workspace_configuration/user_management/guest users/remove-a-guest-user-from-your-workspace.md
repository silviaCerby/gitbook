...
# Remove a guest user from your workspace
...
As a **Workspace Admin** , you can remove guest users from your Cerby workspace. To do so, you must complete the following steps:
