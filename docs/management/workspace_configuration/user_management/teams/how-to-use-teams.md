...
**NOTE:** If Group Push was not updated recently, you can perform a manual push. If the push status is **Inactive** , you can reactivate it. For more information on performing both actions, see the Map new groups and manage group mapping section.
