...
When you set up an app integration in your IdP to connect it to your Ceby-
integrated app, you must provide the SCIM gateway URL, a SCIM gateway token,
and the Bookmark URL. You can retrieve these elements in the following ways:
...
To retrieve the Bookmark URL of an IdLCM integration, you must complete the
following steps:
