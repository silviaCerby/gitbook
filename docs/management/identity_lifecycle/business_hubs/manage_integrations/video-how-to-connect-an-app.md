...
​**NOTE:** Not all the **Apps** require a business or organization ID; Cerby displays this input field when applicable to your app. For instructions on how to find the ID, read the [Requirements](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-business-hubs) section of the article [How to use Tenants](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-business-hubs).
