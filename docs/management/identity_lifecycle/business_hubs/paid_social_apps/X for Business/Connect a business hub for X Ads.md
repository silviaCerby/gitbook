...
This article provides instructions on how to connect a business hub for X Ads.
...
To connect a business hub for X Ads, you must complete the following main
...
To add a business hub and connect it to X Ads, you must complete the following
steps:
...
To connect your X Ads user account to the business hub so Cerby can manage and
