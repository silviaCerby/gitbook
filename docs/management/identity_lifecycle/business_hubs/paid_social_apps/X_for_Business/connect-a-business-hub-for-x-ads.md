---
description: This article describes how to connect a business hub to centrally manage the users and assets of X Ads from Cerby.
intercom_id: 12549571
---

# Connect a business hub for X Ads
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users and assets of X Ads.
...
This article provides instructions on how to connect a business hub for X Ads. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **Account administrator** role in X Ads to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
  * An account number. You can find the ID in the following ways:
    * **In the address bar:** When you are logged in to X Ads, the ID is displayed in the address bar as part of the URL. For example, **`18ab55cdef8`** in **`https://ads.x.com/simpleads/18ab55cdef8/objectivepicker`**. Just copy the value and paste it when connecting the business hub.
    * **In the account settings:** After logging in to X Ads, click on your account name in the top-right corner, and select the **Account settings** option from the drop-down menu. The ID is displayed in the **Account ID** field for you to copy, as shown in **Figure 1**.

<img src="../../../../../../.gitbook/assets/image_2.png" alt="">

**Figure 1.** **Account ID** field in the **Account setting** page

* * *

## Connect a business hub for X Ads

To connect a business hub for X Ads, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to X Ads](connect-a-business-hub-for-x-ads.md#id-1.-add-a-business-hub-and-connect-it-to-x-ads)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-x-ads.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your X Ads user account to the business hub](connect-a-business-hub-for-x-ads.md#id-3.-connect-your-x-ads-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-x-ads.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to X Ads

To add a business hub and connect it to X Ads, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **X Ads** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Account number:** It is the unique identifier of your business or organization in **X Ads**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-x-ads.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported by X Ads.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing X Ads accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-x-ads.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-x-ads.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_124.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your X Ads user account to the business hub](connect-a-business-hub-for-x-ads.md#id-3.-connect-your-x-ads-user-account-to-the-business-hub).

### 3\. Connect your X Ads user account to the business hub

To connect your X Ads user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding X Ads account card. The **Connect your X Ads Account** dialog box is displayed.
  3. Enter the login credentials of your **X Ads** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-x-ads.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_125.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-x-ads.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-x-ads.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-x-ads.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in X Ads.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_126.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_127.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
