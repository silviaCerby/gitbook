...
description: >-
  ...
  users and assets of LinkedIn Business Manager from Cerby.
---
...
![](../../../../.gitbook/assets/AD_4nXeLQIjoy60EI-ytezN5yT7uK7_WqLIdBbaYfixkL8o7ESl13q95vRv4f9-oiqBthaE2msO3aKvE1dcOhK2B6cuNalofYayo_puOjtCMlqIPcHtTZbIfZkLYwZ-gb-q31Ple4tbHHXJ_CI6G8sY2Eo0iKwck.png)
...
2. Click the **Settings** (![](../../../../.gitbook/assets/unnamed_8.png)) icon of the corresponding LinkedIn Business Manager business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/unnamed_9.png)) icon of the corresponding business hub card. A drop-down list is displayed.
