...
To check for updates in your app to identify and import users, roles, and assets to Cerby, you must complete the following steps:
  ...
  2. Click the **Settings** (<img src="../../../../../../.gitbook/assets/unnamed_8.png" alt="">) icon of the corresponding LinkedIn Business Manager business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
To view the status of the imported app’s users, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/unnamed_9.png" alt="">) icon of the corresponding business hub card. A drop-down list is displayed.
