...
* A Business ID. You can find the ID in your organization settings. After logging in to JetBrains, the ID is the number displayed next to the organization's name in the left menu, as shown in**Figure 1**. ​ **Figure 1.** Business ID in the JetBrains account page
