---
description: This article describes how to connect a business hub to centrally manage the users and assets of JetBrains from Cerby.
intercom_id: 10924637
---

# Connect a business hub for JetBrains
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users and assets of JetBrains.
...
The following are the requirements to connect a business hub:
  ...
  * A Business ID. You can find the ID in your organization settings. After logging in to JetBrains, the ID is the number displayed next to the organization's name in the left menu, as shown in**Figure 1**.
​

<img src="../../../../../../.gitbook/assets/Business_ID__in_JetBrains_Account.png" alt="">

**Figure 1.** Business ID in the JetBrains account page

* * *

## Connect a business hub for JetBrains

To connect a business hub for JetBrains, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to JetBrains](connect-a-business-hub-for-jetbrains.md#id-1.-add-a-business-hub-and-connect-it-to-jetbrains)
  2. [Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-jetbrains.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby)
  3. [Connect your JetBrains user account to the business hub](connect-a-business-hub-for-jetbrains.md#id-3.-connect-your-jetbrains-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-jetbrains.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to JetBrains

To add a business hub and connect it to JetBrains, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **JetBrains Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **JetBrains Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-jetbrains.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing JetBrains accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-jetbrains.md#id-requirements) section.
...
The next step is [2. Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-jetbrains.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby).
...
The next step is [3. Connect your JetBrains user account to the business hub](connect-a-business-hub-for-jetbrains.md#id-3.-connect-your-jetbrains-user-account-to-the-business-hub).

### 3\. Connect your JetBrains user account to the business hub

To connect your JetBrains user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding JetBrains Hub account card. The **Connect your JetBrains Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **JetBrains** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-jetbrains.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-jetbrains.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-jetbrains.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-jetbrains.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in JetBrains.
