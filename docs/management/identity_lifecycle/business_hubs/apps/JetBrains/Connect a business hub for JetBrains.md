...
JetBrains. For other app-specific articles and videos, review the [Connecting
...
![](images/Business_ID+_in_JetBrains_Account.png)
...
To connect a business hub for JetBrains, you must complete the following main
...
To add a business hub and connect it to JetBrains, you must complete the
following steps:
...
To connect your JetBrains user account to the business hub so Cerby can manage
