...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Region:** It is the country of your store in the **Amazon Seller Hub**. You must select the option that matches the region described in the Requirements section.
...
The next step is 3\. Connect your Amazon Seller user account to the business hub.
