...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Region:** It is the country of your store in the **Amazon Seller Hub**. You must select the option that matches the region described in the [Requirements](connect-a-business-hub-for-amazon-seller.md#requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-amazon-seller.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-amazon-seller.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-amazon-seller.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-amazon-seller.md#exempt-unmatched-users)
