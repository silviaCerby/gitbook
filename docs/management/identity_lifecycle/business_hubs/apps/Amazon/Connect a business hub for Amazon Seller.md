...
update user roles is not available for this business hub because Amazon Seller
doesn't support roles. {% endhint %}

This article provides instructions on how to connect a business hub for Amazon
Seller. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Amazon Seller, you must complete the following
...
To add a business hub and connect it to Amazon Seller, you must complete the
following steps:
...
The next step is 3\. Connect your Amazon Seller user account to the business
hub.

## 3\. Connect your Amazon Seller user account to the business hub

To connect your Amazon Seller user account to the business hub so Cerby can
