...
* A business ID. You can find the ID in your account settings by completing the following steps after logging in to Reflect:
  ...
  2. Select the **Settings** option. The **Account Information** page is displayed. The business ID is the value inside the **Account Name** field in the **Account Configuration** section, as shown in **Figure 1**.

![](../../../../.gitbook/assets/AD_4nXf3sPgvPPku4GydJB0gkHmVnictTlIEo2_80iOeUJbLZU4TdTJ9wxZR6GnFcgoOA5ofDI6SUFlX2bb5SHkv1tdjNaLkJm77SHoT8Tx3pD367ZQ0ejUD3GfKIKVxKEuGZYEc0YYAYQ.png)
