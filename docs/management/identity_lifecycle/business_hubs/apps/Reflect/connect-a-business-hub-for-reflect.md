...
* The user management and login method for your business hub identified to select the corresponding option when connecting your app. For more information, read the **User management and login method** section of the article [Explore Apps](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-business-hubs) **IMPORTANT:** Currently, single sign-on (SSO) is not supported by this business hub.
...
<figure><img src="../../../../.gitbook/assets/AD_4nXf3sPgvPPku4GydJB0gkHmVnictTlIEo2_80iOeUJbLZU4TdTJ9wxZR6GnFcgoOA5ofDI6SUFlX2bb5SHkv1tdjNaLkJm77SHoT8Tx3pD367ZQ0ejUD3GfKIKVxKEuGZYEc0YYAYQ.png" alt=""><figcaption></figcaption></figure>
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **Business ID:** It is the unique identifier of your Reflect account. For instructions on how to find it, read the Requirements section.
   * **User management and login method:** It is the way your users log in to the app and determines if they must save their credentials in Cerby.
     1. Select the **Username and password** option because account security and access are managed by Ceby, and users log in with their credentials after saving them in Cerby. **IMPORTANT:** Currently, the **Single sign-on (SSO)** option is not supported by this business hub.
...
The next step is 3. Connect your Reflect user account to the business hub.
