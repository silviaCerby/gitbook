---
description: This article describes how to connect a business hub to centrally manage the users of Reflect from Cerby.
intercom_id: 10315352
---

# Connect a business hub for Reflect
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Reflect.
...
This article provides instructions on how to connect a business hub for Reflect. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  **IMPORTANT:** Currently, single sign-on (SSO) is not supported by this business hub.

  * A business ID. You can find the ID in your account settings by completing the following steps after logging in to Reflect:

    1. Click the user profile icon at the top right of the page. A drop-down menu is displayed.
    2. Select the **Settings** option. The **Account Information** page is displayed.
The business ID is the value inside the **Account Name** field in the **Account Configuration** section, as shown in **Figure 1**.

<img src="../../../../../../.gitbook/assets/AD_4nXf3sPgvPPku4GydJB0gkHmVnictTlIEo2_80iOeUJbLZU4TdTJ9wxZR6GnFcgoOA5ofDI6SUFlX2bb5SHkv1tdjNaLkJm77SHoT8Tx3pD367ZQ0ejUD3GfKIKVxKEuGZYEc0YYAYQ.png" alt="">

**Figure 1.** **Account Name** in the **Account Information** page

* * *

## Connect a business hub for Reflect

To connect a business hub for Reflect, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Reflect](connect-a-business-hub-for-reflect.md#id-1.-add-a-business-hub-and-connect-it-to-reflect)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-reflect.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Reflect user account to the business hub](connect-a-business-hub-for-reflect.md#id-3.-connect-your-reflect-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-reflect.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Reflect

To add a business hub and connect it to Reflect, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Reflect Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your Reflect account. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-reflect.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines if they must save their credentials in Cerby.
       ...
       **IMPORTANT:** Currently, the **Single sign-on (SSO)** option is not supported by this business hub.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Reflect accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-reflect.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-reflect.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Reflect user account to the business hub](connect-a-business-hub-for-reflect.md#id-3.-connect-your-reflect-user-account-to-the-business-hub).

### 3\. Connect your Reflect user account to the business hub

To connect your Reflect user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Reflect Hub account card. The **Connect your Reflect Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Reflect user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-reflect.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-reflect.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-reflect.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-reflect.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Reflect.
