...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** Mercury requires
an additional field, **Custom permissions** , to create user accounts. You
must provide this value when inviting new users to the app. {% endhint %}

This article provides instructions on how to connect a business hub for
Mercury. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Mercury, you must complete the following main
...
To add a business hub and connect it to Mercury, you must complete the
following steps:
...
To connect your Mercury user account to the business hub so Cerby can manage
