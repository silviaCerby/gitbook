---
description: This article describes how to connect a business hub to centrally manage the users of Gente from Cerby.
intercom_id: 12663641
---

# Connect a business hub for Gente
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Gente.
...
This article provides instructions on how to connect a business hub for Gente. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Business unique identifier. You can find the ID in your company information by completing the following steps:

    1. Go to the [Gente login](https://gente2.uy/deel4911/gente.aspx) page.
    2. Click the **Selecciona empresa** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1795802493/7f82402adbd0799f5da2c9267ad2/image.png?expires=1761344400&signature=39035fd623f6a8d8470d2d219460faf3fdfe6ed901a4ea62474d7006ef950935&req=dScuE8F%2Bn4VWWvMU3HP0gEWPAc%2FJHfTALkvGXomF0w69PBkKsOA%3D%0A" alt="">) icon next to the **Empresa** field. A pop-up window is displayed listing all available companies, as shown in **Figure 1**.

<img src="../../../../../../.gitbook/assets/image_1.png" alt="">

**Figure 1.** The **Empresas** window on the Gente login page

    3. Find your company in the **Empresa** column. The ID corresponds to the value shown in this column for your company in Gente.
    4. Copy the value and paste it when connecting the business hub.

* * *

## Connect a business hub for Gente

To connect a business hub for Gente, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Gente](connect-a-business-hub-for-gente.md#id-1.-add-a-business-hub-and-connect-it-to-gente)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-gente.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Gente user account to the business hub](connect-a-business-hub-for-gente.md#id-3.-connect-your-gente-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-gente.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Gente

To add a business hub and connect it to Gente, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Gente Deel Business Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business unique identifier:** It is the unique identifier of your business or organization in **Gente Deel Business Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-gente.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **NOTE:** The **Single sign-on (SSO)** option is not supported for Gente.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Gente accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-gente.md#id-requirements) section.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_80.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Gente user account to the business hub](connect-a-business-hub-for-gente.md#id-3.-connect-your-gente-user-account-to-the-business-hub).

### 3\. Connect your Gente user account to the business hub

To connect your Gente user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Gente Deel Business Hub account card. The **Connect your Gente Deel Business Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Gente** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-gente.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-gente.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-gente.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-gente.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Gente.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_82.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_83.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
