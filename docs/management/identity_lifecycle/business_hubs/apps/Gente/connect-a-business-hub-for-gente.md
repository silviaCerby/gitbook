...
* A Business unique identifier. You can find the ID in your company information by completing the following steps:
  ...
  2.  Click the **Selecciona empresa** (

      <figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1795802493/7f82402adbd0799f5da2c9267ad2/image.png?expires=1761344400&#x26;signature=39035fd623f6a8d8470d2d219460faf3fdfe6ed901a4ea62474d7006ef950935&#x26;req=dScuE8F%2Bn4VWWvMU3HP0gEWPAc%2FJHfTALkvGXomF0w69PBkKsOA%3D%0A" alt=""><figcaption></figcaption></figure>

      ) icon next to the **Empresa** field. A pop-up window is displayed listing all available companies, as shown in **Figure 1**.
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **Business unique identifier:** It is the unique identifier of your business or organization in **Gente Deel Business Hub**. For instructions on how to find it, read the Requirements section.
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Username and password** option because account security and access are managed by Cerby, and users log in with their credentials after saving them in Cerby. **NOTE:** The **Single sign-on (SSO)** option is not supported for Gente.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_80.png" alt=""><figcaption></figcaption></figure>
...
The next step is 3. Connect your Gente user account to the business hub.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_81.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_82.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_83.png" alt=""><figcaption></figcaption></figure>
