...
* A Business unique identifier. You can find the ID in your company information by completing the following steps:
    ...
    2. Click the **Selecciona empresa** (<figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1795802493/7f82402adbd0799f5da2c9267ad2/image.png?expires=1761344400&signature=39035fd623f6a8d8470d2d219460faf3fdfe6ed901a4ea62474d7006ef950935&req=dScuE8F%2Bn4VWWvMU3HP0gEWPAc%2FJHfTALkvGXomF0w69PBkKsOA%3D%0A" alt=""><figcaption></figcaption></figure>) icon next to the **Empresa** field. A pop-up window is displayed listing all available companies, as shown in **Figure 1**.
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<figure><img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_81.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding business hub card. A drop-down menu is displayed.
...
{% endhint %}
  ...
  1. Click the **More options** (<figure><img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_82.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<figure><img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_83.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding user. A drop-down list is displayed.
