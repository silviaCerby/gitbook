...
This article provides instructions on how to connect a business hub for Gente.
For other app-specific articles and videos, review the [Connecting business
hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-
your-apps) and [Connecting business hubs for your paid social
...
To connect a business hub for Gente, you must complete the following main
...
To add a business hub and connect it to Gente, you must complete the following
steps:
...
To connect your Gente user account to the business hub so Cerby can manage and
