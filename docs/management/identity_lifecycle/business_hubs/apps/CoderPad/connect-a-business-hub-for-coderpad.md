...
description: >-
  ...
  users of CoderPad from Cerby.
---

# Connect a business hub for CoderPad
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of CoderPad.
...
This article provides instructions on how to connect a business hub for CoderPad. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for CoderPad, you must complete the following main steps from the Cerby web app dashboard:

1. [Add a business hub and connect it to CoderPad](connect-a-business-hub-for-coderpad.md#id-1.-add-a-business-hub-and-connect-it-to-coderpad)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-coderpad.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your CoderPad user account to the business hub](connect-a-business-hub-for-coderpad.md#id-3.-connect-your-coderpad-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-coderpad.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1. Add a business hub and connect it to CoderPad

To add a business hub and connect it to CoderPad, you must complete the following steps:
...
5. Select **CoderPad Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-coderpad.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_502.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your CoderPad user account to the business hub](connect-a-business-hub-for-coderpad.md#id-3.-connect-your-coderpad-user-account-to-the-business-hub).

### 3. Connect your CoderPad user account to the business hub

To connect your CoderPad user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
2. Click the **Log in** button of the corresponding CoderPad Hub account card. The **Connect your CoderPad Hub Account** dialog box is displayed.
3. Enter the login credentials of your CoderPad user account.
4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-coderpad.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
2. Click the **More options** (![](https://downloads.intercomcdn.com/i/o/pc0ldyqu/1764683486/d898720ea8efc02a04b926c6ec22/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1759968000\&signature=0ddc27f35255b6f66374f97a5ae2a9ccd8204c05c7cfc514b99f0dbfec299078\&req=dSchEs92noVXX%2FMW3Hu4gTfs%2Bs3flM6ELWDxkJgTRJM1b9lbg%2BFsGtrQlYBW%0AGw%3D%3D%0A))icon of the corresponding business hub card. A drop-down menu is displayed.
...
{% hint style="danger" %}
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in CoderPad.
{% endhint %}

1. Click the **More options** (![](https://downloads.intercomcdn.com/i/o/pc0ldyqu/1764684575/9f9973013de57805ac8964822738/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1759968000\&signature=b3e84bf73c91c9e3ad34038b8a9d7e31f2fae9c353bf4b68f4419efcf9ec8dc5\&req=dSchEs92mYRYXPMW3Hu4gYYD1pl2IqV7jIy6Th7PR2APPd%2F385ORrsMqQ2EO%0AiA%3D%3D%0A)) icon of the corresponding user. A drop-down menu is displayed.
...
1. Click the **More options**(![](https://downloads.intercomcdn.com/i/o/pc0ldyqu/1764684967/dc174aff4276840a164cb79878aa/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1759968000\&signature=da6166d1a0632c9c827ddd109c58029da11b491890542782c0ad3d216eab576c\&req=dSchEs92mYhZXvMW3Hu4gbv%2FPWCRLY%2BxkgTxy00SEpLVH5zQRUlvVueEwQD7%0AXA%3D%3D%0A)) icon of the corresponding user. A drop-down menu is displayed.
