---
intercom_id: 10488233
description: >-
  This article describes how to connect a business hub to centrally manage the
  users of Frase from Cerby.
---

# Connect a business hub for Frase
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Frase.
...
{% hint style="info" %}
**NOTE:** The automated task to update app members’ roles is not available for this business hub because Frase only supports one **Admin** member per account.
{% endhint %}

This article provides instructions on how to connect a business hub for Frase. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Frase, you must complete the following main steps from the Cerby web app dashboard:

1. [Add a business hub and connect it to Frase](connect-a-business-hub-for-frase.md#id-1.-add-a-business-hub-and-connect-it-to-frase)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-frase.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your Frase user account to the business hub](connect-a-business-hub-for-frase.md#id-3.-connect-your-frase-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-frase.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1. Add a business hub and connect it to Frase

To add a business hub and connect it to Frase, you must complete the following steps:
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-frase.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **Settings** (![](../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz_19.png)) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your Frase user account to the business hub](connect-a-business-hub-for-frase.md#id-3.-connect-your-frase-user-account-to-the-business-hub).

### 3. Connect your Frase user account to the business hub

To connect your Frase user account to the business hub so Cerby can manage and protect it, you must complete the following steps:
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-frase.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_474.png)) icon of the corresponding business hub card. A drop-down list is displayed.
...
* [Match users](connect-a-business-hub-for-frase.md#match-users)
* [Remove unmatched users](connect-a-business-hub-for-frase.md#remove-unmatched-users)
* [Exempt unmatched users](connect-a-business-hub-for-frase.md#exempt-unmatched-users)
...
{% hint style="danger" %}
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Frase.
{% endhint %}

1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_475.png)) icon of the corresponding user. A drop-down list is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_476.png)) icon of the corresponding user. A drop-down list is displayed.
