...
Worknet. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Worknet, you must complete the following main
...
To add a business hub and connect it to Worknet, you must complete the
following steps:
...
​**IMPORTANT:** Cerby supports **Username and password** login using your
Slack credentials.
...
To connect your Worknet user account to the business hub so Cerby can manage
