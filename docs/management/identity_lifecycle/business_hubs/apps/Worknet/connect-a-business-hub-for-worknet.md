...
​**IMPORTANT:** Cerby supports **Username and password** login using your Slack credentials.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-worknet.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-worknet.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-worknet.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-worknet.md#exempt-unmatched-users)
