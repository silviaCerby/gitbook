---
intercom_id: 10023791
---

# Connect a business hub for Playable
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage Playable's users and assets.
...
This article provides instructions on how to connect a business hub for Playable. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * The ID of your Payable account. To find it, perform the following actions:
    ...
    3. Copy the ID from the address bar. It’s the number after the **accounts/** subdirectory. For example, `https://console.playable.video/#/accounts/abcdefg.playable.video`
...
To add a business hub and connect it to Playable, you must complete the following steps:
  ...
  5. Select the **Playable Tenant** app from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Unique Identifier:** It is the identifier of your organizational account within Playable. See the [Requirements](connect-a-business-hub-for-playable.md#requirements) section to learn how to get it.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed. One of the following scenarios occurs:
     ...
     * If you don’t have an account for the app, you are prompted to add it:
       ...
       1. Enter your account details in the corresponding fields:
          ...
          2. **App:** It is the name of the app or service provider to which the account belongs or the login URL.
...
To connect your app’s user account to the business hub so Cerby can manage and protect it, you must complete the following steps:
  ...
  2. Click the **Log in** button of the corresponding Playable account card. The **Connect your Playable Tenant Account** dialog box is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-playable.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-playable.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-playable.md#exempt-unmatched-users)
