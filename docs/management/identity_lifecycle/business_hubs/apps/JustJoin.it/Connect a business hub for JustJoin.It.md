...
members’ roles is not available for this business hub because JustJoin.It only
supports the**Employer's** role. {% endhint %}

This article provides instructions on how to connect a business hub for
JustJoin.It. For other app-specific articles and videos, review the
...
To connect a business hub for JustJoin.It, you must complete the following
...
To add a business hub and connect it to JustJoin.It, you must complete the
following steps:
...
The next step is 3\. Connect your JustJoin.It user account to the business
hub.

## 3\. Connect your JustJoin.It user account to the business hub

To connect your JustJoin.It user account to the business hub so Cerby can
