...
Voices. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Voices, you must complete the following main
steps from the Cerby web app dashboard:

  1. Add a business hub and connect it to Voices[ ](https://help.cerby.com/en/articles/9046120-connect-an-app#h_039a665169)
...
To add a business hub and connect it to Voices, you must complete the
following steps:
...
To connect your Voices user account to the business hub so Cerby can manage
