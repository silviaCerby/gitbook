---
description: This article describes how to connect a business hub to centrally manage the users of Asana from Cerby.
intercom_id: 10548117
---
...
This article provides instructions on how to connect a business hub for Asana. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Asana, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Asana](connect-a-business-hub-for-asana.md#id-1.-add-a-business-hub-and-connect-it-to-asana)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-asana.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Asana user account to the business hub](connect-a-business-hub-for-asana.md#id-3.-connect-your-asana-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-asana.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Asana Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-asana.md#id-requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-asana.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-asana.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Asana user account to the business hub](connect-a-business-hub-for-asana.md#id-3.-connect-your-asana-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-asana.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-asana.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-asana.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-asana.md#id-exempt-unmatched-users)
