...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Asana Hub**. For instructions on how to find it, read the Requirements section.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **Settings** (<figure><img src="../../../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz_10.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is 3\. Connect your Asana user account to the business hub.
...
{% endhint %}
  ...
  1. Click the **More options** (<figure><img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_442.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding user. A drop-down list is displayed.
