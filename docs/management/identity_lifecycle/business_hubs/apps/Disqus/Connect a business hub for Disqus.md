...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** Disqus requires
an additional field for the **Username** to create accounts. You must provide
this value when adding users to your external app. {% endhint %}

This article provides instructions on how to connect a business hub for
Disqus. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Disqus, you must complete the following main
...
To add a business hub and connect it to Disqus, you must complete the
following steps:
...
To connect your Disqus user account to the business hub so Cerby can manage
