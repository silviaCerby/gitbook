...
This article provides instructions on how to connect a business hub for WP
Engine. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for WP Engine, you must complete the following main
...
To add a business hub and connect it to WP Engine, you must complete the
following steps:
...
​**IMPORTANT** : The **Username and password** option is not supported for WP
Engine.
...
To connect your WP Engine user account to the business hub so Cerby can manage
