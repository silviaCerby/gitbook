...
This article provides instructions on how to connect a business hub for Govly.
...
To connect a business hub for Govly, you must complete the following main
...
To add a business hub and connect it to Govly, you must complete the following
steps:
...
To connect your Govly user account to the business hub so Cerby can manage and
