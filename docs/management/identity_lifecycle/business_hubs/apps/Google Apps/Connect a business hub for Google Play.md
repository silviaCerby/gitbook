...
users and assets of Google Play.
...
Play. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Google Play, you must complete the following
...
To add a business hub and connect it to Google Play, you must complete the
following steps:
...
The next step is 3\. Connect your Google Play user account to the business
hub.

## 3\. Connect your Google Play user account to the business hub

To connect your Google Play user account to the business hub so Cerby can
