...
update user roles is not currently available for this business hub. {% endhint
%}

This article provides instructions on how to connect a business hub for DV360.
...
To connect a business hub for DV360, you must complete the following main
...
To add a business hub and connect it to DV360, you must complete the following
steps:
...
**IMPORTANT:** Cerby supports SSO through your Google Account and Okta for
DV360.
...
To connect your DV360 user account to the business hub so Cerby can manage and
