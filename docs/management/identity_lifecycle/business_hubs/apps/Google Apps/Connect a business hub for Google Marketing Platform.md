...
users of Google Marketing Platform.
...
Marketing Platform. For other app-specific articles and videos, review the
...
The ID is displayed below the **Organization ID** label, as shown in **Figure
1**.  
​

![](images/google_marketing_org_id.png)
...
To connect a business hub for Google Marketing Platform, you must complete the
...
To add a business hub and connect it to Google Marketing Platform, you must
...
**IMPORTANT:** The**Username and password** option**** is not currently
available for Google Marketing Platform.
...
The next step is 3\. Connect your Google Marketing Platform user account to
the business hub.

## 3\. Connect your Google Marketing Platform user account to the business hub

To connect your Google Marketing Platform user account to the business hub so
...
Google Marketing Platform. {% endhint %}
