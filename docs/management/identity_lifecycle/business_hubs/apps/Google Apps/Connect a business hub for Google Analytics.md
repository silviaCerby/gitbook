...
users and assets of Google Analytics.
...
Analytics. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Google Analytics, you must complete the
...
To add a business hub and connect it to Google Analytics, you must complete
the following steps:
...
The next step is 3\. Connect your Google Analytics user account to the
business hub.

## 3\. Connect your Google Analytics user account to the business hub

To connect your Google Analytics user account to the business hub so Cerby can
