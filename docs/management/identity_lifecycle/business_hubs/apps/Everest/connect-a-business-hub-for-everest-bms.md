---
description: This article describes how to connect a business hub to centrally manage the users of Everest (BMS) from Cerby.
intercom_id: 12844810
---

# Connect a business hub for Everest (BMS)
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Everest (BMS).
...
This article provides instructions on how to connect a business hub for Everest (BMS). For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Business unique identifier. You can find this ID after logging in to the **Microsoft My Apps** portal. The ID corresponds to the name of the card associated with the **Everest (BMS)** instance you want to connect to Cerby.
* * *

## Connect a business hub for Everest (BMS)

To connect a business hub for Everest (BMS), you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Everest (BMS)](connect-a-business-hub-for-everest-bms.md#id-1.-add-a-business-hub-and-connect-it-to-everest-(bms))
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-everest-bms.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Everest (BMS) user account to the business hub](connect-a-business-hub-for-everest-bms.md#id-3.-connect-your-everest-(bms)-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-everest-bms.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Everest (BMS)

To add a business hub and connect it to Everest (BMS), you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Everest (BMS)** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business unique identifier:** It is the unique identifier of your business or organization in **Everest (BMS)**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-everest-bms.md#id-requirements) section.
...
​**IMPORTANT** : Cerby supports SSO only through Microsoft 365 Enterprise for Everest (BMS).

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Everest (BMS) accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-everest-bms.md#id-requirements) section.
...
The next step is [3. Connect your Everest (BMS) user account to the business hub](connect-a-business-hub-for-everest-bms.md#id-3.-connect-your-everest-(bms)-user-account-to-the-business-hub).

### 3\. Connect your Everest (BMS) user account to the business hub

To connect your Everest (BMS) user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Everest (BMS) account card. The **Connect your Everest (BMS) Account** dialog box is displayed.
  3. Enter the login credentials of your **Everest (BMS)** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-everest-bms.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_49.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-everest-bms.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-everest-bms.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-everest-bms.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Everest (BMS).


{% endhint %}

  1. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1831363522/d521531aad0409ec99279b1d58b3/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1763150400&signature=9490267cf53975334c0b829e089a2781464cd310eb3a4e180d24c52ca3f3ee86&req=dSgkF8p4noRdW%2FMU3HP0gAx%2Fb4%2BE2%2FMgV3cHHdDtNHVc4BbCKY0%3D%0A" alt="">) icon of the corresponding user. A drop-down menu is displayed.
