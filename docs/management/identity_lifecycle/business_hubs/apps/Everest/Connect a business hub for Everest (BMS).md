...
Everest (BMS). For other app-specific articles and videos, review the
...
To connect a business hub for Everest (BMS), you must complete the following
...
To add a business hub and connect it to Everest (BMS), you must complete the
following steps:
...
​**IMPORTANT** : Cerby supports SSO only through Microsoft 365 Enterprise for
Everest (BMS).
...
The next step is 3\. Connect your Everest (BMS) user account to the business
hub.

## 3\. Connect your Everest (BMS) user account to the business hub

To connect your Everest (BMS) user account to the business hub so Cerby can
