---
description: This article describes how to connect a business hub to centrally manage the users of 10bis from Cerby.
intercom_id: 10517544
---
...
This article provides instructions on how to connect a business hub for 10bis. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for 10bis, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to 10bis](connect-a-business-hub-for-10bis.md#id-1.-add-a-business-hub-and-connect-it-to-10bis)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-10bis.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your 10bis user account to the business hub](connect-a-business-hub-for-10bis.md#id-3.-connect-your-10bis-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-10bis.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-10bis.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-10bis.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your 10bis user account to the business hub](connect-a-business-hub-for-10bis.md#id-3.-connect-your-10bis-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-10bis.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_459.png" alt="">) icon of the corresponding business hub card. A drop-down list is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-10bis.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-10bis.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-10bis.md#id-exempt-unmatched-users)
...
{% endhint %}
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_460.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
