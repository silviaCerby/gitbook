...
endhint %}{% hint style="info" %} **NOTE:** Updating app members’ roles is not
available for this business hub because 10bis doesn’t support roles. However,
you can update your app members' group via an automation task triggered from
Cerby. This task receives from the Cerby platform a list of users and groups
to reassign. The Cerby agent updates the group of each user in your 10bis. {%
endhint %}

This article provides instructions on how to connect a business hub for 10bis.
...
To connect a business hub for 10bis, you must complete the following main
...
To add a business hub and connect it to 10bis, you must complete the following
steps:
...
To connect your 10bis user account to the business hub so Cerby can manage and
