...
Affinity. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Affinity, you must complete the following main
...
To add a business hub and connect it to Affinity, you must complete the
following steps:
...
**IMPORTANT:** Affinity supports Google SSO via Okta. The **Username and
password** option is not currently available for this app.
...
To connect your Affinity user account to the business hub so Cerby can manage
