---
description: This article describes how to connect a business hub to centrally manage the users of Affinity from Cerby.
intercom_id: 12133759
---
...
This article provides instructions on how to connect a business hub for Affinity. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for Affinity, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Affinity](connect-a-business-hub-for-affinity.md#id-1.-add-a-business-hub-and-connect-it-to-affinity)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-affinity.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Affinity user account to the business hub](connect-a-business-hub-for-affinity.md#id-3.-connect-your-affinity-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-affinity.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Affinity subdomain:** It is the unique identifier of your business or organization in **Affinity Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-affinity.md#id-requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-affinity.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-affinity.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Affinity user account to the business hub](connect-a-business-hub-for-affinity.md#id-3.-connect-your-affinity-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-affinity.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_213.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-affinity.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-affinity.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-affinity.md#id-exempt-unmatched-users)
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_215.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
