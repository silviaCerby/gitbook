...
apps). {% endhint %}{% hint style="info" %} **NOTE:** The automated tasks to
**add users** and **update user roles** are not currently available for this
business hub. {% endhint %}

This article provides instructions on how to connect a business hub for
SheerID. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for SheerID, you must complete the following main
...
To add a business hub and connect it to SheerID, you must complete the
following steps:
...
To connect your SheerID user account to the business hub so Cerby can manage
