...
Enterprise. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Readme Enterprise, you must complete the
...
To add a business hub and connect it to Readme Enterprise, you must complete
the following steps:
...
The next step is 3\. Connect your Readme Enterprise user account to the
business hub.

## 3\. Connect your Readme Enterprise user account to the business hub

To connect your Readme Enterprise user account to the business hub so Cerby
