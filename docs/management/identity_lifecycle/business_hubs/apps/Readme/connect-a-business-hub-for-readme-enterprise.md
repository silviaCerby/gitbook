...
* A Unique identifier. You can find the identifier after logging in to Readme Enterprise. The identifier corresponds to the project name indicated in the**Enterprise Projects** section, as shown in **Figure 1**. **Figure 1.** Project name on the Readme Enterprise
