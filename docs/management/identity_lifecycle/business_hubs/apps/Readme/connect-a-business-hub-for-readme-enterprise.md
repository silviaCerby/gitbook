---
description: This article describes how to connect a business hub to centrally manage the users of Readme Enterprise from Cerby.
intercom_id: 11271918
---

# Connect a business hub for Readme Enterprise
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Readme Enterprise.
...
This article provides instructions on how to connect a business hub for Readme Enterprise. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A project in Readme Enterprise
  ...
  * A Unique identifier. You can find the identifier after logging in to Readme Enterprise. The identifier corresponds to the project name indicated in the**Enterprise Projects** section, as shown in **Figure 1**.

<img src="../../../../../../.gitbook/assets/image_21.png" alt="">

**Figure 1.** Project name on the Readme Enterprise

* * *

## Connect a business hub for Readme Enterprise

To connect a business hub for Readme Enterprise, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Readme Enterprise](connect-a-business-hub-for-readme-enterprise.md#id-1.-add-a-business-hub-and-connect-it-to-readme-enterprise)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-readme-enterprise.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Readme Enterprise user account to the business hub](connect-a-business-hub-for-readme-enterprise.md#id-3.-connect-your-readme-enterprise-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-readme-enterprise.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Readme Enterprise

To add a business hub and connect it to Readme Enterprise, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Readme Enterprise Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Unique identifier:** It is the unique identifier of your business or organization in **Readme Enterprise Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-readme-enterprise.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Readme Enterprise accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-readme-enterprise.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-readme-enterprise.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_308.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Readme Enterprise user account to the business hub](connect-a-business-hub-for-readme-enterprise.md#id-3.-connect-your-readme-enterprise-user-account-to-the-business-hub).

### 3\. Connect your Readme Enterprise user account to the business hub

To connect your Readme Enterprise user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Readme Enterprise Hub account card. The **Connect your Readme Enterprise Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Readme Enterprise** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-readme-enterprise.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_309.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-readme-enterprise.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-readme-enterprise.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-readme-enterprise.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Readme Enterprise.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_310.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_311.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
The following are the supported features of business hubs you can use:
  ...
  * [Update team member roles in your app via a business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-users/update-team-member-roles-in-your-app-via-a-business-hub)
