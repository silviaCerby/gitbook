...
update app members’ roles is not available for this business hub because
Readme Projects only supports the **Admin** role. {% endhint %}

This article provides instructions on how to connect a business hub for Readme
Projects. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Readme Projects, you must complete the following
...
To add a business hub and connect it to Readme Projects, you must complete the
following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not supported by Readme
Projects.
...
The next step is 3\. Connect your Readme Projects user account to the business
hub.

## 3\. Connect your Readme Projects user account to the business hub

To connect your Readme Projects user account to the business hub so Cerby can
