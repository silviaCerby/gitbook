...
users and assets of Uber for Business.
...
This article provides instructions on how to connect a business hub for Uber
for Business. For other app-specific articles and videos, review the
...
To connect a business hub for Uber for Business, you must complete the
...
To add a business hub and connect it to Uber for Business, you must complete
the following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not supported by Uber
for Business.
...
The next step is 3\. Connect your Uber for Business user account to the
business hub.

## 3\. Connect your Uber for Business user account to the business hub

To connect your Uber for Business user account to the business hub so Cerby
