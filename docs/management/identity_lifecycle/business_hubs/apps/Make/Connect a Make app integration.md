...
members and roles in Make, you must complete the following steps:
  ...
  2. Click the **More options** (![](images/AD_4nXeTwaO6FjgmgWJSevQmJK3jCSV4Ee-IZiAndgiwclJq3VwDWkzhHp43em4udIQyjk7EAXQ6EiaM52WUCKjjaWJjxeF-nPeIjFkDYJOQjrGhdJuiIbWST8aXPry5KOkGidvUdhU4HTLQrt9vEQ0PBq3pGeUu)) icon of the Make Tenant app card that you added. A drop-down list is displayed.
...
following steps:
  ...
  2. Click the **More options** (![](images/AD_4nXeTwaO6FjgmgWJSevQmJK3jCSV4Ee-IZiAndgiwclJq3VwDWkzhHp43em4udIQyjk7EAXQ6EiaM52WUCKjjaWJjxeF-nPeIjFkDYJOQjrGhdJuiIbWST8aXPry5KOkGidvUdhU4HTLQrt9vEQ0PBq3pGeUu)) icon of the Make Tenant app card. A drop-down list is displayed.
...
To remove unmatched users, you must perform the following steps:
  ...
  5. Click the **More options** (![](images/AD_4nXeTwaO6FjgmgWJSevQmJK3jCSV4Ee-IZiAndgiwclJq3VwDWkzhHp43em4udIQyjk7EAXQ6EiaM52WUCKjjaWJjxeF-nPeIjFkDYJOQjrGhdJuiIbWST8aXPry5KOkGidvUdhU4HTLQrt9vEQ0PBq3pGeUu)) icon of the corresponding user. A drop-down list is displayed.
