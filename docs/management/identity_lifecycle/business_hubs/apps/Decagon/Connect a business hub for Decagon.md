...
{% hint style="info" %} **NOTE:** The automated task to **add users** is not
available for this business hub because Decagon uses Just-In-Time (JIT)****
provisioning, which automatically creates user accounts when they first sign
in. {% endhint %}{% hint style="success" %} **TIP:** For more details about
the automated tasks of a business hub, how it works, and the supported apps,
read the article [Explore Business
...
Decagon. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Decagon, you must complete the following main
...
To add a business hub and connect it to Decagon, you must complete the
following steps:
...
To connect your Decagon user account to the business hub so Cerby can manage
