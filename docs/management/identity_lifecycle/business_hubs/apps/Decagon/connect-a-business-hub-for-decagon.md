...
​**IMPORTANT** : The **Username and password** option is not currently supported for Decagon.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-decagon.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-decagon.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-decagon.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-decagon.md#exempt-unmatched-users)
