...
description: >-
  ...
  users of JP Morgan PaymentNet from Cerby.
---

# Connect a business hub for JP Morgan PaymentNet
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of JP Morgan PaymentNet.
...
{% hint style="danger" %}
**IMPORTANT:** JP Morgan PaymentNet requires an additional field, **Hierarchy ID** , to create and update user accounts. You must provide this value when adding users to your external app.
{% endhint %}

This article provides instructions on how to connect a business hub for JP Morgan PaymentNet. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
* An automation account, meaning an active user account with a native **Manager** role in JP Morgan PaymentNet, to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)

***

## Connect a business hub for JP Morgan PaymentNet

To connect a business hub for JP Morgan PaymentNet, you must complete the following main steps from the Cerby web app dashboard:

1. [Add a business hub and connect it to JP Morgan PaymentNet](connect-a-business-hub-for-jp-morgan-paymentnet.md#id-1.-add-a-business-hub-and-connect-it-to-jp-morgan-paymentnet)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-jp-morgan-paymentnet.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your JP Morgan PaymentNet user account to the business hub](connect-a-business-hub-for-jp-morgan-paymentnet.md#id-3.-connect-your-jp-morgan-paymentnet-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-jp-morgan-paymentnet.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1. Add a business hub and connect it to JP Morgan PaymentNet

To add a business hub and connect it to JP Morgan PaymentNet, you must complete the following steps:
...
5. Select **JP Morgan PaymentNet Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
...
2. Click the **More options** (![](https://downloads.intercomcdn.com/i/o/pc0ldyqu/1337118523/d67c21a49b18a83548bcd74eac2a/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1765929600\&signature=8462e784a5c2de8c56d76fa12bb10c4da619f25c5882dce7a4c1850720a23c5a\&req=dSMkEch%2FlYRdWvMW3nq%2BgXneoYBRe015y4uSSWr%2Fb7vFBSnEAvqm3cBdwO3n%0AdfJp0frHtFVGV9XFy1TpJoxw53Q%3D%0A)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your JP Morgan PaymentNet user account to the business hub](connect-a-business-hub-for-jp-morgan-paymentnet.md#id-3.-connect-your-jp-morgan-paymentnet-user-account-to-the-business-hub).

### 3. Connect your JP Morgan PaymentNet user account to the business hub

To connect your JP Morgan PaymentNet user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
2. Click the **Log in** button of the corresponding JP Morgan PaymentNet Hub account card. The **Connect your JP Morgan PaymentNet Hub Account** dialog box is displayed.
3. Enter the login credentials of your **JP Morgan PaymentNet** user account.
4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-jp-morgan-paymentnet.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
{% hint style="danger" %}
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in JP Morgan PaymentNet.
{% endhint %}

1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_1.png)) icon of the corresponding user. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_2.png)) icon of the corresponding user. A drop-down list is displayed.
