...
This article provides instructions on how to connect a business hub for Gem.
...
To connect a business hub for Gem, you must complete the following main steps
...
To add a business hub and connect it to Gem, you must complete the following
steps:
...
To connect your Gem user account to the business hub so Cerby can manage and
