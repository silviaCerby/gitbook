...
​**NOTE:** Cerby supports SSO only through Okta for Gem.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-gem.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-gem.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-gem.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-gem.md#exempt-unmatched-users)
