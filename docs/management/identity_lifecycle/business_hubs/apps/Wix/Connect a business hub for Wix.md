...
This article provides instructions on how to connect a business hub for Wix.
...
To connect a business hub for Wix, you must complete the following main steps
...
To add a business hub and connect it to Wix, you must complete the following
steps:
...
To connect your Wix user account to the business hub so Cerby can manage and
