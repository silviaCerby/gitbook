...
* A team name. You can find the name in the settings by completing the following steps after logging in to Hootsuite:
  ...
  3.  Click the **Expand** (
      ...
      <figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1768774324/94bc406fab3fcb8fa37f2d7c3fd2/41882112081435?expires=1759969950&#x26;signature=df961ce281f0219fb220b31e8094c040f98c14bb0b3b340ef43989058e21139d&#x26;req=dSchHs55mYJdXfMU3HP0gDy7EtBGIh40tAqzPyfyokO5QJ471bs%3D%0A" alt=""><figcaption></figcaption></figure>

      ) icon to display the **Admin setting** menu.
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **Team name:** It is the unique identifier of your business or organization in **Hootsuite Hub**. For instructions on how to find it, read the Requirements section.
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Username and password** option because account security and access are managed by Cerby, and users log in with their credentials after saving them in Cerby. **IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported by Hootsuite.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_132.png" alt=""><figcaption></figcaption></figure>
...
The next step is 3. Connect your Hootsuite user account to the business hub.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_133.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_134.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_135.png" alt=""><figcaption></figcaption></figure>
