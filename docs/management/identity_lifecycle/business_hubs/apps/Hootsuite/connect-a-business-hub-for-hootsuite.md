---
description: This article describes how to connect a business hub to centrally manage the users of Hootsuite from Cerby.
intercom_id: 12544223
---

# Connect a business hub for Hootsuite
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Hootsuite.
...
This article provides instructions on how to connect a business hub for Hootsuite. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **Admin** role in Hootsuite to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
  * A team name. You can find the name in the settings by completing the following steps after logging in to Hootsuite:

    1. Click the user profile icon at the bottom of the left navigation panel.
    2. Select the **Social account and team (BETA)** option. Your organization's overview page is displayed.
    3. Click the **Expand** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1768774324/94bc406fab3fcb8fa37f2d7c3fd2/41882112081435?expires=1759969950&signature=df961ce281f0219fb220b31e8094c040f98c14bb0b3b340ef43989058e21139d&req=dSchHs55mYJdXfMU3HP0gDy7EtBGIh40tAqzPyfyokO5QJ471bs%3D%0A" alt="">) icon to display the **Admin setting** menu.
    4. Select the **Teams** option. The **All teams** page is displayed, listing all your teams as shown in **Figure 1.**

<img src="../../../../../../.gitbook/assets/image_3.png" alt="">

**Figure 1.** **All teams** page in Hootsuite

    5. Copy the name of the team and paste it when connecting the business hub.

* * *

## Connect a business hub for Hootsuite

To connect a business hub for Hootsuite, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Hootsuite](connect-a-business-hub-for-hootsuite.md#id-1.-add-a-business-hub-and-connect-it-to-hootsuite)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-hootsuite.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Hootsuite user account to the business hub](connect-a-business-hub-for-hootsuite.md#id-3.-connect-your-hootsuite-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-hootsuite.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Hootsuite

To add a business hub and connect it to Hootsuite, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Hootsuite Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Team name:** It is the unique identifier of your business or organization in **Hootsuite Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-hootsuite.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported by Hootsuite.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Hootsuite accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-hootsuite.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-hootsuite.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_132.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Hootsuite user account to the business hub](connect-a-business-hub-for-hootsuite.md#id-3.-connect-your-hootsuite-user-account-to-the-business-hub).

### 3\. Connect your Hootsuite user account to the business hub

To connect your Hootsuite user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Hootsuite Hub account card. The **Connect your Hootsuite Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Hootsuite** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-hootsuite.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_133.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-hootsuite.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-hootsuite.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-hootsuite.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Hootsuite.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_134.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_135.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
