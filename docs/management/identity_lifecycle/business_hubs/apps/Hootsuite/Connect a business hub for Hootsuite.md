...
Hootsuite. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Hootsuite, you must complete the following main
...
To add a business hub and connect it to Hootsuite, you must complete the
following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported
by Hootsuite.
...
To connect your Hootsuite user account to the business hub so Cerby can manage
