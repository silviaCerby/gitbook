...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** When you add a
business hub and connect it to Stripe using single sign-on (SSO) as the user
management and login method, the automated tasks to **create users** and
**update user roles** are not supported due to Stripe’s security verification
process. {% endhint %}

This article provides instructions on how to connect a business hub for
Stripe. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Stripe, you must complete the following main
...
To add a business hub and connect it to Stripe, you must complete the
following steps:
...
To connect your Stripe user account to the business hub so Cerby can manage
