...
To connect a business hub for Trustpilot, you must complete the following main
...
To add a business hub and connect it to Trustpilot, you must complete the
following steps:
...
To connect your Trustpilot user account to the business hub so Cerby can
