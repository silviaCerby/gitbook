---
description: This article describes how to connect a business hub to centrally manage the users of Explorium from Cerby.
intercom_id: 10315295
---

# [UNPUBLISHED] Connect a business hub for Explorium
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Explorium.
...
This article provides instructions on how to connect a business hub for Explorium. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  **NOTE:** Explorium only supports SSO with Google.

* * *

## Connect a business hub for Explorium

To connect a business hub for Explorium, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Explorium](unpublished-connect-a-business-hub-for-explorium.md#id-1-.-add-a-business-hub-and-connect-it-to-explorium)
  2. [Check for updates to import users and roles to Cerby](unpublished-connect-a-business-hub-for-explorium.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Explorium user account to the business hub](unpublished-connect-a-business-hub-for-explorium.md#id-3.-connect-your-explorium-user-account-to-the-business-hub)
  4. [Manage unmatched users](unpublished-connect-a-business-hub-for-explorium.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1 . Add a business hub and connect it to Explorium

To add a business hub and connect it to Explorium, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Explorium Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub. You must select one of the following methods:
       ...
       **IMPORTANT:** Explorium only supports SSO with Google.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Explorium accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](unpublished-connect-a-business-hub-for-explorium.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](unpublished-connect-a-business-hub-for-explorium.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Explorium user account to the business hub](unpublished-connect-a-business-hub-for-explorium.md#id-3.-connect-your-explorium-user-account-to-the-business-hub).

### 3\. Connect your Explorium user account to the business hub

To connect your Explorium user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Explorium Hub account card. The **Connect your Explorium Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Explorium user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](unpublished-connect-a-business-hub-for-explorium.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](unpublished-connect-a-business-hub-for-explorium.md#id-match-users)
  * [Remove unmatched users](unpublished-connect-a-business-hub-for-explorium.md#id-remove-unmatched-users)
  * [Exempt unmatched users](unpublished-connect-a-business-hub-for-explorium.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Explorium.
