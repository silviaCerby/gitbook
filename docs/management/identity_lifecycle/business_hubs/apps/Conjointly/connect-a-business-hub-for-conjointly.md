...
description: >-
  ...
  users of Conjointly from Cerby.
---

# Connect a business hub for Conjointly
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Conjointly.
...
This article provides instructions on how to connect a business hub for Conjointly. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
* A collaboration space in Conjointly
...
To connect a business hub for Conjointly, you must complete the following main steps from the Cerby web app dashboard:

1. [Add a business hub and connect it to Conjointly](connect-a-business-hub-for-conjointly.md#id-1.-add-a-business-hub-and-connect-it-to-conjointly)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-conjointly.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your Conjointly user account to the business hub](connect-a-business-hub-for-conjointly.md#id-3.-connect-your-conjointly-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-conjointly.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1. Add a business hub and connect it to Conjointly

To add a business hub and connect it to Conjointly, you must complete the following steps:
...
5. Select **Conjointly Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-conjointly.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **Settings** (![](../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz_5.png)) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your Conjointly user account to the business hub](connect-a-business-hub-for-conjointly.md#id-3.-connect-your-conjointly-user-account-to-the-business-hub).

### 3. Connect your Conjointly user account to the business hub

To connect your Conjointly user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
2. Click the **Log in** button of the corresponding Conjointly Hub account card. The **Connect your Conjointly Hub Account** dialog box is displayed.
3. Enter the login credentials of your **Conjointly** user account.
4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-conjointly.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_421.png)) icon of the corresponding business hub card. A drop-down list is displayed.
...
{% hint style="danger" %}
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Conjointly.
{% endhint %}

1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_422.png)) icon of the corresponding user. A drop-down list is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_423.png)) icon of the corresponding user. A drop-down list is displayed.
