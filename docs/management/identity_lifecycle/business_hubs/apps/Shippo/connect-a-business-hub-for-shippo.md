...
# Connect a business hub for Shippo
...
As a user with any workspace role in Cerby except Guest User and Login-Only, you can connect a business hub integration to centrally manage Shippo's users.
...
**NOTE:** The automated task to update app members’ roles is not available for this business hub because Shippo only supports one role and one **Account Owner**.


{% endhint %}

This article provides instructions on how to connect a business hub for Shippo. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Shippo, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Shippo](connect-a-business-hub-for-shippo.md#id-1.-add-a-business-hub-and-connect-it-to-shippo)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-shippo.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Shippo user account to the business hub](connect-a-business-hub-for-shippo.md#id-3.-connect-your-shippo-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-shippo.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Shippo

To add a business hub and connect it to Shippo, you must complete the following steps:
  ...
  **TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Shippo Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-shippo.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Shippo user account to the business hub](connect-a-business-hub-for-shippo.md#id-3.-connect-your-shippo-user-account-to-the-business-hub).

### 3\. Connect your Shippo user account to the business hub

To connect your Shippo user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Shippo Hub account card. The **Connect your Shippo Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Shippo user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-shippo.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-shippo.md#h_53dfa6231a)
  * [Remove unmatched users](connect-a-business-hub-for-shippo.md#h_2c1dfae437)
  * [Exempt unmatched users](connect-a-business-hub-for-shippo.md#h_0fe489c7b9)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Shippo.
