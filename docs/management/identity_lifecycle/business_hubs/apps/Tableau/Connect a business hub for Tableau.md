...
Tableau. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Tableau, you must complete the following main
...
To add a business hub and connect it to Tableau, you must complete the
following steps:
...
To connect your Tableau user account to the business hub so Cerby can manage
...
Manual matching is required when apps don't provide email addresses and for
app members using personal or external accounts that couldn’t be identified or
are not in the corporate directory.
