---
description: "This article describes how to connect a business hub to centrally manage the users of Kahoot from Cerby."
intercom_id: 10293878
---
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Kahoot.
...
**NOTE:** The automated task to update app members’ roles is not available for this business hub because Kahoot **Admins** can only assign **Member** and **Limited Member** roles. Automated invites for new members are also unavailable because invites are sent via an invite link that **Admins** must copy and paste.


{% endhint %}

This article provides instructions on how to connect a business hub for Kahoot. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To add a business hub and connect it to Kahoot, you must complete the following steps:
  ...
  **TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your group in a Kahoot team workspace. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-kahoot.md#requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-kahoot.md#requirements) section
...
To connect your Kahoot user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Kahoot Hub account card. The **Connect your Kahoot Hub Account** dialog box is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-kahoot.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-kahoot.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-kahoot.md#exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Kahoot.
