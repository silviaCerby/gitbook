...
update user roles is not available for this business hub because Tower only
supports one role and one **Account Owner**. {% endhint %}

This article provides instructions on how to connect a business hub for Tower.
...
To connect a business hub for Tower, you must complete the following main
...
To add a business hub and connect it to Tower, you must complete the following
steps:
...
To connect your Tower user account to the business hub so Cerby can manage and
