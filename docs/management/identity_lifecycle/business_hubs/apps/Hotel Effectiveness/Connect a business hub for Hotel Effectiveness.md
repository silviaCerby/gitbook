...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** Hotel
Effectiveness requires the following additional fields to create user
accounts: * **Job title/position** * **Timezone** * **Work Week Preference** *
**Assigned Hotel access** * **Should this user be able to see employee
wages?** * **Which departments can the user access in Labor Management?** You
must provide the required values when adding users to your external app. {%
endhint %}

This article provides instructions on how to connect a business hub for Hotel
Effectiveness. For other app-specific articles and videos, review the
...
To connect a business hub for Hotel Effectiveness, you must complete the
...
To add a business hub and connect it to Hotel Effectiveness, you must complete
the following steps:
...
The next step is 3\. Connect your Hotel Effectiveness user account to the
business hub.

## 3\. Connect your Hotel Effectiveness user account to the business hub

To connect your Hotel Effectiveness user account to the business hub so Cerby
