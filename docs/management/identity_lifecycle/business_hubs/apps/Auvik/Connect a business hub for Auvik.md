...
This article provides instructions on how to connect a business hub for Auvik.
...
To connect a business hub for Auvik, you must complete the following main
...
To add a business hub and connect it to Auvik, you must complete the following
steps:
...
**IMPORTANT:** The**Username and password** option**** is not available for
Auvik.
...
To connect your Auvik user account to the business hub so Cerby can manage and
