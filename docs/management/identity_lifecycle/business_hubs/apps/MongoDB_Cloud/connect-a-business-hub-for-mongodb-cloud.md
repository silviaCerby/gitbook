---
description: This article describes how to connect a business hub to centrally manage the users of MongoDB Cloud from Cerby.
intercom_id: 12295592
---

# Connect a business hub for MongoDB Cloud
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of MongoDB Cloud.
...
This article provides instructions on how to connect a business hub for MongoDB Cloud. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An organization in MongoDB Cloud
  ...
  * An Organization Identifier. You can find the ID in the address bar**** when you are logged in to MongoDB Cloud. The ID is displayed in the address bar as part of the URL, after the **`org` **subfolder**.** For example, **`12a3bbccdef45f1fdfe06d78` **in **`https://cloud.mongodb.com/v2#/org/12a3bbccdef45f1fdfe06d78/access/users`**. Just copy the value and paste it when connecting the business hub.
* * *

## Connect a business hub for MongoDB Cloud

To connect a business hub for MongoDB Cloud, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to MongoDB Cloud](connect-a-business-hub-for-mongodb-cloud.md#id-1.-add-a-business-hub-and-connect-it-to-mongodb-cloud)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-mongodb-cloud.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your MongoDB Cloud user account to the business hub](connect-a-business-hub-for-mongodb-cloud.md#id-3.-connect-your-mongodb-cloud-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-mongodb-cloud.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to MongoDB Cloud

To add a business hub and connect it to MongoDB Cloud, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **MongoDB Cloud Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Organization Identifier:** It is the unique identifier of your business or organization in **MongoDB Cloud Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-mongodb-cloud.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing MongoDB Cloud accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-mongodb-cloud.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-mongodb-cloud.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your MongoDB Cloud user account to the business hub](connect-a-business-hub-for-mongodb-cloud.md#id-3.-connect-your-mongodb-cloud-user-account-to-the-business-hub).

### 3\. Connect your MongoDB Cloud user account to the business hub

To connect your MongoDB Cloud user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding MongoDB Cloud Hub account card. The **Connect your MongoDB Cloud Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **MongoDB Cloud** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-mongodb-cloud.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_177.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-mongodb-cloud.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-mongodb-cloud.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-mongodb-cloud.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in MongoDB Cloud.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_179.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
