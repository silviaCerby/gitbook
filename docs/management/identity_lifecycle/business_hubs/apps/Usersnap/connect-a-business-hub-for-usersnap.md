---
description: This article describes how to connect a business hub to centrally manage the users and assets of Usersnap from Cerby.
intercom_id: 11395400
---

# Connect a business hub for Usersnap
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users and assets of Usersnap.
...
**NOTE:** The **Team admin** role cannot be assigned from Cerby. It can only be transferred by an existing **Team admin**. If you need to transfer ownership, you must do so directly in Usersnap.


{% endhint %}

This article provides instructions on how to connect a business hub for Usersnap. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for Usersnap, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Usersnap](connect-a-business-hub-for-usersnap.md#id-1.-add-a-business-hub-and-connect-it-to-usersnap)
  2. [Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-usersnap.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby)
  3. [Connect your Usersnap user account to the business hub](connect-a-business-hub-for-usersnap.md#id-3.-connect-your-usersnap-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-usersnap.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Usersnap

To add a business hub and connect it to Usersnap, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Usersnap Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Usersnap accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-usersnap.md#id-requirements) section.
...
The next step is [2. Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-usersnap.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby).
...
The next step is [3. Connect your Usersnap user account to the business hub](connect-a-business-hub-for-usersnap.md#id-3.-connect-your-usersnap-user-account-to-the-business-hub).

### 3\. Connect your Usersnap user account to the business hub

To connect your Usersnap user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Usersnap Hub account card. The **Connect your Usersnap Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Usersnap** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-usersnap.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-usersnap.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-usersnap.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-usersnap.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Usersnap.
