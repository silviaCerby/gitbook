...
apps). {% endhint %}{% hint style="info" %} **NOTE:** The **Team admin** role
cannot be assigned from Cerby. It can only be transferred by an existing
**Team admin**. If you need to transfer ownership, you must do so directly in
Usersnap. {% endhint %}

This article provides instructions on how to connect a business hub for
Usersnap. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Usersnap, you must complete the following main
...
To add a business hub and connect it to Usersnap, you must complete the
following steps:
...
To connect your Usersnap user account to the business hub so Cerby can manage
