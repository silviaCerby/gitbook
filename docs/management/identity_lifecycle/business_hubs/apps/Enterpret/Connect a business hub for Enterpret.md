...
apps). {% endhint %}{% hint style="info" %} **NOTE:** Invited users who have
not accepted the invite and joined Enterpret cannot be identified by a check
for updates or removed. Therefore, they are not displayed in the **Members**
table of the business hub details page. {% endhint %}

This article provides instructions on how to connect a business hub for
Enterpret. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Enterpret, you must complete the following main
...
To add a business hub and connect it to Enterpret, you must complete the
following steps:
...
To connect your Enterpret user account to the business hub so Cerby can manage
