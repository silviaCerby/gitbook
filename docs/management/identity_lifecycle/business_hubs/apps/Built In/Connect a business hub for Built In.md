...
This article provides instructions on how to connect a business hub for Built
In. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Built In, you must complete the following main
...
To add a business hub and connect it to Built In, you must complete the
following steps:
...
To connect your Built In user account to the business hub so Cerby can manage
