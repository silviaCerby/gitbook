...
Frame.io. For other app-specific articles and videos, review the [Connecting
...
​**Note:** The **Content Admin** permissions must be over the Frame.io
account, not over the workspace.
...
To connect a business hub for Frame.io, you must complete the following main
...
To add a business hub and connect it to Frame.io, you must complete the
following steps:
...
To connect your Frame.io user account to the business hub so Cerby can manage
