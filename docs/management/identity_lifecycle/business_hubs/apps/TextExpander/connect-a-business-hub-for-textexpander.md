...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Organization ID:** It is the unique identifier of your business or organization in **TextExpander Hub**. For instructions on how to find it, read the Requirements section.
...
The next step is 3\. Connect your TextExpander user account to the business hub.
