...
**update user roles** is not available for this business hub because Cadena
doesn't support roles. {% endhint %}

This article provides instructions on how to connect a business hub for
Cadena. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Cadena, you must complete the following main
...
To add a business hub and connect it to Cadena, you must complete the
following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not supported for
Cadena.
...
To connect your Cadena user account to the business hub so Cerby can manage
