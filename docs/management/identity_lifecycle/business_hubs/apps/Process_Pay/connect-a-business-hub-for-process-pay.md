---
description: This article describes how to connect a business hub to centrally manage the users of Process Pay from Cerby.
intercom_id: 13161347
---

# Connect a business hub for Process Pay
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Process Pay.
...
**NOTE:** The automated task to update user roles is not available for this business hub because Process Pay only supports one role.


{% endhint %}

This article provides instructions on how to connect a business hub for Process Pay. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account in Process Pay, to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
* * *

## Connect a business hub for Process Pay

To connect a business hub for Process Pay, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Process Pay](connect-a-business-hub-for-process-pay.md#id-1.-add-a-business-hub-and-connect-it-to-process-pay)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-process-pay.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Process Pay user account to the business hub](connect-a-business-hub-for-process-pay.md#id-3.-connect-your-process-pay-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-process-pay.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Process Pay

To add a business hub and connect it to Process Pay, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Process Pay Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Process Pay.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Process Pay accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-process-pay.md#id-requirements) section.
...
The next step is [3. Connect your Process Pay user account to the business hub](connect-a-business-hub-for-process-pay.md#id-3.-connect-your-process-pay-user-account-to-the-business-hub).

### 3\. Connect your Process Pay user account to the business hub

To connect your Process Pay user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Process Pay Hub account card. The **Connect your Process Pay Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Process Pay** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-process-pay.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-process-pay.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-process-pay.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-process-pay.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Process Pay.
