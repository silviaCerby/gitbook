...
users and assets (projects) of Mixpanel.
...
Mixpanel. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Mixpanel, you must complete the following main
...
To add a business hub and connect it to Mixpanel, you must complete the
following steps:
...
To connect your Mixpanel user account to the business hub so Cerby can manage
