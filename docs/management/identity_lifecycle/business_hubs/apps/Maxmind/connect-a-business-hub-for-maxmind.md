---
description: This article describes how to connect a business hub to centrally manage the users of Maxmind from Cerby.
intercom_id: 11021945
---

# Connect a business hub for Maxmind
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Maxmind.
...
This article provides instructions on how to connect a business hub for Maxmind. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **Admin** role in Maxmind to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
  * A Business ID. You can find the ID in the following ways:
    * **In the address bar:** When logged in to Maxmind, the ID is displayed in the address bar as part of the URL, between the **`accounts` **and **`people`** subdirectory. For example, **`123456`** in **`https://www.maxmind.com/en/accounts/123456/people/`. **
    * **In the business information or settings:** After logging in to MaxMind, go to the **Account** section in the left menu and select the **Account Information** option. The ID is displayed in the **Account ID** field for you to copy.
* * *

## Connect a business hub for Maxmind

To connect a business hub for Maxmind, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Maxmind](connect-a-business-hub-for-maxmind.md#id-1.-add-a-business-hub-and-connect-it-to-maxmind)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-maxmind.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Maxmind user account to the business hub](connect-a-business-hub-for-maxmind.md#id-3.-connect-your-maxmind-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-maxmind.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Maxmind

To add a business hub and connect it to Maxmind, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Maxmind Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Maxmind Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-maxmind.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub. You must select one of the following methods:
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not supported by Maxmind.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Maxmind accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-maxmind.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-maxmind.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Maxmind user account to the business hub](connect-a-business-hub-for-maxmind.md#id-3.-connect-your-maxmind-user-account-to-the-business-hub).

### 3\. Connect your Maxmind user account to the business hub

To connect your Maxmind user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Maxmind Hub account card. The **Connect your Maxmind Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Maxmind** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-maxmind.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-maxmind.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-maxmind.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-maxmind.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Maxmind.
