...
Productboard. For other app-specific articles and videos, review the
...
To connect a business hub for Productboard, you must complete the following
...
To add a business hub and connect it to Productboard, you must complete the
following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not currently available
for Productboard.
...
The next step is 3\. Connect your Productboard user account to the business
hub.

## 3\. Connect your Productboard user account to the business hub

To connect your Productboard user account to the business hub so Cerby can
