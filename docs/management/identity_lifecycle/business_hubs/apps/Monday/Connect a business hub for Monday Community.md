...
**add users** is not available for this business hub. {% endhint %}

This article provides instructions on how to connect a business hub for Monday
Community. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Monday Community, you must complete the
...
To add a business hub and connect it to Monday Community, you must complete
the following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Monday
Community.
...
The next step is 3\. Connect your Monday Community user account to the
business hub.

## 3\. Connect your Monday Community user account to the business hub

To connect your Monday Community user account to the business hub so Cerby can
