...
This article provides instructions on how to connect a business hub for Adyen.
...
To connect a business hub for Adyen, you must complete the following main
...
To add a business hub and connect it to Adyen, you must complete the following
steps:
...
To connect your Adyen user account to the business hub so Cerby can manage and
