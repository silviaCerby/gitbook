---
description: This article describes how to connect a business hub to centrally manage the users of Wisestamp from Cerby.
intercom_id: 13161735
---

# Connect a business hub for Wisestamp
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Wisestamp.
...
This article provides instructions on how to connect a business hub for Wisestamp. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **Admin** role in Wisestamp to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
* * *

## Connect a business hub for Wisestamp

To connect a business hub for Wisestamp, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Wisestamp](connect-a-business-hub-for-wisestamp.md#id-1.-add-a-business-hub-and-connect-it-to-wisestamp)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-wisestamp.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Wisestamp user account to the business hub](connect-a-business-hub-for-wisestamp.md#id-3.-connect-your-wisestamp-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-wisestamp.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Wisestamp

To add a business hub and connect it to Wisestamp, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Business hub name** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business unique identifier:** It is a unique identifier that differentiates your business hub in Cerby from others for the same app. You can assign an alphanumeric value between 3 and 30 characters without symbols or special characters. Cerby recommends using your Organization Name as the value.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported for Wisestamp.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Wisestamp accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-wisestamp.md#id-requirements) section.
...
The next step is [3. Connect your Wisestamp user account to the business hub](connect-a-business-hub-for-wisestamp.md#id-3.-connect-your-wisestamp-user-account-to-the-business-hub).

### 3\. Connect your Wisestamp user account to the business hub

To connect your Wisestamp user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Business hub name account card. The **Connect your Business hub name Account** dialog box is displayed.
  3. Enter the login credentials of your **Wisestamp** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-wisestamp.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-wisestamp.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-wisestamp.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-wisestamp.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Wisestamp.
