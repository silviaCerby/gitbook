...
update user roles is not available for this business hub because Smartling
does not support updating user roles. To change a user's role, you must remove
the user and re-add them with the desired role. {% endhint %}

This article provides instructions on how to connect a business hub for
Smartling. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Smartling, you must complete the following main
...
To add a business hub and connect it to Smartling, you must complete the
following steps:
...
To connect your Smartling user account to the business hub so Cerby can manage
