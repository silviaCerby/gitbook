...
This article provides instructions on how to connect a business hub for Stack
Exchange. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Stack Exchange, you must complete the following
...
To add a business hub and connect it to Stack Exchange, you must complete the
following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not supported by Stack
Exchange.
...
The next step is 3\. Connect your Stack Exchange user account to the business
hub.

## 3\. Connect your Stack Exchange user account to the business hub

To connect your Stack Exchange user account to the business hub so Cerby can
