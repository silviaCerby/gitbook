...
This article provides instructions on how to connect a business hub for Prism
HR. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Prism HR, you must complete the following main
...
To add a business hub and connect it to Prism HR, you must complete the
following steps:
...
**IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Prism
HR.
...
To connect your Prism HR user account to the business hub so Cerby can manage
