...
This article provides instructions on how to connect a business hub for Dock.
...
To connect a business hub for Dock, you must complete the following main steps
...
To add a business hub and connect it to Dock, you must complete the following
steps:
...
service-account-for-your-business-hub) because you may need to add the account
first and then, add the business hub.
...
To connect your Dock user account to the business hub so Cerby can manage and
