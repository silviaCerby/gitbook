...
# Connect a business hub for Dock
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Dock.
...
This article provides instructions on how to connect a business hub for Dock. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A business ID. You can find the ID in the address bar after logging in to Dock. It’s the subdomain of the URL. For example, **`cerby`** in **`https://cerby.dock.us`**. Just copy the value and paste it when requested while connecting the business hub.
* * *

## Connect a business hub for Dock

To connect a business hub for Dock, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Dock](connect-a-business-hub-for-dock.md#id-1.-add-a-business-hub-and-connect-it-to-dock)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-dock.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Dock user account to the business hub](connect-a-business-hub-for-dock.md#id-3.-connect-your-dock-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-dock.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Dock

To add a business hub and connect it to Dock, you must complete the following steps:
  ...
  **TIP:** You can select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Dock Tenant** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your Dock workspace.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-dock.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Dock user account to the business hub](connect-a-business-hub-for-dock.md#id-3.-connect-your-dock-user-account-to-the-business-hub).

### 3\. Connect your Dock user account to the business hub

To connect your Dock user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Dock Tenant account card. The **Connect your Dock Tenant Account** dialog box is displayed.
  3. Enter the login credentials of your Dock user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-dock.md#id-4.-manage-unmatched-users).
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Dock.
