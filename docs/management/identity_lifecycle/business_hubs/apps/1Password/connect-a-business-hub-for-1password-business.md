---
description: This article describes how to connect a business hub to centrally manage the users of 1Password Business from Cerby.
intercom_id: 11842679
---
...
This article provides instructions on how to connect a business hub for 1Password Business. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for 1Password Business, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to 1Password Business](connect-a-business-hub-for-1password-business.md#id-1.-add-a-business-hub-and-connect-it-to-1password-business)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-1password-business.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your 1Password Business user account to the business hub](connect-a-business-hub-for-1password-business.md#id-3.-connect-your-1password-business-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-1password-business.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business unique identifier:** It is the unique identifier of your business or organization in **1Password Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-1password-business.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The Single sign-on (SSO) option is not supported by 1Password Business.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-1password-business.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-1password-business.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your 1Password Business user account to the business hub](connect-a-business-hub-for-1password-business.md#id-3.-connect-your-1password-business-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-1password-business.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-1password-business.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-1password-business.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-1password-business.md#id-exempt-unmatched-users)
