...
1Password Business. For other app-specific articles and videos, review the
...
To connect a business hub for 1Password Business, you must complete the
...
To add a business hub and connect it to 1Password Business, you must complete
the following steps:
...
**IMPORTANT:** The Single sign-on (SSO) option is not supported by 1Password
Business.
...
The next step is 3\. Connect your 1Password Business user account to the
business hub.

## 3\. Connect your 1Password Business user account to the business hub

To connect your 1Password Business user account to the business hub so Cerby
