...
* Your Discord server ID (a 19-digit numerical code). You must complete the following steps to get it:
  ...
  2.  Click the **User Settings** (
      ...
      <figure><img src="../../../../.gitbook/assets/unnamed_2.png" alt=""><figcaption></figcaption></figure>

      ) icon next to your user name at the bottom left pane. The **My Account** detail window opens.
  ...
  5.  Click the **ESC** (
      ...
      <figure><img src="../../../../.gitbook/assets/unnamed_3.png" alt=""><figcaption></figcaption></figure>
...
8. Select the Discord account you previously created. **NOTE:** This account must have been previously created. (See the Requirements section.) It doesn't need to have a real Discord user profile.
...
2.  Click the **Settings** (
    ...
    <figure><img src="../../../../.gitbook/assets/unnamed_4.png" alt=""><figcaption></figcaption></figure>

    ) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
3. Click the **Check for updates** button located at the top right of the page. A message box is displayed with information about the process. **NOTE:** Depending on the number of users and roles, the check and import process may take a few minutes.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/unnamed_5.png" alt=""><figcaption></figcaption></figure>

    ) icon on the corresponding business hub card. A drop-down list is displayed.
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/unnamed_6.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/unnamed_7.png" alt=""><figcaption></figcaption></figure>
