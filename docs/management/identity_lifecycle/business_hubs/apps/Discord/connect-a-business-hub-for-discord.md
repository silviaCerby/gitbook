...
* Your Discord server ID (a 19-digit numerical code). You must complete the following steps to get it:
  1. Open the Discord server on the desktop or web app.
  2. Click the **User Settings** (![](../../../../.gitbook/assets/unnamed_2.png)) icon next to your user name at the bottom left pane. The **My Account** detail window opens.
  ...
  5. Click the **ESC** (![](../../../../.gitbook/assets/unnamed_3.png)) button.
...
1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/unnamed_5.png)) icon on the corresponding business hub card. A drop-down list is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/unnamed_6.png)) icon of the corresponding user. A drop-down list is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/unnamed_7.png)) icon of the corresponding user. A drop-down list is displayed.
