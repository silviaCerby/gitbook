---
description: This article describes how to connect a business hub to centrally manage the users of 6sense from Cerby.
intercom_id: 12642838
---
...
This article provides instructions on how to connect a business hub for 6sense. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A business URL subdomain. You can find the sudomain in the address bar when you are logged in to 6sense. For example, **`cerby`** in **`https://cerby.workflows.6sense.com`**. Just copy the value and paste it when connecting the business hub.
* * *
...
To connect a business hub for 6sense, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to 6sense](connect-a-business-hub-for-6sense.md#id-1.-add-a-business-hub-and-connect-it-to-6sense)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-6sense.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your 6sense user account to the business hub](connect-a-business-hub-for-6sense.md#id-3.-connect-your-6sense-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-6sense.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business URL subdomain:** It is the unique identifier of your business or organization in **6sense Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-6sense.md#id-requirements) section.
...
​**IMPORTANT** : The **Username and password** option is not supported for 6sense.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing 6sense accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-6sense.md#id-requirements) section.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_88.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your 6sense user account to the business hub](connect-a-business-hub-for-6sense.md#id-3.-connect-your-6sense-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-6sense.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-6sense.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-6sense.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-6sense.md#id-exempt-unmatched-users)
...
{% endhint %}
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_90.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_91.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
