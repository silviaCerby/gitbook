...
**add users** is not available for this business hub because 6sense uses Just-
In-Time (JIT)**** provisioning, which automatically creates user accounts when
they first sign in. {% endhint %}

This article provides instructions on how to connect a business hub for
6sense. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for 6sense, you must complete the following main
...
To add a business hub and connect it to 6sense, you must complete the
following steps:
...
To connect your 6sense user account to the business hub so Cerby can manage
