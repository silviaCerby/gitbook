...
This article provides instructions on how to connect a business hub for Malt.
...
To connect a business hub for Malt, you must complete the following main steps
...
To add a business hub and connect it to Malt, you must complete the following
steps:
...
To connect your Malt user account to the business hub so Cerby can manage and
