...
To connect a business hub to Backslash, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Backslash](connect-a-business-hub-for-backslash.md#id-1.-add-a-business-hub-and-connect-it-to-backslash)
  2. [Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-backslash.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby)
  3. [Connect your app’s user account to the business hub](connect-a-business-hub-for-backslash.md#id-3.-connect-your-apps-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-backslash.md#id-4.-manage-unmatched-users)
...
The next step is [2. Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-backslash.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby).
...
The next step is [3. Connect your app’s user account to the business hub](connect-a-business-hub-for-backslash.md#id-3.-connect-your-apps-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-backslash.md#id-4.-manage-unmatched-users), which you must complete from your Cerby dashboard.
...
To view the status of the imported app’s users, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXf0FP_RKAf9OorxP0uXz5WGjOTnXvYacp0DJo59PwEDGIIRjrw2H7qgZXHR9AXLFzvcsvA0IhTt7Ze09Lfy_Aa7YYHJmnwEm3jOHua3vkL7XBXL41Rj5PpGZV5_p1sbw2hDk64P4K5IH6R3WMgo2r0UPko.png" alt="">) icon of the corresponding business hub card. A drop-down list is displayed.
...
To remove unmatched users from the app, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXf0FP_RKAf9OorxP0uXz5WGjOTnXvYacp0DJo59PwEDGIIRjrw2H7qgZXHR9AXLFzvcsvA0IhTt7Ze09Lfy_Aa7YYHJmnwEm3jOHua3vkL7XBXL41Rj5PpGZV5_p1sbw2hDk64P4K5IH6R3WMgo2r0UPko_1.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXf0FP_RKAf9OorxP0uXz5WGjOTnXvYacp0DJo59PwEDGIIRjrw2H7qgZXHR9AXLFzvcsvA0IhTt7Ze09Lfy_Aa7YYHJmnwEm3jOHua3vkL7XBXL41Rj5PpGZV5_p1sbw2hDk64P4K5IH6R3WMgo2r0UPko_2.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
