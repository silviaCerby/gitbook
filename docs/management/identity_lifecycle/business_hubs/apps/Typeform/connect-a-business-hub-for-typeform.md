---
description: This article describes how to connect a business hub to centrally manage the users of Typeform from Cerby.
intercom_id: 10386584
---

# Connect a business hub for Typeform
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Typeform.
...
This article provides instructions on how to connect a business hub for Typeform. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An organization ID. You can find the ID in the address bar after logging in to Typeform and navigating to the workspace settings. It’s the last part of the URL. For example, **12ABCDEFGH34IJKLM56** in **<https://admin.typeform.com/accounts/12ABCDEFGH34IJKLM56>**. Just copy the value and paste it when requested while connecting the business hub.
* * *

## Connect a business hub for Typeform

To connect a business hub for Typeform, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Typeform](connect-a-business-hub-for-typeform.md#id-1.-add-a-business-hub-and-connect-it-to-typeform)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-typeform.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Typeform user account to the business hub](connect-a-business-hub-for-typeform.md#id-3.-connect-your-typeform-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-typeform.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Typeform

To add a business hub and connect it to Typeform, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Typeform Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Organization ID:** It is the unique identifier of your organization in Typeform. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-typeform.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Typeform accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-typeform.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-typeform.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Typeform user account to the business hub](connect-a-business-hub-for-typeform.md#id-3.-connect-your-typeform-user-account-to-the-business-hub).

### 3\. Connect your Typeform user account to the business hub

To connect your Typeform user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Typeform Hub account card. The **Connect your Typeform Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Typeform user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-typeform.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1333464811/b0b24f24bef8a26382331b4fc0d2/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1736964000&signature=bc4bc80500c558f1f708220de190374b0c894db38c14b36ca8f8080abe22e05e&req=dSMkFc14mYleWPMW3Hu4gSDo0O4EIu6QiTTeW5y7xHY5LxbWtzD5YpniUxFD%0ARA%3D%3D%0A" alt="">) icon of the corresponding business hub card. A drop-down list is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-typeform.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-typeform.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-typeform.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Typeform.


{% endhint %}

  1. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1333464811/b0b24f24bef8a26382331b4fc0d2/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1736964000&signature=bc4bc80500c558f1f708220de190374b0c894db38c14b36ca8f8080abe22e05e&req=dSMkFc14mYleWPMW3Hu4gSDo0O4EIu6QiTTeW5y7xHY5LxbWtzD5YpniUxFD%0ARA%3D%3D%0A" alt="">) icon of the corresponding user. A drop-down list is displayed.
