...
# Connect a business hub for Frontitude
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users and assets (projects) of Frontitude.
...
**NOTE:** The automated task to update app members’ roles is not available for this business hub because Frontitude only supports one role at the workspace and project levels: **Collaborator**. To differentiate them in Cerby, we use **Collaborator** for the workspace-level role and **Project Collaborator** for the asset-level role.


{% endhint %}

This article provides instructions on how to connect a business hub for Frontitude. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
### 1\. Add a business hub and connect it to Frontitude

To add a business hub and connect it to Frontitude, you must complete the following steps:
  ...
  **TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Frontitude Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
...
The next step is [2. Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-frontitude.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby).
...
The next step is [3. Connect your Frontitude user account to the business hub](connect-a-business-hub-for-frontitude.md#id-3.-connect-your-frontitude-user-account-to-the-business-hub).

### 3\. Connect your Frontitude user account to the business hub

To connect your Frontitude user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Frontitude Hub account card. The **Connect your Frontitude Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Frontitude user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-frontitude.md#id-4.-manage-unmatched-users).
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Frontitude.
