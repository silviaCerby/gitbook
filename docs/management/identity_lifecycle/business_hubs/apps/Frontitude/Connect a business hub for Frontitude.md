...
users and assets (projects) of Frontitude.
...
members’ roles is not available for this business hub because Frontitude only
supports one role at the workspace and project levels: **Collaborator**. To
differentiate them in Cerby, we use **Collaborator** for the workspace-level
role and **Project Collaborator** for the asset-level role. {% endhint %}

This article provides instructions on how to connect a business hub for
Frontitude. For other app-specific articles and videos, review the [Connecting
...
**NOTE:** Frontitude only supports one role at the workspace and project
level: **Collaborator**. Therefore, the service account has this role
...
**IMPORTANT:** This business hub only supports single sign-on (SSO) as the
...
To connect a business hub for Frontitude, you must complete the following main
...
To add a business hub and connect it to Frontitude, you must complete the
following steps:
...
**IMPORTANT:** This business hub doesn’t support the **Username and password**
option.
...
To connect your Frontitude user account to the business hub so Cerby can
