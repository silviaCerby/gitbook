...
Autodesk. For other app-specific articles and videos, review the [Connecting
...
The drop-down list displays the teams available in your account, as shown
in**Figure 1**.  
​
...
To connect a business hub for Autodesk, you must complete the following main
...
To add a business hub and connect it to Autodesk, you must complete the
following steps:
...
**IMPORTANT:** A business hub integration is required for each Autodesk team
whose users you want to manage through Cerby.
...
To connect your Autodesk user account to the business hub so Cerby can manage
