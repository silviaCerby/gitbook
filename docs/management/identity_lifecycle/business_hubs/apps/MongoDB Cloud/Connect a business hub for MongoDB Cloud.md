...
MongoDB Cloud. For other app-specific articles and videos, review the
...
To connect a business hub for MongoDB Cloud, you must complete the following
...
To add a business hub and connect it to MongoDB Cloud, you must complete the
following steps:
...
The next step is 3\. Connect your MongoDB Cloud user account to the business
hub.

## 3\. Connect your MongoDB Cloud user account to the business hub

To connect your MongoDB Cloud user account to the business hub so Cerby can
