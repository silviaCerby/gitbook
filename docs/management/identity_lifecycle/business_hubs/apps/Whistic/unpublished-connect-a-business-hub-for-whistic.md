...
# [UNPUBLISHED] Connect a business hub for Whistic
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Whistic.
...
**NOTE:** The automated tasks to invite app members and update app members’ roles are not available for this business hub.


{% endhint %}

This article provides instructions on how to connect a business hub for Whistic. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Business ID. You can find the ID in the address bar. After logging in to Whistic, the ID is displayed in the address bar as part of the URL. For example, **`cerby`** in **`https://cerby.whistic.com/v2/console/admin-tools/user-management`**. Just copy the value and paste it when connecting the business hub.
* * *

## Connect a business hub for Whistic

To connect a business hub for Whistic, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Whistic](unpublished-connect-a-business-hub-for-whistic.md#id-1.-add-a-business-hub-and-connect-it-to-whistic)
  2. [Check for updates to import users and roles to Cerby](unpublished-connect-a-business-hub-for-whistic.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Whistic user account to the business hub](unpublished-connect-a-business-hub-for-whistic.md#id-3.-connect-your-whistic-user-account-to-the-business-hub)
  4. [Manage unmatched users](unpublished-connect-a-business-hub-for-whistic.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Whistic

To add a business hub and connect it to Whistic, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Whistic Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Whistic Hub**. For instructions on how to find it, read the [Requirements](https://docs.google.com/document/d/1Ra9GAL1XsoLZqTwpKHSRuHMmTmxrmE9qiMZTrL8BnI0/edit?tab=t.0#heading=h.wxmv4kvterhj) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Whistic accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](https://docs.google.com/document/d/1Ra9GAL1XsoLZqTwpKHSRuHMmTmxrmE9qiMZTrL8BnI0/edit?tab=t.0#heading=h.wxmv4kvterhj) section.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **Settings** (<img src="../../../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz_25.png" alt="">) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your Whistic user account to the business hub](unpublished-connect-a-business-hub-for-whistic.md#id-3.-connect-your-whistic-user-account-to-the-business-hub).

### 3\. Connect your Whistic user account to the business hub

To connect your Whistic user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Whistic Hub account card. The **Connect your Whistic Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Whistic** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](unpublished-connect-a-business-hub-for-whistic.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_512.png" alt="">) icon of the corresponding business hub card. A drop-down list is displayed.
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Whistic.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_514.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
