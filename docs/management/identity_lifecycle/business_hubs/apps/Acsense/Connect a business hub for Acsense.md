...
Acsense. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Acsense, you must complete the following main
...
To add a business hub and connect it to Acsense, you must complete the
following steps:
...
The next step is 3\. Connect your Acsense user account to the business hub.

## 3\. Connect your Acsense user account to the business hub

To connect your Acsense user account to the business hub so Cerby can manage
