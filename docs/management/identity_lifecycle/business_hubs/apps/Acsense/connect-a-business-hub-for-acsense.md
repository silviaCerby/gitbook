---
description: This article describes how to connect a business hub to centrally manage the users of Acsense from Cerby.
intercom_id: 10227057
---
...
This article provides instructions on how to connect a business hub for Acsense. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Acsense, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Acsense](connect-a-business-hub-for-acsense.md#id-1.-add-a-business-hub-and-connect-it-to-acsense)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-acsense.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Acsense user account to the business hub](connect-a-business-hub-for-acsense.md#id-3.-connect-your-acsense-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-acsense.md#id-4.-manage-unmatched-users)
...
To add a business hub and connect it to Acsense, you must complete the following steps:
  ...
  **TIP:** You can select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-acsense.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-acsense.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Acsense user account to the business hub](connect-a-business-hub-for-acsense.md#id-3.-connect-your-acsense-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-acsense.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-acsense.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-acsense.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-acsense.md#id-exempt-unmatched-users)
