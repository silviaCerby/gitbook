...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** Cross River Bank
requires the following additional fields to create user accounts: * **Phone
number** * **Country code** You must provide both values when adding users to
your external app. {% endhint %}

This article provides instructions on how to connect a business hub for Cross
River Bank. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Cross River Bank, you must complete the
...
To add a business hub and connect it to Cross River Bank, you must complete
the following steps:
...
​**IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Cross
River Bank Hub.
...
The next step is 3\. Connect your Cross River Bank user account to the
business hub.

## 3\. Connect your Cross River Bank user account to the business hub

To connect your Cross River Bank user account to the business hub so Cerby can
