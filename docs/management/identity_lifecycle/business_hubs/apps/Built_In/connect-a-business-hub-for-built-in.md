---
description: This article describes how to connect a business hub to centrally manage the users of Built In from Cerby.
intercom_id: 11199040
---
...
This article provides instructions on how to connect a business hub for Built In. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for Built In, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Built In](connect-a-business-hub-for-built-in.md#id-1.-add-a-business-hub-and-connect-it-to-built-in)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-built-in.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Built In user account to the business hub](connect-a-business-hub-for-built-in.md#id-3.-connect-your-built-in-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-built-in.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Builtin Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-built-in.md#id-requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-built-in.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-built-in.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Built In user account to the business hub](connect-a-business-hub-for-built-in.md#id-3.-connect-your-built-in-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-built-in.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-built-in.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-built-in.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-built-in.md#id-exempt-unmatched-users)
