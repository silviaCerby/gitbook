...
update user roles is not available for this business hub because Streamline
Icons does not support it. {% endhint %}

This article provides instructions on how to connect a business hub for
Streamline Icons. For other app-specific articles and videos, review the
...
To connect a business hub for Streamline Icons, you must complete the
...
To add a business hub and connect it to Streamline Icons, you must complete
the following steps:
...
The next step is 3\. Connect your Streamline Icons user account to the
business hub.

## 3\. Connect your Streamline Icons user account to the business hub

To connect your Streamline Icons user account to the business hub so Cerby can
