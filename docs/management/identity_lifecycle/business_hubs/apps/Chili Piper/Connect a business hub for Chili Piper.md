...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** Chili Piper
requires the following additional fields to create user accounts: * **Instant
Booker Product License** * **Handoff Product License** * **Concierge Product
License** You must provide these values when adding users to your external
app. {% endhint %}

This article provides instructions on how to connect a business hub for Chili
Piper. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Chili Piper, you must complete the following
...
To add a business hub and connect it to Chili Piper, you must complete the
following steps:
...
The next step is 3\. Connect your Chili Piper user account to the business
hub.

## 3\. Connect your Chili Piper user account to the business hub

To connect your Chili Piper user account to the business hub so Cerby can
