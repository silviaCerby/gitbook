...
users of Chili Piper New Dashboards.
...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** Chili Piper New
Dashboards requires the following additional fields to create user accounts: *
**ChiliCal Product License** * **Handoff Product License** * **Concierge
Product License** You must provide both values when adding users to your
external app. {% endhint %}

This article provides instructions on how to connect a business hub for Chili
Piper New Dashboards. For other app-specific articles and videos, review the
...
To connect a business hub for Chili Piper New Dashboards, you must complete
...
To add a business hub and connect it to Chili Piper New Dashboards, you must
...
The next step is [2\. Check for updates to import users and roles to
...
The next step is 3\. Connect your Chili Piper New Dashboards user account to
the business hub.

## 3\. Connect your Chili Piper New Dashboards user account to the business
hub

To connect your Chili Piper New Dashboards user account to the business hub so
...
Chili Piper New Dashboards. {% endhint %}

  1. Click the **More options** (![](images/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg)) icon of the corresponding user. A drop-down menu is displayed.
