...
​**IMPORTANT:** Currently, this business hub doesn’t support the **Username and password** option.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-watershed.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-watershed.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-watershed.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-watershed.md#exempt-unmatched-users)
