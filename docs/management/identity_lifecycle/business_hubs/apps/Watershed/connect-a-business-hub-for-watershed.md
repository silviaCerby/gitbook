---
description: This article describes how to connect a business hub to centrally manage the users of Watershed from Cerby.
intercom_id: 10338513
---

# Connect a business hub for Watershed
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Watershed.
...
**NOTE:** Watershed supports two roles, **Admin** and **Member** , and multiple permissions that can be assigned to app members. A user can have multiple roles and permissions.


{% endhint %}

This article provides instructions on how to connect a business hub for Watershed. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  **IMPORTANT:** Currently,**** this business hub only supports single sign-on (SSO) as the user management and login method.

* * *

## Connect a business hub for Watershed

To connect a business hub for Watershed, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Watershed](connect-a-business-hub-for-watershed.md#id-1.-add-a-business-hub-and-connect-it-to-watershed)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-watershed.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Watershed user account to the business hub](connect-a-business-hub-for-watershed.md#id-3.-connect-your-watershed-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-watershed.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Watershed

To add a business hub and connect it to Watershed, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Watershed Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials in Cerby:
...
​**IMPORTANT:** Currently, this business hub doesn’t support the **Username and password** option.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Watershed accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-watershed.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-watershed.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Watershed user account to the business hub](connect-a-business-hub-for-watershed.md#id-3.-connect-your-watershed-user-account-to-the-business-hub).

### 3\. Connect your Watershed user account to the business hub

To connect your Watershed user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Watershed Hub account card. The **Connect your Watershed Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Watershed user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-watershed.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-watershed.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-watershed.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-watershed.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Watershed.
