...
This article provides instructions on how to connect a business hub for Braintree. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
1. [Add a business hub and connect it to Braintree](connect-a-business-hub-for-braintree.md#id-1.-add-a-business-hub-and-connect-it-to-braintree)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-braintree.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your Braintree user account to the business hub](connect-a-business-hub-for-braintree.md#id-3.-connect-your-braintree-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-braintree.md#id-4.-manage-unmatched-users)
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-braintree.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_159.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Braintree user account to the business hub](connect-a-business-hub-for-braintree.md#id-3.-connect-your-braintree-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-braintree.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_160.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
* [Match users](connect-a-business-hub-for-braintree.md#match-users)
* [Remove unmatched users](connect-a-business-hub-for-braintree.md#remove-unmatched-users)
* [Exempt unmatched users](connect-a-business-hub-for-braintree.md#exempt-unmatched-users)
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_161.png)) icon of the corresponding user. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_162.png)) icon of the corresponding user. A drop-down menu is displayed.
