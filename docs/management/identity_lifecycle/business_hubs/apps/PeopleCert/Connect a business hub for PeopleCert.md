...
PeopleCert doesn't support roles. {% endhint %}

This article provides instructions on how to connect a business hub for
PeopleCert. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for PeopleCert, you must complete the following main
...
To add a business hub and connect it to PeopleCert, you must complete the
following steps:
...
To connect your PeopleCert user account to the business hub so Cerby can
