...
This article provides instructions on how to connect a business hub for BuildBuddy. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
1. [Add a business hub and connect it to BuildBuddy](connect-a-business-hub-for-buildbuddy.md#id-1.-add-a-business-hub-and-connect-it-to-buildbuddy)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-buildbuddy.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your BuildBuddy user account to the business hub](connect-a-business-hub-for-buildbuddy.md#id-3.-connect-your-buildbuddy-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-buildbuddy.md#id-4.-manage-unmatched-users)
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **BuildBuddy Team Name:** It is the unique identifier of your business or organization in **BuildBuddy Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-buildbuddy.md#requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-buildbuddy.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **Settings** (![](../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz.png)) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your BuildBuddy user account to the business hub](connect-a-business-hub-for-buildbuddy.md#id-3.-connect-your-buildbuddy-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-buildbuddy.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_406.png)) icon of the corresponding business hub card. A drop-down list is displayed.
...
* [Match users](connect-a-business-hub-for-buildbuddy.md#match-users)
* [Remove unmatched users](connect-a-business-hub-for-buildbuddy.md#remove-unmatched-users)
* [Exempt unmatched users](connect-a-business-hub-for-buildbuddy.md#exempt-unmatched-users)
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_407.png)) icon of the corresponding user. A drop-down list is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_408.png)) icon of the corresponding user. A drop-down list is displayed.
