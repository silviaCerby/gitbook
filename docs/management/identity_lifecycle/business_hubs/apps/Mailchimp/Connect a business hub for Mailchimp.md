...
Mailchimp. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Mailchimp, you must complete the following main
...
To add a business hub and connect it to Mailchimp, you must complete the
following steps:
...
To connect your Mailchimp user account to the business hub so Cerby can manage
