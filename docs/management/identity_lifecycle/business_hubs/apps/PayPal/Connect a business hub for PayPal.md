...
apps). {% endhint %}{% hint style="danger" %} **IMPORTANT:** PayPal requires
an additional field to specify the **accounts** users should have access to
when creating accounts. You must provide this information when adding users to
your external app. {% endhint %}

This article provides instructions on how to connect a business hub for
PayPal. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for PayPal, you must complete the following main
...
To add a business hub and connect it to PayPal, you must complete the
following steps:
...
To connect your PayPal user account to the business hub so Cerby can manage
