---
description: This article describes how to connect a business hub to centrally manage the users of GoCardless from Cerby.
intercom_id: 12815141
---

# Connect a business hub for GoCardless
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of GoCardless.
...
This article provides instructions on how to connect a business hub for GoCardless. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **Administrator** role in GoCardless to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
* * *

## Connect a business hub for GoCardless

To connect a business hub for GoCardless, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to GoCardless](connect-a-business-hub-for-gocardless.md#id-1.-add-a-business-hub-and-connect-it-to-gocardless)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-gocardless.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your GoCardless user account to the business hub](connect-a-business-hub-for-gocardless.md#id-3.-connect-your-gocardless-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-gocardless.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to GoCardless

To add a business hub and connect it to GoCardless, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **GoCardless Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported for GoCardless.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing GoCardless accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-gocardless.md#id-requirements) section.
...
The next step is [3. Connect your GoCardless user account to the business hub](connect-a-business-hub-for-gocardless.md#id-3.-connect-your-gocardless-user-account-to-the-business-hub).

### 3\. Connect your GoCardless user account to the business hub

To connect your GoCardless user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding GoCardless Hub account card. The **Connect your GoCardless Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **GoCardless** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-gocardless.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1825724102/c2a48d70cebfce06a90ea0bd68f4/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1762909350&signature=8e35f5dd8421ef448ecf7fe63ce864909c181551ea5ddd56c35fa8ffe65fa753&req=dSglE858mYBfW%2FMU3HP0gERy3R4EoCc77oe7EKyROJdp2jdX10M%3D%0A" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-gocardless.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-gocardless.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-gocardless.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in GoCardless.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_52.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_53.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
