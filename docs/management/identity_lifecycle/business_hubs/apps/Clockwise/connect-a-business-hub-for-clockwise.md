---
description: This article describes how to connect a business hub to centrally manage the users of Clockwise from Cerby.
intercom_id: 11324229
---

# Connect a business hub for Clockwise
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Clockwise.
...
**NOTE:** The automated task to update user roles is not available for this business hub because Clockwise doesn’t support roles.


{% endhint %}

This article provides instructions on how to connect a business hub for Clockwise. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Team ID. You can find the ID in the address bar by completing the following steps after logging in to Clockwise;

    1. Hover the mouse over the **More** option on the left menu. A menu is displayed.
    2. Click your team’s name in the **Teams** section of the menu. The team management page is displayed.
    3. Copy the ID from the address bar. The ID is displayed in the address bar as part of the URL, after the **team** subdirectory. For example, **`123abc45d67e890123f45g678hi90123`** in **`https://www.getclockwise.com/app/team/123abc45d67e890123f45g678hi90123`.**

* * *

## Connect a business hub for Clockwise

To connect a business hub for Clockwise, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Clockwise](connect-a-business-hub-for-clockwise.md#id-1.-add-a-business-hub-and-connect-it-to-clockwise)
  2. [Check for updates to import users to Cerby](connect-a-business-hub-for-clockwise.md#id-2.-check-for-updates-to-import-users-to-cerby)
  3. [Connect your Clockwise user account to the business hub](connect-a-business-hub-for-clockwise.md#id-3.-connect-your-clockwise-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-clockwise.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Clockwise

To add a business hub and connect it to Clockwise, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Clockwise Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Team ID:** It is the unique identifier of your business or organization in **Clockwise Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-clockwise.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The Username and password option is not supported by Clockwise.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Clockwise accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-clockwise.md#id-requirements) section.
...
The next step is [2. Check for updates to import users to Cerby](connect-a-business-hub-for-clockwise.md#id-2.-check-for-updates-to-import-users-to-cerby).
...
To check for updates in your app to identify and import users to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_292.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Clockwise user account to the business hub](connect-a-business-hub-for-clockwise.md#id-3.-connect-your-clockwise-user-account-to-the-business-hub).

### 3\. Connect your Clockwise user account to the business hub

To connect your Clockwise user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Clockwise Hub account card. The **Connect your Clockwise Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Clockwise** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-clockwise.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_293.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-clockwise.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-clockwise.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-clockwise.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Clockwise.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_294.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_295.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
