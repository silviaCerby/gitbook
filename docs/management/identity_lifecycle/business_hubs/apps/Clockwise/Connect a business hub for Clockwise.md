...
update user roles is not available for this business hub because Clockwise
doesn’t support roles. {% endhint %}

This article provides instructions on how to connect a business hub for
Clockwise. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Clockwise, you must complete the following main
...
To add a business hub and connect it to Clockwise, you must complete the
following steps:
...
To connect your Clockwise user account to the business hub so Cerby can manage
