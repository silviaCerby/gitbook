---
description: This article describes how to connect a business hub to centrally manage the users of Cronitor from Cerby.
intercom_id: 10396966
---

# Connect a business hub for Cronitor
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Cronitor.
...
**IMPORTANT:** Cronitor only supports one **Team Manager** per account. This role has the following restrictions:

* The role is only updatable within the application by the current **Team Manager** or an **Administrator**.
* Assigning the role to another user automatically changes the current **Team Manager** to an **Administrator**.
* Users cannot get the role by invitation.

Therefore, the **Team Manager** role is not currently editable nor assignable in Cerby.


{% endhint %}

This article provides instructions on how to connect a business hub for Cronitor. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Cronitor, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Cronitor](connect-a-business-hub-for-cronitor.md#id-1.-add-a-business-hub-and-connect-it-to-cronitor)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-cronitor.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Cronitor user account to the business hub](connect-a-business-hub-for-cronitor.md#id-3.-connect-your-cronitor-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-cronitor.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Cronitor

To add a business hub and connect it to Cronitor, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Cronitor Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Cronitor accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-cronitor.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-cronitor.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **Settings** (<img src="../../../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz_29.png" alt="">) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your Cronitor user account to the business hub](connect-a-business-hub-for-cronitor.md#id-3.-connect-your-cronitor-user-account-to-the-business-hub).

### 3\. Connect your Cronitor user account to the business hub

To connect your Cronitor user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Cronitor Hub account card. The **Connect your Cronitor Hub Account** dialog box is displayed.
  3. Enter the login credentials of your Cronitor user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-cronitor.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-cronitor.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-cronitor.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-cronitor.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Cronitor.


{% endhint %}

  1. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1333464811/b0b24f24bef8a26382331b4fc0d2/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1739340000&signature=106e9b0ef1a2f3424962f0bef798cd8b0f9edf7c60cc27d19e100b24509f218d&req=dSMkFc14mYleWPMW3Hu4gSDo0O4ELeSSjTTeW5y7xHagqoULgsJ7no8GNXWI%0Ahg%3D%3D%0A" alt="">) icon of the corresponding user. A drop-down list is displayed.
