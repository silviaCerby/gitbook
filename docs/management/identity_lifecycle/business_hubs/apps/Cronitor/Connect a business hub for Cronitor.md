...
endhint %}{% hint style="danger" %} **IMPORTANT:** Cronitor only supports one
**Team Manager** per account. This role has the following restrictions: * The
role is only updatable within the application by the current **Team Manager**
or an **Administrator**. * Assigning the role to another user automatically
changes the current **Team Manager** to an **Administrator**. * Users cannot
get the role by invitation. Therefore, the **Team Manager** role is not
currently editable nor assignable in Cerby. {% endhint %}

This article provides instructions on how to connect a business hub for
Cronitor. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Cronitor, you must complete the following main
...
To add a business hub and connect it to Cronitor, you must complete the
following steps:
...
To connect your Cronitor user account to the business hub so Cerby can manage
