---
description: This article describes how to connect a business hub to centrally manage the users of Eight from Cerby.
intercom_id: 11011432
---

# Connect a business hub for Eight
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Eight.
...
This article provides instructions on how to connect a business hub for Eight. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Business unique identifier. You can find the ID in the address bar by completing the following steps after logging in to Eigth:

    1. Click the **Settings** icon at the top right of the page.
    2. Select the **Eight Team** option from the drop-down menu. The **Members list** page is displayed.
    3. Copy the ID from the address bar. The ID is displayed in the address bar as part of the URL, between the **`team` **and **`members`** subdirectory. For example, **`1234`** in **`https://8card.net/team/1234/members/list`**.
​
...
To connect a business hub for Eight, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Eight](connect-a-business-hub-for-eight.md#id-1.-add-a-business-hub-and-connect-it-to-eight)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-eight.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Eight user account to the business hub](connect-a-business-hub-for-eight.md#id-3.-connect-your-eight-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-eight.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Eight

To add a business hub and connect it to Eight, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Eight Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business unique identifier:** It is the unique identifier of your business or organization in **Eight Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-eight.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Eight accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-eight.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-eight.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Eight user account to the business hub](connect-a-business-hub-for-eight.md#id-3.-connect-your-eight-user-account-to-the-business-hub).

### 3\. Connect your Eight user account to the business hub

To connect your Eight user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Eight Hub account card. The **Connect your Eight Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Eight** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-eight.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-eight.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-eight.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-eight.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Eight.
