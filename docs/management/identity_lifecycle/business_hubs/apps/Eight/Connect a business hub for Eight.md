...
This article provides instructions on how to connect a business hub for Eight.
...
To connect a business hub for Eight, you must complete the following main
...
To add a business hub and connect it to Eight, you must complete the following
steps:
...
To connect your Eight user account to the business hub so Cerby can manage and
