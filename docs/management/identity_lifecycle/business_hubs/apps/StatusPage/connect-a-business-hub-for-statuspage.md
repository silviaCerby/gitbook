...
6. Enter and select your app information in the corresponding fields:
   ...
   * **Organization ID:** It is the unique identifier of your business or organization in **StatusPage Hub**. For instructions on how to find it, read the Requirements section.
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Single sign-on (SSO)** option because access must be managed by your IdP, and users log in with SSO authentication. They are not asked to save their credentials in Cerby. **IMPORTANT** : The **Username and password** option is not supported for StatusPage.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_188.png" alt=""><figcaption></figcaption></figure>
...
The next step is 3. Connect your StatusPage user account to the business hub.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_189.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_190.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_191.png" alt=""><figcaption></figcaption></figure>
