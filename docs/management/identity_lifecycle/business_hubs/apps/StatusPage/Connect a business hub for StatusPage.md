...
StatusPage. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for StatusPage, you must complete the following main
...
To add a business hub and connect it to StatusPage, you must complete the
following steps:
...
**IMPORTANT** : The **Username and password** option is not supported for
StatusPage.
...
To connect your StatusPage user account to the business hub so Cerby can
