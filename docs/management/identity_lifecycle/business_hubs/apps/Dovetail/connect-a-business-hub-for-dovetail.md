---
description: This article describes how to connect a business hub to centrally manage the users of Dovetail from Cerby.
intercom_id: 10472040
---

# Connect a business hub for Dovetail
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Dovetail.
...
This article provides instructions on how to connect a business hub for Dovetail. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Business ID. You can find the ID in the following ways:
    * **In the address bar:** When you are logged in to Dovetail, the ID is displayed in the address bar as part of the URL. For example, **`team-workspace-123`** in **`https://team-workspace-123.dovetail.com/settings/workspace`**. Just copy the value and paste it when connecting the business hub.
    * **In the business information or settings:** When you are logged in to Dovetail, navigate to **Settings** , then select **Workspace settings**. The ID is displayed in the **Subdomain** field for you to copy.
* * *

## Connect a business hub for Dovetail

To connect a business hub for Dovetail, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Dovetail](connect-a-business-hub-for-dovetail.md#id-1.-add-a-business-hub-and-connect-it-to-dovetail)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-dovetail.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Dovetail user account to the business hub](connect-a-business-hub-for-dovetail.md#id-3.-connect-your-dovetail-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-dovetail.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Dovetail

To add a business hub and connect it to Dovetail, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Dovetail Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Dovetail Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-dovetail.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Dovetail accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-dovetail.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-dovetail.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **Settings** (<img src="../../../../../../.gitbook/assets/AD_4nXeByVHBSTSp-KuNiohUPzRJ81cmUV-g-W-qM7ABEk0mzfVRcsTnC9XD_6mAQBQObGIKbGJWpnxScMGm_cT3R4uzEzVW0ZAsqkGoo-cmatfJC_I2vgLsWIrLnwQAUqoT_5Llg9mz_20.png" alt="">) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your Dovetail user account to the business hub](connect-a-business-hub-for-dovetail.md#id-3.-connect-your-dovetail-user-account-to-the-business-hub).

### 3\. Connect your Dovetail user account to the business hub

To connect your Dovetail user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Dovetail Hub account card. The **Connect your Dovetail Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Dovetail** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-dovetail.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_478.png" alt="">) icon of the corresponding business hub card. A drop-down list is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-dovetail.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-dovetail.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-dovetail.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Dovetail.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_479.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_480.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
