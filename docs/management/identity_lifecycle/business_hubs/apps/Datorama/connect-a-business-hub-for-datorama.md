---
description: This article describes how to connect a business hub to centrally manage the users of Datorama from Cerby.
intercom_id: 13162134
---

# Connect a business hub for Datorama
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Datorama.
...
The following are the requirements to connect a business hub:
  ...
  * A business unique identifier. You can find the ID in the address bar when you are logged in to Datorama. The ID is displayed in the address bar as part of the URL. For example, **`123456`** in **`https://platform.datorama.com/123456/settings/account/users/v2`**. Just copy the value and paste it when connecting the business hub.
* * *

## Connect a business hub for Datorama

To connect a business hub for Datorama, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Datorama](connect-a-business-hub-for-datorama.md#id-1.-add-a-business-hub-and-connect-it-to-datorama)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-datorama.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Datorama user account to the business hub](connect-a-business-hub-for-datorama.md#id-3.-connect-your-datorama-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-datorama.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Datorama

To add a business hub and connect it to Datorama, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Datorama Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business unique identifier:** It is the unique identifier of your business or organization in **Datorama Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-datorama.md#id-requirements) section.
...
You must select one of the following methods:
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Datorama accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-datorama.md#id-requirements) section.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_8.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Datorama user account to the business hub](connect-a-business-hub-for-datorama.md#id-3.-connect-your-datorama-user-account-to-the-business-hub).

### 3\. Connect your Datorama user account to the business hub

To connect your Datorama user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Datorama Hub account card. The **Connect your Datorama Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Datorama** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-datorama.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-datorama.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-datorama.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-datorama.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Datorama.
