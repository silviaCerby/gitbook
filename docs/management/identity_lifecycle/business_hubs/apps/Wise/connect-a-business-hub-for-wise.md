...
6. Enter and select your app information in the corresponding fields:
   ...
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Username and password** option because account security and access are managed by Cerby, and users log in with their credentials after saving them in Cerby **IMPORTANT:** The **Single sign-on (SSO)** option is not currently supported for Wise.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_40.png" alt=""><figcaption></figcaption></figure>
...
The next step is 3. Connect your Wise user account to the business hub.
...
2.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_41.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_42.png" alt=""><figcaption></figcaption></figure>
...
1.  Click the **More options** (
    ...
    <figure><img src="../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_43.png" alt=""><figcaption></figcaption></figure>
