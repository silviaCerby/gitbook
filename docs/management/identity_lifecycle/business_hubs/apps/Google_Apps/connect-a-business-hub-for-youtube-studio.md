...
intercom_id: 9141289
description: >-
  This article describes how to add your business hub for YouTube Studio to
  centrally manage access to it and its assets from Cerby.
---
...
1. [Prepare for the member migration to YouTube Studio](connect-a-business-hub-for-youtube-studio.md#id-1.-prepare-for-the-member-migration-to-youtube-studio)
2. [Migrate from YouTube Brand account to YouTube Studio](connect-a-business-hub-for-youtube-studio.md#id-2.-migrate-from-youtube-brand-account-to-youtube-studio)
...
* [Members must create a YouTube personal channel](connect-a-business-hub-for-youtube-studio.md#h_24aa58786a)
* [Each channel must have a permanent owner](connect-a-business-hub-for-youtube-studio.md#h_3adafc4ce0)
* [Your content might be temporarily unavailable](connect-a-business-hub-for-youtube-studio.md#h_16a4352a5d)
...
1. Open [YouTube Studio](https://studio.youtube.com/). ​**IMPORTANT:** You must sign in as the **Primary Owner** of the Brand account to have the option to opt into permissions.
...
1. [Add a business hub and connect it to your YouTube Studio](connect-a-business-hub-for-youtube-studio.md#id-1.-add-a-business-hub-and-connect-it-to-your-youtube-studio)
2. [Check for updates and import users and roles to Cerby](connect-a-business-hub-for-youtube-studio.md#id-2.-check-for-updates-and-import-users-and-roles-to-cerby)
3. [Manage unmatched users](connect-a-business-hub-for-youtube-studio.md#id-3.-manage-unmatched-users)
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **Channel name:** It is the YouTube channel, which you are adding the business hub in Cerby. ​**IMPORTANT:** This field is case sensitive, which means that you must provide the name of the YouTube channel exactly as it is, including any uppercase and lowercase letters. For example, if the channel name is "TechTutorials," it must be entered as "TechTutorials," not "techtutorials" or "TECHTUTORIALS".
...
![](../../../../.gitbook/assets/qudaeJJ6hCet5Du5--f-jqbvvLWNzNhizAvulKePYKKgNBW75acgeWGV7L5QdqzmsItU-hp3M0Id7cWgmAwZIEJB3sDLMPpsV8IUxo6yiCUzs7MIRyv1TqogPV7CiBAAvYB8GU0DVpjLfDumSmErj7E.png)
...
![](../../../../.gitbook/assets/lj5D8SIIGSh28fk1SUMlGeEtsb9eFAdHXld1RSSQb1DkbGIRdUSqJbA8ePi33lFcfkdrZPQyIl-7U29IBZV6roFX6zBmoOZ7At7_j5JxHmCUNdQMMO3O5EvYyw5ftvQ9AoWqOpq222s6Kej5iTjTVmg.png)
...
The next step is [2. Check for updates and import users and roles to Cerby](connect-a-business-hub-for-youtube-studio.md#id-2.-check-for-updates-and-import-users-and-roles-to-cerby).
...
3. Click the **Check for updates** button located at the top-right section of the page. A message box is displayed with information about the process. ​**NOTE** : The check and import process may take a few minutes depending on the number of users and because Cerby automatically matches users to their corresponding Cerby accounts. When the process is complete, a success message box is displayed.
...
The next step is [3. Manage unmatched users](connect-a-business-hub-for-youtube-studio.md#id-3.-manage-unmatched-users), which you must complete from the Cerby dashboard.
...
10. Click the **Match user** button. The dialog box closes, a success message box is displayed, and the user is moved to the **Onboarded users** tab. The YouTube account and app cards are displayed in the **All accounts** and **Apps** views, respectively, of each matched user.
...
![](../../../../.gitbook/assets/AD_4nXcv5yMMc2iZThDArIF3oJDogEtiPrAhQLdJW_WV-iwZIzU-3KqLDYZJRaUGsxow2uQMCw6kbnTaUYvbgXTkHpxWySA1ger-RfuHB2EeBkLzyzqMhDIyGLLvCHgoIQxbYgyzRLcj.png)
