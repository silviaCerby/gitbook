---
description: This article describes how to connect a business hub to centrally manage the users and assets of Google Play from Cerby.
intercom_id: 11084661
---

# Connect a business hub for Google Play
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users and assets of Google Play.
...
The following are the requirements to connect a business hub:
  ...
  * A development account in Google Play
  ...
  * A Team ID. You can find the ID in**** the address bar after logging in to Google Play and navigating to the **Users and permissions** page, the ID is displayed in the address bar as part of the URL. It’s the subdirectory between the **developers** and the **users-and-permissions** subdirectories of the UR For example, **`1234567890123456789`** in **`https://play.google.com/console/developers/1234567890123456789/users-and-permissions.`** Just copy the value and paste it when connecting the business hub.
* * *

## Connect a business hub for Google Play

To connect a business hub for Google Play, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Google Play](connect-a-business-hub-for-google-play.md#id-1.-add-a-business-hub-and-connect-it-to-google-play)
  2. [Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-google-play.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby)
  3. [Connect your Google Play user account to the business hub](connect-a-business-hub-for-google-play.md#id-3.-connect-your-google-play-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-google-play.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Google Play

To add a business hub and connect it to Google Play, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Google Play Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Team ID:** It is the unique identifier of your business or organization in **Google Play Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-google-play.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The**Username and password** option**** is not currently available for Google Play.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Google Play accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-google-play.md#id-requirements) section.
...
The next step is [2. Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-google-play.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby).
...
To check for updates in your app to identify and import users, roles, and assets to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_348.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Google Play user account to the business hub](connect-a-business-hub-for-google-play.md#id-3.-connect-your-google-play-user-account-to-the-business-hub).

### 3\. Connect your Google Play user account to the business hub

To connect your Google Play user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Google Play Hub account card. The **Connect your Google Play Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Google Play** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-google-play.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_349.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-google-play.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-google-play.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-google-play.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Google Play.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_350.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_351.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
