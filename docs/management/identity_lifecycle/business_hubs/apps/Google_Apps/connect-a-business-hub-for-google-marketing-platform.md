...
description: >-
  ...
  users of Google Marketing Platform from Cerby.
---
...
* An Organization ID. You can find the ID in the business settings by completing the following steps after logging in to the Google Marketing Platform home:
  ...
  3. Select the card that corresponds to your organization. The **Organization details** page is displayed. The ID is displayed below the **Organization ID** label, as shown in **Figure 1**. ​

![](../../../../.gitbook/assets/google_marketing_org_id.png)
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Single sign-on (SSO)** option because access must be managed by your IdP, and users log in with SSO authentication. They are not asked to save their credentials in Cerby. **IMPORTANT:** The**Username and password** option\*\*\*\* is not currently available for Google Marketing Platform.
...
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_343.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_344.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_345.png)) icon of the corresponding user. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_346.png)) icon of the corresponding user. A drop-down menu is displayed.
