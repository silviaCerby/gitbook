...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Google ADH.
...
This article provides instructions on how to connect a business hub for Google ADH. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Google ADH, you must complete the following main steps from the Cerby web app dashboard:

1. [Add a business hub and connect it to Google ADH](connect-a-business-hub-for-google-adh.md#id-1.-add-a-business-hub-and-connect-it-to-google-adh)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-google-adh.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your Google ADH user account to the business hub](connect-a-business-hub-for-google-adh.md#id-3.-connect-your-google-adh-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-google-adh.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1. Add a business hub and connect it to Google ADH

To add a business hub and connect it to Google ADH, you must complete the following steps:
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-google-adh.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_351.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Google ADH user account to the business hub](connect-a-business-hub-for-google-adh.md#id-3.-connect-your-google-adh-user-account-to-the-business-hub).

### 3. Connect your Google ADH user account to the business hub

To connect your Google ADH user account to the business hub so Cerby can manage and protect it, you must complete the following steps:
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-google-adh.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_352.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
* [Match users](connect-a-business-hub-for-google-adh.md#match-users)
* [Remove unmatched users](connect-a-business-hub-for-google-adh.md#remove-unmatched-users)
* [Exempt unmatched users](connect-a-business-hub-for-google-adh.md#exempt-unmatched-users)
...
{% hint style="danger" %}
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Google ADH.
{% endhint %}

1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_353.png)) icon of the corresponding user. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_354.png)) icon of the corresponding user. A drop-down menu is displayed.
