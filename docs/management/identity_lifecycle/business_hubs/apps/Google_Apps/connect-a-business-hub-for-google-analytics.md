---
description: This article describes how to connect a business hub to centrally manage the users and assets of Google Analytics from Cerby.
intercom_id: 12385744
---

# Connect a business hub for Google Analytics
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users and assets of Google Analytics.
...
This article provides instructions on how to connect a business hub for Google Analytics. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * A Business ID. You can find the ID in the following ways:
    * **In the address bar:** When you are logged in to Google Analytics and open the **Admin** section, the ID is displayed in the address bar. It's the value between the **`#/` and `/admin` **subfolders, without the starting **`a`** and ending **`p0`**. For example, **`162430495`** in **`https://analytics.google.com/analytics/web/#/a162430495p0/admin`**. Just copy the value and paste it when connecting the business hub.
    * **In the business information or settings:** When you are logged in to Google Analytics, go to the **Account** section in the left menu, and select the **Account details** option. The ID is displayed below the **Account Id** label, as shown in **Figure 1**.
​

<img src="../../../../../../.gitbook/assets/image_5.png" alt="">

**Figure 1. Account Id** in the **Account details** page

* * *

## Connect a business hub for Google Analytics

To connect a business hub for Google Analytics, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Google Analytics](connect-a-business-hub-for-google-analytics.md#id-1.-add-a-business-hub-and-connect-it-to-google-analytics)
  2. [Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-google-analytics.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby)
  3. [Connect your Google Analytics user account to the business hub](connect-a-business-hub-for-google-analytics.md#id-3.-connect-your-google-analytics-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-google-analytics.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Google Analytics

To add a business hub and connect it to Google Analytics, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Google Analytics Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Google Analytics Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-google-analytics.md#id-requirements) section.
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Google Analytics accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-google-analytics.md#id-requirements) section.
...
The next step is [2. Check for updates to import users, roles, and assets to Cerby](connect-a-business-hub-for-google-analytics.md#id-2.-check-for-updates-to-import-users-roles-and-assets-to-cerby).
...
To check for updates in your app to identify and import users, roles, and assets to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_156.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Google Analytics user account to the business hub](connect-a-business-hub-for-google-analytics.md#id-3.-connect-your-google-analytics-user-account-to-the-business-hub).

### 3\. Connect your Google Analytics user account to the business hub

To connect your Google Analytics user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Google Analytics Hub account card. The **Connect your Google Analytics Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Google Analytics** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-google-analytics.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_157.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-google-analytics.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-google-analytics.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-google-analytics.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Google Analytics.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_158.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_159.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
