...
* A Project ID. You can find the ID in the following ways: **Figure 1.** **Project ID** in the Firebase console
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Single sign-on (SSO)** option because access must be managed by your IdP, and users log in with SSO authentication. They are not asked to save their credentials in Cerby. **NOTE:** Cerby supports single sign-on (SSO) with Okta, Google, and Google via Okta.
...
2.  Click the **More options** (
    ...
    <figure><img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1741079357/9b4e342a547ae4832d5fa02b0c58/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1759968000&#x26;signature=9887c6fa434a8f7e735d6eb4f09c1ddd3f4ea08b99fd5402dd3ca573d815ffb1&#x26;req=dScjF8l5lIJaXvMW3Hu4geW1HZGxgz78O3AXs1Hjejl7Wygmt0CtUFvjzZyq%0ACA%3D%3D%0A" alt=""><figcaption></figcaption></figure>
