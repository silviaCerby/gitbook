---
description: This article describes how to connect a business hub to centrally manage the users of Firebase from Cerby.
intercom_id: 10518290
---

# Connect a business hub for Firebase
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Firebase.
...
**TIP:** **TIP:** For more details about the automated tasks of a business hub, how it works, and the supported apps, read the article [Explore Business Hubs](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-business-hubs).


{% endhint %}

This article provides instructions on how to connect a business hub for Firebase. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active Google user account**** to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create an automation or service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub)
  * A Project ID. You can find the ID in the following ways:
    * **In the address bar:** When you are logged into your project in Firebase, the ID is displayed in the address bar as part of the URL, after the **`project`** subdirectory. For example, **`test-app-4cf35`** in **`https://console.firebase.google.com/project/test-app-4cf35`**. Just copy the value and paste it when connecting the business hub.
    * **In the business information or settings:** When you are logged in to the [Firebase console](https://console.firebase.google.com/), the ID is displayed under the project name, as shown in **Figure 1.**

<img src="../../../../../../.gitbook/assets/image_26.png" alt="">

**Figure 1.** **Project ID** in the Firebase console

* * *

## Connect a business hub for Firebase

To connect a business hub for Firebase, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Firebase](connect-a-business-hub-for-firebase.md#id-1.-add-a-business-hub-and-connect-it-to-firebase)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-firebase.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Firebase user account to the business hub](connect-a-business-hub-for-firebase.md#id-3.-connect-your-firebase-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-firebase.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Firebase

To add a business hub and connect it to Firebase, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Firebase Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Project ID:** It is the unique identifier of your business or organization in **Firebase Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-firebase.md#id-requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **NOTE:** Cerby supports single sign-on (SSO) with Okta, Google, and Google via Okta.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Firebase accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-firebase.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-firebase.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1741079357/9b4e342a547ae4832d5fa02b0c58/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1759968000&signature=9887c6fa434a8f7e735d6eb4f09c1ddd3f4ea08b99fd5402dd3ca573d815ffb1&req=dScjF8l5lIJaXvMW3Hu4geW1HZGxgz78O3AXs1Hjejl7Wygmt0CtUFvjzZyq%0ACA%3D%3D%0A" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
  3. elect the **Settings** option from the menu. The business hub details page is displayed with the **Settings** tab activated.
...
The next step is [3. Connect your Firebase user account to the business hub](connect-a-business-hub-for-firebase.md#id-3.-connect-your-firebase-user-account-to-the-business-hub).

### 3\. Connect your Firebase user account to the business hub

To connect your Firebase user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Firebase Hub account card. The **Connect your Firebase Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Firebase** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-firebase.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_456.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-firebase.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-firebase.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-firebase.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Firebase.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_457.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_458.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
