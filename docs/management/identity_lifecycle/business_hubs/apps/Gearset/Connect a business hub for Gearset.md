...
apps). {% endhint %}{% hint style="info" %} **NOTE:** When adding a user, they
are assigned the **Member** role by default. You can only update the role of
existing app members.**** {% endhint %}

This article provides instructions on how to connect a business hub for
Gearset. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Gearset, you must complete the following main
...
To add a business hub and connect it to Gearset, you must complete the
following steps:
...
**IMPORTANT:** The **Username and password** option is not supported by
Gearset.
...
To connect your Gearset user account to the business hub so Cerby can manage
