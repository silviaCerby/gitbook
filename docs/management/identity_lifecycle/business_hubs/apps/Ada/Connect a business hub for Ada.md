...
This article provides instructions on how to connect a business hub for Ada.
...
To connect a business hub for Ada, you must complete the following main steps
...
To add a business hub and connect it to Ada, you must complete the following
steps:
...
To connect your Ada user account to the business hub so Cerby can manage and
