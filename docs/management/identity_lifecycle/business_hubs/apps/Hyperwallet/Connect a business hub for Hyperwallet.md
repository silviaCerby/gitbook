...
Hyperwallet. For other app-specific articles and videos, review the
...
To connect a business hub for Hyperwallet, you must complete the following
...
To add a business hub and connect it to Hyperwallet, you must complete the
following steps:
...
The next step is 3\. Connect your Hyperwallet user account to the business
hub.

## 3\. Connect your Hyperwallet user account to the business hub

To connect your Hyperwallet user account to the business hub so Cerby can
