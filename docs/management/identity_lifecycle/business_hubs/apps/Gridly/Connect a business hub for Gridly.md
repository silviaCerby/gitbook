...
%}{% hint style="danger" %} **IMPORTANT:** Gridly requires the following
additional fields to create user accounts: * **User groups** * **Project
role** You must provide both values when adding users to your external app. {%
endhint %}

This article provides instructions on how to connect a business hub for
Gridly. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Gridly, you must complete the following main
...
To add a business hub and connect it to Gridly, you must complete the
following steps:
...
To connect your Gridly user account to the business hub so Cerby can manage
