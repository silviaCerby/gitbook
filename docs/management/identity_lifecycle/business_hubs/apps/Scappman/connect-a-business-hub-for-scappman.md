---
description: This article describes how to connect a business hub to centrally manage the users of Scappman from Cerby.
intercom_id: 10620271
---

# Connect a business hub for Scappman
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Scappman.
...
This article provides instructions on how to connect a business hub for Scappman. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Scappman, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Scappman](connect-a-business-hub-for-scappman.md#id-1.-add-a-business-hub-and-connect-it-to-scappman)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-scappman.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Scappman user account to the business hub](connect-a-business-hub-for-scappman.md#id-3.-connect-your-scappman-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-scappman.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Scappman

To add a business hub and connect it to Scappman, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Scappman Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub. You must select one of the following methods:
       ...
       **IMPORTANT:** Cerby supports SSO only through Microsoft 365 Enterprise for Scappman.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Scappman accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-scappman.md#id-requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-scappman.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1423535055/13c6d8500aaaddd1856f4165a17e/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1741996950&signature=2d1d13b2c74674d9e0992c499742d7b23cee0f4a5a497fe5887fab2058f8e09d&req=dSQlFcx9mIFaXPMU3HP0gNSxNm1jj3tiTZoQ9OV218QJyx6Fv98%3D%0A" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
**NOTE:** Cerby automatically performs daily checks for updates for all business hubs, but you can trigger them manually, as described in this section. For more instructions, read the article [Check for updates in your app and apply report](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-users/sync-your-business-hub-with-your-external-app).


{% endhint %}

The next step is [3. Connect your Scappman user account to the business hub](connect-a-business-hub-for-scappman.md#id-3.-connect-your-scappman-user-account-to-the-business-hub).

### 3\. Connect your Scappman user account to the business hub

To connect your Scappman user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **Accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Scappman Hub account card. The **Connect your Scappman Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Scappman** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-scappman.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-scappman.md#id-match-users)
  * [Remove unmatched users](connect-a-business-hub-for-scappman.md#id-remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-scappman.md#id-exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Scappman.


{% endhint %}

  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_405.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
The following are the supported features of business hubs you can use:
  ...
  * [Remove ](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-users/remove-users-from-your-app-via-a-business-hub)[users from your app via a business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-users/add-users-and-teams-to-your-apps-via-a-business-hub)
