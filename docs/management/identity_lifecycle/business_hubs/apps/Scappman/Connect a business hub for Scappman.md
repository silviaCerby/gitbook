...
Scappman. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Scappman, you must complete the following main
...
To add a business hub and connect it to Scappman, you must complete the
following steps:
...
described in this section. For more instructions, read the article [Check for
updates in your app and apply
...
To connect your Scappman user account to the business hub so Cerby can manage
