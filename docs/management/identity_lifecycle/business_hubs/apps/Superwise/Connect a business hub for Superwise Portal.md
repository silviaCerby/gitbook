...
Superwise Portal. For other app-specific articles and videos, review the
...
To connect a business hub for Superwise Portal, you must complete the
...
To add a business hub and connect it to Superwise Portal, you must complete
the following steps:
...
The next step is 3\. Connect your Superwise Portal user account to the
business hub.

## 3\. Connect your Superwise Portal user account to the business hub

To connect your Superwise Portal user account to the business hub so Cerby can
