...
This article provides instructions on how to connect a business hub for Braze.
...
To connect a business hub for FullStory, you must complete the following main
...
To add a business hub and connect it to FullStory, you must complete the
following steps:
...
To connect your FullStory user account to the business hub so Cerby can manage
