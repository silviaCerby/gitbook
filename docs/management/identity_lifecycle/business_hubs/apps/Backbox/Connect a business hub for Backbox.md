...
apps). {% endhint %}{% hint style="info" %} **NOTE:** The **Notification**
role may appear in the **Users** table if detected during sync. However, Cerby
does not support assigning this role when adding users to Rackbox. {% endhint
%}

This article provides instructions on how to connect a business hub for
Backbox. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Backbox, you must complete the following main
...
To add a business hub and connect it to Backbox, you must complete the
following steps:
...
**IMPORTANT:** The **Username and password** option is not currently available
for Backbox.
...
To connect your Backbox user account to the business hub so Cerby can manage
