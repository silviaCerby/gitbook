...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of RiskLedger.
...
This article provides instructions on how to connect a business hub for RiskLedger. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for RiskLedger, you must complete the following main steps from the Cerby web app dashboard:

1. [Add a business hub and connect it to RiskLedger](connect-a-business-hub-for-riskledger.md#id-1.-add-a-business-hub-and-connect-it-to-riskledger)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-riskledger.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Connect your RiskLedger user account to the business hub](connect-a-business-hub-for-riskledger.md#id-3.-connect-your-riskledger-user-account-to-the-business-hub)
4. [Manage unmatched users](connect-a-business-hub-for-riskledger.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1. Add a business hub and connect it to RiskLedger

To add a business hub and connect it to RiskLedger, you must complete the following steps:
...
6. Enter and select your app information in the corresponding fields:
   ...
   * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
     1. Select the **Single sign-on (SSO)** option because access must be managed by your IdP, and users log in with SSO authentication. They are not asked to save their credentials in Cerby. **IMPORTANT:** The Username and password option is not currently available for RiskLedger.
7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing RiskLedger accounts.
8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-riskledger.md#requirements) section. ​**NOTE:** If you don’t have an automation account, you are prompted to add it. Make sure you read Cerby’s recommendations on how to configure it in the article [Create a service account for your business hub](https://cerby-test.gitbook.io/cerby-test/management/identity-lifecycle/business-hubs/manage-integrations/create-an-automation-or-service-account-for-your-business-hub). You may need to add the account first and then add the business hub.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-riskledger.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_267.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your RiskLedger user account to the business hub](connect-a-business-hub-for-riskledger.md#id-3.-connect-your-riskledger-user-account-to-the-business-hub).

### 3. Connect your RiskLedger user account to the business hub

To connect your RiskLedger user account to the business hub so Cerby can manage and protect it, you must complete the following steps:
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-riskledger.md#id-4.-manage-unmatched-users).
...
1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
2. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_268.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
* [Match users](connect-a-business-hub-for-riskledger.md#match-users)
* [Remove unmatched users](connect-a-business-hub-for-riskledger.md#remove-unmatched-users)
* [Exempt unmatched users](connect-a-business-hub-for-riskledger.md#exempt-unmatched-users)
...
{% hint style="danger" %}
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in RiskLedger.
{% endhint %}

1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_269.png)) icon of the corresponding user. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_270.png)) icon of the corresponding user. A drop-down menu is displayed.
