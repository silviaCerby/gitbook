...
The following are the requirements to connect a business hub:
  ...
  * A Project ID. You can find the ID in the following ways:
    ...
    * **In the address bar:** When you are logged into your project in the Firebase console, the ID is displayed in the address bar as part of the URL, after the **project** subdirectory. For example, **`cerby-12345`** in **`https://console.firebase.google.com/project/cerby-12345`**. Just copy the value and paste it when connecting the business hub.

    * **In the business information or settings:** When you are logged in to Firebase, open your Firebase project, go to **Project Overview** , and select **Project settings**. The ID is displayed under the **General** tab in the**Project ID** field for you to copy.

{% hint style="danger" %} **IMPORTANT:** The Cerby browser extension must be
installed to execute the automated tasks. {% endhint %}
...
next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **Firebase Hub**. For instructions on how to find it, read the Requirements section.
...
**IMPORTANT:** Firebase only supports login with Google account credentials.
