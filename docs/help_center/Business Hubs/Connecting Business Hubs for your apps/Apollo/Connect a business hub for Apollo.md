...
Apollo. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Apollo, you must complete the following main
...
To add a business hub and connect it to Apollo, you must complete the
following steps:
...
next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your organization in Apollo. For instructions on how to find it, read the Requirements section.
...
The next step is 3\. Connect your Apollo user account to the business hub.

## 3\. Connect your Apollo user account to the business hub

To connect your Apollo user account to the business hub so Cerby can manage
