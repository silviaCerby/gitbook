...
UserGems. For other app-specific articles and videos, review the [Connecting
...
**NOTE:** The **Full Admin** role is granted by assigning **Admin**
permissions to both Contact Tracking and Meeting Assistant.
...
To connect a business hub for UserGems, you must complete the following main
...
To add a business hub and connect it to UserGems, you must complete the
following steps:
...
To connect your UserGems user account to the business hub so Cerby can manage
