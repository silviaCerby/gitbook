...
Kapa.ai. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Kapa.ai, you must complete the following main
...
To add a business hub and connect it to Kapa.ai, you must complete the
following steps:
...
To connect your Kapa.ai user account to the business hub so Cerby can manage
