...
This article provides instructions on how to connect a business hub for Habu.
...
To connect a business hub for Habu, you must complete the following main steps
...
To add a business hub and connect it to Habu, you must complete the following
steps:
...
To connect your Habu user account to the business hub so Cerby can manage and
