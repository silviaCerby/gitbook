...
perform the following user and access management tasks through automation jobs
...
The following are the requirements to connect a business hub:
  ...
  * A Business ID. You can find the ID in the address bar by completing the following steps after logging in to DV360:
...
next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your business or organization in **DV360 Hub**. For instructions on how to find it, read the Requirements section.
...
**IMPORTANT:** Cerby only supports logging in to DV360 through SSO using your
Google account managed in Okta.
...
Cerby performs an automation job to revoke the user’s seat and permissions in
DV360. {% endhint %}
