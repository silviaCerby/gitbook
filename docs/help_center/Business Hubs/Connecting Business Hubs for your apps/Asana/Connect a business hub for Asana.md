...
This article provides instructions on how to connect a business hub for Asana.
...
To connect a business hub for Asana, you must complete the following main
...
To add a business hub and connect it to Asana, you must complete the following
steps:
...
To connect your Asana user account to the business hub so Cerby can manage and
