...
As a user with any workspace role in Cerby except Guest User and Login-Only,
you can connect a business hub integration to centrally manage Shippo's users.
...
members’ roles is not available for this business hub because Shippo only
supports one role and one **Account Owner**. {% endhint %}

This article provides instructions on how to connect a business hub for
Shippo. For other app-specific articles and videos, review the [Connecting
...
required for the automated tasks to work correctly because Shippo performs
email validations. This email address must be associated with the user account
having the **Account Owner** role. {% endhint %}

* * *

# **Connect a business hub for Shippo**

To connect a business hub for Shippo, you must complete the following main
...
To add a business hub and connect it to Shippo, you must complete the
following steps:
...
To connect your Shippo user account to the business hub so Cerby can manage
