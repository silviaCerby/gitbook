...
Hotjar. For other app-specific articles and videos, review the [Connecting
...
The **Sites & Organizations **page is displayed. The ID is next to your
organization's name, as shown in **Figure 1**.

![](gitbook/imageshotjar_organization_id.png)
...
To connect a business hub for Hotjar, you must complete the following main
...
To add a business hub and connect it to Hotjar, you must complete the
following steps:
...
To connect your Hotjar user account to the business hub so Cerby can manage
