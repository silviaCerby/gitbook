...
Only** , you can connect a business hub integration to centrally manage
Hubspot users.
...
Hubspot. For other app-specific articles and videos, review the [Connecting
...
{% hint style="danger" %} **IMPORTANT:** A Cerby-managed email address is
required for the automated tasks to work correctly because Hubspot uses email
as the default verification method for multi-factor authentication (MFA). This
email address must be associated with the user account having the **Super
Admin** role. {% endhint %}
...
To connect a business hub for Hubspot, you must complete the following main
...
To add a business hub and connect it to Hubspot, you must complete the
following steps:
...
To connect your Hubspot user account to the business hub so Cerby can manage
