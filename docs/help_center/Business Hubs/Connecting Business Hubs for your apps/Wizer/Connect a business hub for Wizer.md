...
This article provides instructions on how to connect a business hub for Wizer.
...
To connect a business hub for Wizer, you must complete the following main
...
To add a business hub and connect it to Wizer, you must complete the following
steps:
...
To connect your Wizer user account to the business hub so Cerby can manage and
