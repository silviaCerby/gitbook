...
endhint %}{% hint style="info" %} **NOTE:** The automated task to invite app
members is not available for this business hub because BuildBuddy provides
access through a generic URL that users must visit to accept the invitation {%
endhint %}

This article provides instructions on how to connect a business hub for
BuildBuddy. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for BuildBuddy, you must complete the following main
...
To add a business hub and connect it to BuildBuddy, you must complete the
following steps:
...
To connect your BuildBuddy user account to the business hub so Cerby can
