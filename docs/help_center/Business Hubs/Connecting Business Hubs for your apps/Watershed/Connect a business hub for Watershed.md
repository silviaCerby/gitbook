...
endhint %}{% hint style="info" %} **NOTE:** Watershed supports two roles,
**Admin** and **Member** , and multiple permissions that can be assigned to
app members. A user can have multiple roles and permissions. {% endhint %}

This article provides instructions on how to connect a business hub for
Watershed. For other app-specific articles and videos, review the [Connecting
...
**IMPORTANT:** Currently,**** this business hub only supports single sign-on
(SSO) as the user management and login method.

* * *

# **Connect a business hub for Watershed**

To connect a business hub for Watershed, you must complete the following main
...
To add a business hub and connect it to Watershed, you must complete the
following steps:
...
​**IMPORTANT:** Currently, this business hub doesn’t support the **Username
and password** option.
...
To connect your Watershed user account to the business hub so Cerby can manage
