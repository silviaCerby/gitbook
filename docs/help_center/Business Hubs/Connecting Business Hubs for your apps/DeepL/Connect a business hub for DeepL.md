...
endhint %}{% hint style="info" %} **NOTE:** When inviting an app member, you
cannot assign them a role; they are assigned the **team member** role by
default. You can only update the role of existing app members. {% endhint %}

This article provides instructions on how to connect a business hub for DeepL.
...
To connect a business hub for DeepL, you must complete the following main
...
To add a business hub and connect it to DeepL, you must complete the following
steps:
...
To connect your DeepL user account to the business hub so Cerby can manage and
