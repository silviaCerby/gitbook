...
This article provides instructions on how to connect a business hub for Alta.
...
To connect a business hub for Alta, you must complete the following main steps
...
To add a business hub and connect it to Alta, you must complete the following
steps:
...
To connect your Alta user account to the business hub so Cerby can manage and
