...
This article provides instructions on how to connect a business hub for Prezi.
...
To connect a business hub for Prezi, you must complete the following main
...
To add a business hub and connect it to Prezi, you must complete the following
steps:
...
To connect your Prezi user account to the business hub so Cerby can manage and
