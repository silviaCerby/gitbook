...
CoderPad Screen. For other app-specific articles and videos, review the
...
To connect a business hub for CoderPad Screen, you must complete the following
...
To add a business hub and connect it to CoderPad Screen, you must complete the
following steps:
...
The next step is 3\. Connect your CoderPad Screen user account to the business
hub.

## 3\. Connect your CoderPad Screen user account to the business hub

To connect your CoderPad Screen user account to the business hub so Cerby can
