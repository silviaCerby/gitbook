...
endhint %}{% hint style="info" %} **NOTE:** The automated tasks to invite app
members and update app members’ roles are not available for this business hub.
{% endhint %}

This article provides instructions on how to connect a business hub for
Whistic. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Whistic, you must complete the following main
...
To add a business hub and connect it to Whistic, you must complete the
following steps:
...
To connect your Whistic user account to the business hub so Cerby can manage
