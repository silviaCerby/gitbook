...
CloudAlly. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for CloudAlly, you must complete the following main
...
To add a business hub and connect it to CloudAlly, you must complete the
following steps:
...
The next step is 3\. Connect your CloudAlly user account to the business hub.

## 3\. Connect your CloudAlly user account to the business hub

To connect your CloudAlly user account to the business hub so Cerby can manage
