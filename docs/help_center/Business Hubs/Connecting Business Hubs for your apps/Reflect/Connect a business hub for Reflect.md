...
Reflect. For other app-specific articles and videos, review the [Connecting
...
**IMPORTANT:** Currently, single sign-on (SSO) is not supported by this
business hub.
...
The business ID is the value inside the **Account Name** field in the
**Account Configuration** section, as shown in **Figure 1**.

![](gitbook/imagesAD_4nXf3sPgvPPku4GydJB0gkHmVnictTlIEo2_80iOeUJbLZU4TdTJ9wxZR6GnFcgoOA5ofDI6SUFlX2bb5SHkv1tdjNaLkJm77SHoT8Tx3pD367ZQ0ejUD3GfKIKVxKEuGZYEc0YYAYQ)
...
To connect a business hub for Reflect, you must complete the following main
...
To add a business hub and connect it to Reflect, you must complete the
following steps:
...
**IMPORTANT:** Currently, the **Single sign-on (SSO)** option is not supported
by this business hub.
...
To connect your Reflect user account to the business hub so Cerby can manage
