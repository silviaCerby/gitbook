...
members’ roles is not available for this business hub because Kahoot
**Admins** can only assign **Member** and **Limited Member** roles. Automated
invites for new members are also unavailable because invites are sent via an
invite link that **Admins** must copy and paste. {% endhint %}

This article provides instructions on how to connect a business hub for
Kahoot. For other app-specific articles and videos, review the [Connecting
...
To connect a business hub for Kahoot, you must complete the following main
...
To add a business hub and connect it to Kahoot, you must complete the
following steps:
...
To connect your Kahoot user account to the business hub so Cerby can manage
