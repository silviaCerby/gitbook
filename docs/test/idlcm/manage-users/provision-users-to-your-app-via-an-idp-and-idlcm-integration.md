---
description: >-
  This article describes how to provision users to your external app via an IdP
  and IdLCM integration
---
...
2. Assign users or groups to the app integration. For instructions, read the official documentation of your IdP:
   *   **Okta:**
       ...
       * [Assign an app integration to a user](https://help.okta.com/oie/en-us/content/topics/provisioning/lcm/lcm-assign-app-user.htm) ​**NOTE** : For external apps supporting entitlements, you can grant access to an entitlement by completing the following steps:
