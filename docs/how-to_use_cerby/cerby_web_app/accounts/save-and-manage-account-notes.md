...
Account notes can be imported to Cerby from your password notes in LastPass. For more information, read the [How to use the Password Manager Importer](https://help.cerby.com/en/articles/7175132-how-to-use-the-password-manager-importer) article.
