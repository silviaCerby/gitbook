...
**Who can use this feature?**
  ...
  * Account **Owners**
  * Supported using the Cerby web app and mobile app. For the Cerby mobile app, read the article [Share an account using the Cerby mobile app](https://help.cerby.com/en/articles/9715128-share-an-account-using-the-cerby-mobile-app)
