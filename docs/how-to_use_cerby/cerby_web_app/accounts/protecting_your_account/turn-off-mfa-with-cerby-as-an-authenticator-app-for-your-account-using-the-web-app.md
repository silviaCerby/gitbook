...
As an account **Owner** , you can turn off multi-factor authentication (MFA) with Cerby as an authenticator app for your account.
...
To turn off MFA manually using Cerby, you must complete the following steps:
  ...
  1. [Turn off MFA manually in your app](turn-off-mfa-with-cerby-as-an-authenticator-app-for-your-account-using-the-web-app.md#id-1.-turn-off-mfa-manually-in-your-app)
  2. [Turn off MFA manually in Cerby](turn-off-mfa-with-cerby-as-an-authenticator-app-for-your-account-using-the-web-app.md#id-2.-turn-off-mfa-manually-in-cerby)
...
**IMPORTANT:** Refer to your app’s official documentation for the accurate steps to turn off using an authenticator app for your account.
...
The next step is [2. Turn off MFA manually in Cerby](turn-off-mfa-with-cerby-as-an-authenticator-app-for-your-account-using-the-web-app.md#id-2.-turn-off-mfa-manually-in-cerby).
