...
With Cerby, all the users within a workspace, no matter their role, have a secure and centralized way to store and view the messages sent to the Cerby-managed email addresses they create and set up for their accounts.
...
**IMPORTANT:** The forward message feature is not supported for SMS messages sent to Cerby-managed phone numbers.
