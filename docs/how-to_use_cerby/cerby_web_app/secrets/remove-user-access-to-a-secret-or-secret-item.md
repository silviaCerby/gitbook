...
To remove user access to a secret or secret item, you must complete the following steps using the Cerby web app:
  ...
  3. Click the **Settings** (<figure><img src="../.gitbook/assets/unnamed_42.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
...
**NOTE:** To remove guest user access from external parties, activate the **Guest users** tab.
  ...
  5. Click the **More options** (<figure><img src="../.gitbook/assets/unnamed_43.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding user. A drop-down list is displayed.
