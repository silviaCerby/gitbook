...
* You must have set your [trusted devices](https://cerby-test.gitbook.io/cerby-test/management/workspace-configuration/trusted-devices/set-up-trusted-sessions-on-your-devices)
...
To learn how to download attachments in the Cerby mobile app, read the article [Download the attachments of a secret and secret item in the Cerby mobile app](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-mobile-app/secrets/download-the-attachments-of-a-secret-and-secret-item-in-the-cerby-mobile-app).
...
To add an attachment to a secret or secret item, you must complete the following steps using the Cerby web app:
  ...
  **NOTE:** If an identity challenge is configured, the **Confirm your identity to continue** dialog box is displayed. To confirm your identity, use one of [Cerby's multi-factor authentication methods](https://cerby-test.gitbook.io/cerby-test/management/identity-providers-idps/scim/set-up-your-identity-with-cerby-s-mfa-methods).
  ...
  5. Select the file you want to add as an attachment to the secret. For more information on the size limits and supported file formats, read the [Specifications](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-secrets) section.
