...
* **NOTE:** For the Cerby mobile app, read the article [Remove team access to a secret or secret item using the Cerby mobile app](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-mobile-app/secrets/remove-team-access-to-a-secret-or-secret-item-using-the-cerby-mobile-app)
...
3. Click the **Settings** (<img src="../../../../.gitbook/assets/unnamed_40.png" alt="">) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
...
5. Click the **More options** (<img src="../../../../.gitbook/assets/unnamed_41.png" alt="">) icon of the corresponding team. A drop-down list is displayed.
