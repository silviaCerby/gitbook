...
To remove team access to a secret or secret item, you must complete the following steps using the Cerby web app:
  ...
  3. Click the **Settings** (<figure><img src="../.gitbook/assets/unnamed_40.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding secret card. The secret details page is displayed with the **Settings** tab activated.
...
**NOTE:** If an identity challenge is configured, the **Confirm your identity to continue** dialog box is displayed, and a push notification is sent to your Cerby mobile app:
  ...
  5. Click the **More options** (<figure><img src="../.gitbook/assets/unnamed_41.png" alt=""><figcaption></figcaption></figure>) icon of the corresponding team. A drop-down list is displayed.
