...
* **NOTE:** For the Cerby mobile app, read the article [View a secret in the Cerby mobile app](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-mobile-app/secrets/view-a-secret-using-the-cerby-mobile-app)
...
Additionally, as mentioned in the article [Add a secret](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-web-app/secrets/add-a-secret), you can configure an identity challenge to view a secret. In this case, all users with shared access, including **Owners** , must confirm their identity to view a secret.
