...
the Scout browser extension to scout the ways you complete user and account
tasks on your apps and help accelerate the process of building the automation
jobs you use in Cerby. As a workspace **user** , you must request
authorization to install Scout from a Cerby Admin.

**IMPORTANT:** Your organization must request Cerby access to this extension
because it is privately listed in the Chrome Web Store.  
---  
