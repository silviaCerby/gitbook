...
intercom_id: 11429586
---

# Add a software license item using the Cerby mobile app
...
To add a software license item using the Cerby mobile app, you must complete the following steps:
