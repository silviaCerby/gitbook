...
* Supported using the Cerby web app and mobile app. For the web app instructions, read the article [Update a user's role on a secret or secret item](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-web-app/secrets/update-a-user-s-role-on-a-secret-or-secret-item)
