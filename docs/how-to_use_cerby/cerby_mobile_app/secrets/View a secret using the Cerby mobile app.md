...
Any user who created a secret or was granted access to one can view the secret
details in the Cerby mobile app, regardless of workspace role.

To view a secret using the Cerby mobile app, you must complete the following
steps:
