...
As a collection **Owner** , you can update other teams’ roles on your collections using the Cerby mobile app. The roles you can select for teams are **Owner** or **Collaborator** , and this role propagates to all team members.

To update a team’s role on a collection, you must complete the following steps using the Cerby mobile app:
