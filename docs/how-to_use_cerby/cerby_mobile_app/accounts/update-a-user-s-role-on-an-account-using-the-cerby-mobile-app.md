...
As an account **Owner** , you can update other users' roles on your accounts using the Cerby mobile app. You can select the roles of **Owner** or **Collaborator** for them.
