...
Account **Owners** and **Collaborators** * Supported using the Cerby mobile
app {% endhint %}

As an account **Owner** or **Collaborator** , you can quickly access the
following actions for your accounts from the home screen:
...
To access and use the quick actions for your accounts in the Cerby mobile app,
