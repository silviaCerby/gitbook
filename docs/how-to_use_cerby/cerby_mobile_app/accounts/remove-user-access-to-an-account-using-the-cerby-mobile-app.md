...
To remove user access to an account, you must complete the following steps using the Cerby mobile app:
...
​**NOTE:** To remove guest user access from external parties, tap the right arrow in the **Guest users** list.
