...
As an account **Owner** or **Manager** , you can edit the information of an account using the Cerby mobile app.

To edit an account using the Cerby mobile app, you must complete the following steps:
  ...
  5. Tap the **More options** (<figure><img src="../.gitbook/assets/Screenshot_2024-08-07_at_2.30.21_3Fp.m..png" alt=""><figcaption></figcaption></figure>) icon. A menu is displayed.
