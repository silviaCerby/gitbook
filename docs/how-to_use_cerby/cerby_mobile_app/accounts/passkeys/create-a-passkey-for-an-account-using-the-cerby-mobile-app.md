...
The next time you log in to the account, you can use the passkey you created. For more information, read the article [Log in to an account using a passkey with the Cerby mobile app](https://help.cerby.com/en/articles/10875427-log-in-to-an-account-with-a-passkey-using-the-cerby-mobile-app).
