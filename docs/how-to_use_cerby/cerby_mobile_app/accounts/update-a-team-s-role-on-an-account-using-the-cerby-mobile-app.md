...
**Who can use this feature?**
  ...
  * Account **Owners**
  * Supported using the Cerby web app and mobile app. For the web app instructions, read the article [Update a team’s role on an account](https://help.cerby.com/en/articles/9479440-update-a-team-s-role-on-an-account)
