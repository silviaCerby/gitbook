...
intercom_id: 9510231
description: >-
  This article describes how to activate or deactivate the account autosave
  feature in the Cerby browser extension settings.
---

# Activate or deactivate account autosave in the Cerby browser extension
...
3. Click the **Settings** (<img src=".gitbook/assets/unnamed_39.png" alt="" data-size="line">) icon located at the top right of the browser extension popup. The **Settings** page is displayed.
4. Activate or deactivate the **Account autosave** switch, as **Figure 1**.

![](.gitbook/assets/image7_2.png)
