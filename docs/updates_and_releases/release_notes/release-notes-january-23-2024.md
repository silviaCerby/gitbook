...
For customers interested in detecting app sprawl in their organization, contact your Customer Success Manager to learn how to join our Early Access Program. In the meantime, look at the article [Explore Cerby Suggest](https://help.cerby.com/en/articles/8839657-explore-cerby-suggest) to learn more about the benefits and supported features. Also, check out the Cerby web app dashboard for Suggest, as shown in **Figure 1**.
