...
<img src="../../../.gitbook/assets/AD_4nXe-Z22iJWy9A7deOfrieJkRnR4eL4oACv-lW_TF0EigVRXFzM6EQTG-QbPcVrYU2g4xlu1fFN6o1C1vGzJawlNtSIrJd1n-KnPI1tzXlcY62RfgxPgSL-Arnuvbe9m6DaU7jtDmsg.png" alt="Screenshot of the Cerby web app dashboard \(left\) and the mobile app \(right\). The account details page is displayed in the web app with an RSA code, and a QR code being scanned is displayed in the mobile app.">
...
For more information, read the article [Set RSA tokens as your account MFA method](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-web-app/accounts/protecting-your-account/set-rsa-tokens-as-your-account-verification-method).
