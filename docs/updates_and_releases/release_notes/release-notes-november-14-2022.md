...
* [Creating a team manually](https://cerby-test.gitbook.io/cerby-test/management/workspace-configuration/user-management/teams/how-to-use-teams) in Cerby with the members of your corporate directory is now supported.
