...
* We know you wanted to save additional information in your Cerby accounts. That’s why the [Account Notes](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-web-app/accounts/save-and-manage-account-notes) and [Custom Fields](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-web-app/accounts/add-and-manage-custom-fields-for-your-accounts) features**** are now available on the account details page using the Cerby web app, as shown in **Figure 1**.

<img src="../../../.gitbook/assets/T4OVgSMwK1R0HaCnP-nPNyUkCvyZ__U1oCENmYSb0od1wdHYAIFrDZEGQd_3chJZkVKd_snYFgeGeDbhaIWdb2V-OQYt-aWqTyd3fe8kxp9moEFlGxV0YouVLYsxrsDU9FNaWAxajAE8GAooaSgsokY.png" alt="Screenshot of the account details page, where you can manage your account and save information via the Notes field or new custom fields.">
...
Additionally, we included a checklist in our [documentation](https://cerby-test.gitbook.io/cerby-test/management/credential-management/item-importer/migrate-from-lastpass-to-cerby) to ensure you have all you need before retrying the import.
...
* Our Development team is on fire! Enjoy the new [tenants](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/explore/explore-business-hubs) we support:
