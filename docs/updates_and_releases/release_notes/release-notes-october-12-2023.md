...
What are you waiting for? Take a look at the [Get started with Cerby Protect](https://cerby-test.gitbook.io/cerby-test/support-and-use-cases/use-cases/get-started-with-cerby-protect) article to learn more about the benefits and supported features. Also, check out the **Vault strategy** section in the **Privacy and security** tab of the workspace settings page, as shown in **Figure 1**.
...
For more information, read the [How to generate secure passwords using the Cerby browser extension](https://cerby-test.gitbook.io/cerby-test/how-to-use-cerby/cerby-browser-extension/generate-secure-passwords-using-the-cerby-browser-extension) article.
