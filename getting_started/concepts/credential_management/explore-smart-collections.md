...
intercom_id: 9422854
description: >-
  This article describes the business context for implementing the Smart
  Collections feature in L’Oréal’s workspace and includes a user guide for
  proper use.
hidden: true
noIndex: true
---
...
6. Select optionally an existing collection from the **Collection** drop-down menu to add the account to it. Besides the automatic assignment, you can add the account to another collection manually. ​**NOTE:** Accounts can belong to more than one collection.
...
3. Hover the mouse over the **Division** , **Zone** , **Brand** , and **Market** fields in the **Account labels** section. The **Edit** (![](../../../.gitbook/assets/unnamed.png)) icon is displayed.
4. Click the **Edit** (![](../../../.gitbook/assets/unnamed.png)) icon. The drop-down lists are enabled next to the **Division** , **Zone** , **Brand** , and **Market** fields.
5. Select the corresponding option in the following fields:
   * **Division**
   * **Zone**
   * **Brand**
   * **Market**
6. Click the **Done** (![](../../../.gitbook/assets/unnamed_2.png)) icon. The edit fields are disabled, and a success message box is displayed.
...
![](../../../.gitbook/assets/ec66d781-ed94-4f81-a572-082bd07fbb50.png)
...
![](../../../.gitbook/assets/67fbdb1d-8cd2-49ce-bbfa-a85e43c677b8.png)
...
3. Click the **Settings** (![](../../../.gitbook/assets/unnamed_3.png)) icon of the corresponding collection card. The collection details page is displayed with the **General** tab activated.
4. Hover the mouse over the **Division** , **Zone** , **Brand** , and **Market** fields in the **Tags** section. The **Edit** (![](../../../.gitbook/assets/unnamed_4.png)) icon is displayed.
5. Click the **Edit** (![](../../../.gitbook/assets/unnamed.png)) icon. The drop-down lists appear next to the **Division** , **Zone** , **Brand** , and **Market** fields.
6. Select the corresponding option in the following fields:
   ...
   * **Brand**
   * **Market**
7. Click the **Done** (![](../../../.gitbook/assets/unnamed.png)) icon. The edit fields are disabled, and a success message is displayed. The accounts that match the tags are displayed in the **Accounts** tab.
...
1. Log in to your Cerby workspace.
2. Select the **Collections** option from the left navigation drawer. The **Collections** view is displayed.
3. Click the **Settings** (![](../../../.gitbook/assets/unnamed.png)) icon of the corresponding collection card. The collection details page is displayed with the **General** tab activated.
