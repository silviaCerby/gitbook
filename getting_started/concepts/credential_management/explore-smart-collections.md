...
To edit the tags of a corporate account, you must complete the following steps:
  ...
  3. Hover the mouse over the **Division** , **Zone** , **Brand** , and **Market** fields in the **Account labels** section. The **Edit** (<img src="../../../.gitbook/assets/unnamed.png" alt="">) icon is displayed.
  4. Click the **Edit** (<img src="../../../.gitbook/assets/unnamed_1.png" alt="">) icon. The drop-down lists are enabled next to the **Division** , **Zone** , **Brand** , and **Market** fields.
  ...
  6. Click the **Done** (<img src="../../../.gitbook/assets/unnamed_2.png" alt="">) icon. The edit fields are disabled, and a success message box is displayed.
...
To update the tags of a collection, you must complete the following steps:
  ...
  3. Click the **Settings** (<img src="../../../.gitbook/assets/unnamed_3.png" alt="">) icon of the corresponding collection card. The collection details page is displayed with the **General** tab activated.
  4. Hover the mouse over the **Division** , **Zone** , **Brand** , and **Market** fields in the **Tags** section. The **Edit** (<img src="../../../.gitbook/assets/unnamed_4.png" alt="">) icon is displayed.
  5. Click the **Edit** (<img src="../../../.gitbook/assets/unnamed_5.png" alt="">) icon. The drop-down lists appear next to the **Division** , **Zone** , **Brand** , and **Market** fields.
  ...
  7. Click the **Done** (<img src="../../../.gitbook/assets/unnamed_6.png" alt="">) icon. The edit fields are disabled, and a success message is displayed. The accounts that match the tags are displayed in the **Accounts** tab.
...
To view the assigned accounts of a collection, you must complete the following steps:
  ...
  1. Log in to your Cerby workspace.
  2. Select the **Collections** option from the left navigation drawer. The **Collections** view is displayed.
  3. Click the **Settings** (<img src="../../../.gitbook/assets/unnamed_7.png" alt="">) icon of the corresponding collection card. The collection details page is displayed with the **General** tab activated.
