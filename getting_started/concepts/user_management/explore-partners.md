...
intercom_id: 8980877
description: >-
  This article describes the key benefits of the Partners feature that enables
  you to collaborate with external parties through Cerby.
---
...
**NOTE:** **Guest Admins** can’t add other local partners, import items from LastPass, or view workspace users, policies, or settings. **Guest User**| It is a role assigned to an external collaborator invited to join a Cerby workspace with limited access to items and assets, enough to perform their activities. Account **Manager**| It is an account-level role assigned by the **Host Admin** when sharing an account with the local partner; by default, the role is assigned to the **Guest** **Admin**. With this role, they can perform the following actions:
