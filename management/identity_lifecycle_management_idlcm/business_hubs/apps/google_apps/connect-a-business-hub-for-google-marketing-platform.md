...
2. Click the **More options** (![](../../../../../.gitbook/assets/unnamed.png)) icon of the corresponding business hub card. A drop-down menu is displayed.
...
1. Click the **More options** (![](../../../../../.gitbook/assets/unnamed.png)) icon of the corresponding user. A drop-down menu is displayed.
