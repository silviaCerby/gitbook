...
7. A Workspace slug. You can find the slug by completing the following steps after logging in to Britise: 1. Select your workspace from the **Workspace** drop-down menu. 2. Select the **Settings** option from the left menu. The **Workspace settings** page is displayed.
