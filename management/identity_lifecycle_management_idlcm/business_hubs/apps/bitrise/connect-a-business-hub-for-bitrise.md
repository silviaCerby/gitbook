---
description: "This article describes how to connect a business hub to centrally manage the users of Bitrise from Cerby."
intercom_id: 12134053
---
...
This article provides instructions on how to connect a business hub for Bitrise. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  6. The user management and login method for your business hub identified to select the corresponding option when connecting your app. For more information, read the **User management and login method** section of the article [Explore Business Hubs](https://help.cerby.com/en/articles/6831152-explore-apps)
  7. A Workspace slug. You can find the slug by completing the following steps after logging in to Britise:
    ...
    2. Select the **Settings** option from the left menu.
The **Workspace settings** page is displayed.

    3. Select the **General settings** option from the left menu.
...
<img src="../../../../../../.gitbook/assets/uuid-c82d552a-8d31-148f-82e4-bb4ec929c183.png" alt="workspace-slug.png">

**Figure 1**. **Workspace slug** field in the **General settings** page
...
To connect a business hub for Bitrise, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Bitrise](connect-a-business-hub-for-bitrise.md#id-1.-add-a-business-hub-and-connect-it-to-bitrise)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-bitrise.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Bitrise user account to the business hub](connect-a-business-hub-for-bitrise.md#id-3.-connect-your-bitrise-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-bitrise.md#id-4.-manage-unmatched-users)
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Workspace slug:** It is the unique identifier of your business or organization in **Bitrise Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-bitrise.md#requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-bitrise.md#requirements) section.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-bitrise.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
The next step is [3. Connect your Bitrise user account to the business hub](connect-a-business-hub-for-bitrise.md#id-3.-connect-your-bitrise-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-bitrise.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-bitrise.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-bitrise.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-bitrise.md#exempt-unmatched-users)
