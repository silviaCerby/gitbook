---
description: "This article describes how to connect a business hub to centrally manage the users of Microsoft 365 Enterprise from Cerby."
intercom_id: 13443594
---

# Connect a business hub for Microsoft 365 Enterprise
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Microsoft 365 Enterprise.
...
**IMPORTANT:** Microsoft 365 Enterprise requires an additional field, **Email Domain** , to create user accounts. You must provide this value when adding users to your external app.


{% endhint %}

This article provides instructions on how to connect a business hub for Microsoft 365 Enterprise. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **User Administrator** role in Microsoft 365 Enterprise to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://help.cerby.com/en/articles/9830816-create-an-automation-or-service-account-for-your-business-hub)
* * *

## Connect a business hub for Microsoft 365 Enterprise

To connect a business hub for Microsoft 365 Enterprise, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Microsoft 365 Enterprise](connect-a-business-hub-for-microsoft-365-enterprise.md#id-1.-add-a-business-hub-and-connect-it-to-microsoft-365-enterprise)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-microsoft-365-enterprise.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Microsoft 365 Enterprise user account to the business hub](connect-a-business-hub-for-microsoft-365-enterprise.md#id-3.-connect-your-microsoft-365-enterprise-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-microsoft-365-enterprise.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Microsoft 365 Enterprise

To add a business hub and connect it to Microsoft 365 Enterprise, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Microsoft 365 Enterprise Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Microsoft 365 Enterprise.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Microsoft 365 Enterprise accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-microsoft-365-enterprise.md#requirements) section.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_9.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
The next step is [3. Connect your Microsoft 365 Enterprise user account to the business hub](connect-a-business-hub-for-microsoft-365-enterprise.md#id-3.-connect-your-microsoft-365-enterprise-user-account-to-the-business-hub).

### 3\. Connect your Microsoft 365 Enterprise user account to the business hub

To connect your Microsoft 365 Enterprise user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Microsoft 365 Enterprise Hub account card. The **Connect your Microsoft 365 Enterprise Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Microsoft 365 Enterprise** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-microsoft-365-enterprise.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1966739113/2156877ae0d5d65c8e91538759a6/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg?expires=1768944000&signature=6299e1492458dc2cd04ba4a56268a32959fca03a0e22ee058f5783de60c3901e&req=dSkhEM59lIBeWvMU3HP0gLRfxwmmadGF4l9n9XsWUQfDEYk%2B%2Fb0%3D%0A" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-microsoft-365-enterprise.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-microsoft-365-enterprise.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-microsoft-365-enterprise.md#exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Microsoft 365 Enterprise.


{% endhint %}

  1. Click the **More options** (<img src="../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_10.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_11.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
