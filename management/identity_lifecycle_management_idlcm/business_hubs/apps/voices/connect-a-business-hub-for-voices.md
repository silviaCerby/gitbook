...
To connect a business hub for Voices, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Voices](connect-a-business-hub-for-voices.md#id-1.-add-a-business-hub-and-connect-it-to-voices)[ ](https://help.cerby.com/en/articles/9046120-connect-an-app#h_039a665169)
