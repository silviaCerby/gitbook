---
description: "This article describes how to connect a business hub to centrally manage the users of Artisan from Cerby."
intercom_id: 13226827
---
...
This article provides instructions on how to connect a business hub for Artisan. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for Artisan, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Artisan](connect-a-business-hub-for-artisan.md#id-1.-add-a-business-hub-and-connect-it-to-artisan)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-artisan.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Artisan user account to the business hub](connect-a-business-hub-for-artisan.md#id-3.-connect-your-artisan-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-artisan.md#id-4.-manage-unmatched-users)
...
​**IMPORTANT** : The **Username and password** option is not supported for Artisan.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Artisan accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-artisan.md#requirements) section.
...
The next step is [3. Connect your Artisan user account to the business hub](connect-a-business-hub-for-artisan.md#id-3.-connect-your-artisan-user-account-to-the-business-hub).
...
The next step is [4. Manage unmatched users](connect-a-business-hub-for-artisan.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-artisan.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-artisan.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-artisan.md#exempt-unmatched-users)
