---
description: "This article describes how to connect a business hub to centrally manage the users of Recall.ai from Cerby."
intercom_id: 13443691
---

# Connect a business hub for Recall.ai
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Recall.ai.
...
**IMPORTANT:** Recall.ai requires an additional field, **Workspace** , to create user accounts. You must provide this value exactly as it appears in Recall.ai when adding users to your external app.


{% endhint %}

This article provides instructions on how to connect a business hub for Recall.ai. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
The following are the requirements to connect a business hub:
  ...
  * An automation account, meaning an active user account with a native **Administrator** role in Recall.ai to be used as a service account. For instructions and recommendations on how to create and configure this account, read the article [Create a service account for your business hub](https://help.cerby.com/en/articles/9830816-create-an-automation-or-service-account-for-your-business-hub)
  **IMPORTANT:** You must provide the **Region** for your Recall.ai service account. You can find this value in the address bar when you are logged in to **Recall.ai**. It appears as the URL subdomain. For example, **`us-west-2` **in **`https://us-west-2.recall.ai/dashboard`**.

  * A workspace name. You can find the workspace name in the account settings by completing the following steps after logging in to Recall.ai:

    1. Select the **Teams** option from the left menu. The **Team** page is displayed.
    2. Activate the **Workspace** tab. The list of available workspaces is displayed, as shown in **Figure 1**.

<img src="../.gitbook/assets/image.png" alt="">

**Figure 1.** Workspace names in the **Teams** page

    3. Copy the name of the workspace exactly as displayed.

* * *

## Connect a business hub for Recall.ai

To connect a business hub for Recall.ai, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to Recall.ai](connect-a-business-hub-for-recall-ai.md#id-1.-add-a-business-hub-and-connect-it-to-recall.ai)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-recall-ai.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your Recall.ai user account to the business hub](connect-a-business-hub-for-recall-ai.md#id-3.-connect-your-recall.ai-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-recall-ai.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to Recall.ai

To add a business hub and connect it to Recall.ai, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Recall.ai Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Workspace name:** It is the unique identifier of your business or organization in **Recall.ai Hub**. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-recall-ai.md#requirements) section.
     * **User management and login method:** It is the way your users log in to the app and determines whether they must save their login credentials as a Cerby account connected to the business hub.
       ...
       **IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Recall.ai.

  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing Recall.ai accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-recall-ai.md#requirements) section.
...
The next step is [3. Connect your Recall.ai user account to the business hub](connect-a-business-hub-for-recall-ai.md#id-3.-connect-your-recall.ai-user-account-to-the-business-hub).

### 3\. Connect your Recall.ai user account to the business hub

To connect your Recall.ai user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding Recall.ai Hub account card. The **Connect your Recall.ai Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **Recall.ai** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-recall-ai.md#id-4.-manage-unmatched-users).
...
To view the status of the imported app members, you must complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_6.png" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-recall-ai.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-recall-ai.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-recall-ai.md#exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Recall.ai.


{% endhint %}

  1. Click the **More options** (<img src="../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_7.png" alt="">) icon of the corresponding user. A drop-down menu is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../.gitbook/assets/AD_4nXewApJOBZXewpFew1XrkjC6rCssB5Upy2WRCW8fpJjw2Zmj0xzSkEgw3tUBvW6lyQC2RihdmxzJ6KKXG1pvMGfAeaQnjZUGnThkBo5vdisjtu8WvqHXLgT1_7-xOwkkFy5umyicPg_8.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
