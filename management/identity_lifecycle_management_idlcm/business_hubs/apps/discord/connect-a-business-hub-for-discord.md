...
To reorder the role hierarchy in Discord, you must follow the next steps:
  ...
  * Your Discord server ID (a 19-digit numerical code). You must complete the following steps to get it:
    ...
    1. Open the Discord server on the desktop or web app.
    2. Click the **User Settings** (<img src="../../../../../../.gitbook/assets/unnamed_29.png" alt="">) icon next to your user name at the bottom left pane. The **My Account** detail window opens.
    ...
    5. Click the **ESC** (<img src="../../../../../../.gitbook/assets/unnamed_30.png" alt="">) button.
...
To check for updates in your app to identify and import users and roles to Cerby, you must complete the following steps:
  ...
  2. Click the **Settings** (<img src="../../../../../../.gitbook/assets/unnamed_31.png" alt="">) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
---
  ...
  1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
  2. Click the **More options** (<img src="../../../../../../.gitbook/assets/unnamed_32.png" alt="">) icon on the corresponding business hub card. A drop-down list is displayed.
...
---
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/unnamed_33.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
...
To exempt unmatched users, you must complete the following steps from the **Unmatched users** tab of the business hub details page:
  ...
  1. Click the **More options** (<img src="../../../../../../.gitbook/assets/unnamed_34.png" alt="">) icon of the corresponding user. A drop-down list is displayed.
