...
intercom_id: 9823646
description: >-
  This article describes how to connect a business hub to manage Discord users’
  roles from Cerby.
---
...
* An active Discord server with the following characteristics:
  * To install the **Cerby Integration - Production** application on your Discord server, complete the following steps:
    ...
    5. Complete the challenge in the dialog box. The **Success!** page is displayed. The Cerby application is installed on the server. It displays the **APP** tag next to its name. You can also see it in the **Integrations** window of the server settings. ​**TIP:** By default, an announcement in the **General** channel informs that the **Cerby Integration - Production** application has been installed. You can turn off this announcement or change the display name by following the next steps:
    6. Right-click the **Cerby Integration - Production** application link in the message. A menu is displayed.
    7. Select the **Change Nickname** option from the menu. The **Change Nickname** window opens.
    8. Enter the new name for the application in the **NICKNAME** field.
    9. Click the **Save** button. The message on the **General** channel displays the updated name for the Cerby application.
...
* Your Discord server ID (a 19-digit numerical code). You must complete the following steps to get it:
  1. Open the Discord server on the desktop or web app.
  2. Click the **User Settings** (![](../../../../../.gitbook/assets/unnamed_29.png)) icon next to your user name at the bottom left pane. The **My Account** detail window opens.
  ...
  5. Click the **ESC** (![](../../../../../.gitbook/assets/unnamed_30.png)) button.
...
1. [Add a business hub and connect it to Discord](connect-a-business-hub-for-discord.md#id-1.-add-a-business-hub-and-connect-it-to-discord)
2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-discord.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
3. [Manage synced users](connect-a-business-hub-for-discord.md#id-3.-manage-synced-users)
4. [Connect your app’s user account to the business hub](connect-a-business-hub-for-discord.md#id-4.-connect-your-apps-user-account-to-the-business-hub)
...
7\. Click the **Next** button. The **Select automation account** page is displayed. 8. Select the Discord account you previously created.
...
The next step is [2. Check for updates to import users and roles to Cerby](connect-a-business-hub-for-discord.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby).
...
2. Click the **Settings** (![](../../../../../.gitbook/assets/unnamed_31.png)) icon of the corresponding business hub card. The business hub details page is displayed with the **Settings** tab activated.
...
4. Confirm that the **Check for updates** automated task has the “Completed” status by performing any of the following actions: 1. Click the **More details** button from the message box. 2. Select the **Automation** option from the left navigation drawer to open the **Automation** view.

{% hint style="info" %}
**NOTE:** Cerby automatically performs daily checks for updates for all business hubs, but you can trigger them manually, as described above in steps 1 to 3. For more instructions, read the article [Check for updates in your app and apply report](https://help.cerby.com/en/articles/9046205-check-for-updates-in-your-app-and-apply-report).
{% endhint %}

The next step is [3. Manage the synced users](connect-a-business-hub-for-discord.md#id-3.-manage-synced-users), which you must complete from your Cerby dashboard.
...
1. Select the **Business Hubs** option from the left navigation drawer. The **Business Hubs** view is displayed.
2. Click the **More options** (![](../../../../../.gitbook/assets/unnamed_32.png)) icon on the corresponding business hub card. A drop-down list is displayed.
...
1. Click the **More options** (![](../../../../../.gitbook/assets/unnamed_33.png)) icon of the corresponding user. A drop-down list is displayed.
...
The next step is [4. Connect your app’s user account to the business hub](connect-a-business-hub-for-discord.md#id-4.-connect-your-apps-user-account-to-the-business-hub).
