---
description: "This article describes how to connect a business hub to centrally manage the users of Massive.io from Cerby."
intercom_id: 10315402
---
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of Massive.io.
...
This article provides instructions on how to connect a business hub for Massive.io. For other app-specific articles and videos, review the [Connecting your business hubs](https://help.cerby.com/en/collections/10289415-connecting-your-apps) collection in the Cerby Help Center.
...
To connect a business hub for Massive.io, you must complete the following main steps from the Cerby web app dashboard:
  ...
  1. [Add a business hub and connect it to Massive.io](connect-a-business-hub-for-massive-io.md#id-1.-add-a-business-hub-and-connect-it-to-massive.io)[ ](https://help.cerby.com/en/articles/9046120-connect-an-app#h_039a665169)
...
### 1\. Add a business hub and connect it to Massive.io

To add a business hub and connect it to Massive.io, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **Massive.io Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Business ID:** It is the unique identifier of your organization in Massive.io. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-massive-io.md#requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-massive-io.md#requirements) section.
...
To connect your Massive.io user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left navigation drawer. The **Accounts** view is displayed.
  2. Click the **Log in** button of the corresponding Massive.io Hub account card. The **Connect your Massive.io Hub Account** dialog box is displayed.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-massive-io.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-massive-io.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-massive-io.md#exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in Massive.io.
