...
​**IMPORTANT:** The **Single sign-on (SSO)** option is not supported for Cross River Bank Hub.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-cross-river-bank.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-cross-river-bank.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-cross-river-bank.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-cross-river-bank.md#exempt-unmatched-users)
