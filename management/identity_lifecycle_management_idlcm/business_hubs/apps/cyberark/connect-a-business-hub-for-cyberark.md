---
description: "This article describes how to connect a business hub to centrally manage the users of CyberArk from Cerby."
intercom_id: 13294687
---

# Connect a business hub for CyberArk
...
As a user with any workspace role in Cerby, except **Guest User** and **Login-Only** , you can connect a business hub integration to centrally manage the users of CyberArk.
...
**NOTE:** The automated task to add users is not currently supported for this business hub.


{% endhint %}

This article provides instructions on how to connect a business hub for CyberArk. For other app-specific articles and videos, review the [Connecting business hubs for your apps](https://help.cerby.com/en/collections/10289415-connecting-your-apps) and [Connecting business hubs for your paid social apps](https://help.cerby.com/en/collections/12330234-connecting-business-hubs-for-your-paid-social-apps) collections in the Cerby Help Center.
...
To connect a business hub for CyberArk, you must complete the following main steps from the Cerby web app dashboard:

  1. [Add a business hub and connect it to CyberArk](connect-a-business-hub-for-cyberark.md#id-1.-add-a-business-hub-and-connect-it-to-cyberark)
  2. [Check for updates to import users and roles to Cerby](connect-a-business-hub-for-cyberark.md#id-2.-check-for-updates-to-import-users-and-roles-to-cerby)
  3. [Connect your CyberArk user account to the business hub](connect-a-business-hub-for-cyberark.md#id-3.-connect-your-cyberark-user-account-to-the-business-hub)
  4. [Manage unmatched users](connect-a-business-hub-for-cyberark.md#id-4.-manage-unmatched-users)

The following sections describe each main step.

### 1\. Add a business hub and connect it to CyberArk

To add a business hub and connect it to CyberArk, you must complete the following steps:
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  5. Select **CyberArk Hub** from the catalog. The **Enter app details** page is displayed on the wizard.
...
You must select one of the following methods:
  ...
  7. Click the **Next** button. The **Select automation account** page is displayed with a list of existing CyberArk accounts.
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-cyberark.md#requirements) section.
...
The next step is [3. Connect your CyberArk user account to the business hub](connect-a-business-hub-for-cyberark.md#id-3.-connect-your-cyberark-user-account-to-the-business-hub).

### 3\. Connect your CyberArk user account to the business hub

To connect your CyberArk user account to the business hub so Cerby can manage and protect it, you must complete the following steps:

  1. Select the **Accounts** option from the left menu. The **All accounts** page is displayed.
  2. Click the **Log in** button of the corresponding CyberArk Hub account card. The **Connect your CyberArk Hub Account** dialog box is displayed.
  3. Enter the login credentials of your **CyberArk** user account.
  4. Click the **Connect account** button. The dialog box closes, and a success message box and a new account card are displayed.

The next step is [4. Manage unmatched users](connect-a-business-hub-for-cyberark.md#id-4.-manage-unmatched-users).
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-cyberark.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-cyberark.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-cyberark.md#exempt-unmatched-users)
...
**IMPORTANT:** When removing an unmatched user, Cerby performs an automated task to revoke the user’s seat and permissions in CyberArk.
