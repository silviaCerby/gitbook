...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **Organization ID:** It is the unique identifier of your organization in Typeform. For instructions on how to find it, read the [Requirements](connect-a-business-hub-for-typeform.md#requirements) section.
  ...
  8. Select the automation account you have previously added to Cerby, as described in the [Requirements](connect-a-business-hub-for-typeform.md#requirements) section.
...
For unmatched users, you can perform one of the following actions:
  ...
  * [Match users](connect-a-business-hub-for-typeform.md#match-users)
  * [Remove unmatched users](connect-a-business-hub-for-typeform.md#remove-unmatched-users)
  * [Exempt unmatched users](connect-a-business-hub-for-typeform.md#exempt-unmatched-users)
