...
**NOTE:** Cerby recommends creating a dedicated account in Pinterest Business (not assigned to a specific user) to monitor the partner’s business center from Cerby. Preferably, set it up with a Cerby-managed email address and phone number.


{% endhint %}

After you add the native partner to Cerby, you can use our agent-based integration to sync and import your partner’s user data.
...
This article describes how to connect a Pinterest Business native partner to Cerby.
...
To connect a Pinterest Business native partner to Cerby, you and your partner must complete the following main steps:
  ...
  1. [Partner setup in Pinterest Business](connect-a-pinterest-business-native-partner-to-cerby.md#id-1.-partner-setup-in-pinterest-business)
  2. [Native partner connection in Cerby](connect-a-pinterest-business-native-partner-to-cerby.md#id-2.-native-partner-connection-in-cerby)
...
Now, your partner is done. The next step is [2. Native partner connection in Cerby](connect-a-pinterest-business-native-partner-to-cerby.md#id-2.-native-partner-connection-in-cerby) that you must complete using the Cerby web app.
...
You must complete the following steps in Cerby to connect with your Pinterest Business native partner:
  ...
  1. [Connect the native partner to Cerby](connect-a-pinterest-business-native-partner-to-cerby.md#id-1.-connect-the-native-partner-to-cerby)
  2. [Sync and review your partner’s users](connect-a-pinterest-business-native-partner-to-cerby.md#id-2.-sync-and-review-your-partners-users)
...
The next step is [2. Sync and review your partner’s users](connect-a-pinterest-business-native-partner-to-cerby.md#id-2.-sync-and-review-your-partners-users), which you must complete from the app details page in Cerby.
