...
To connect a business hub for Meta Business Manager, you must complete the following main steps in Meta and the Cerby web app dashboard:
  ...
  1. [Connect your Meta Business Manager to the Cerby Assets Manager app](connect-a-business-hub-for-meta-business-manager.md#id-1.-connect-your-meta-business-manager-to-the-global-assets-manager-app)
...
### 1\. Connect your Meta Business Manager to the Global Assets Manager app

To connect your Meta Business Manager to the Global Assets Manager app, you must complete the following steps:
...
​**NOTE:** If the **How Will You Work With Cerby, Inc.?** dialog box is displayed instead the **Request an app** dialog box, complete the following steps:
  ...
  7. Enter **1084910789409157** in the **App ID** field.
...
<img src="../../../../../../.gitbook/assets/AD_4nXfOxtp_tx3Qa6qXKLTNjmt0-MTrU6Gy6b2034a-1IqeaXFhaXEb5TibbbH23tX1nizu4O4CYH8uw58qOE7POt7mNTdSriqgz6RfaIOc4pdCcn3Ziee3AoCPBJbkMugbaUVxxt7dfw.png" alt="">

**Figure 1.** **System Users** page

  6. Note down the **ID** of the system user.
  7. Contact the Cerby Support team via email at [support@cerby.com](mailto:support@cerby.com) or through the help chat to let them know that you have requested access to the Global Assets Manager app. Also, you must share the system user **ID** with them.
...
**IMPORTANT:** Take the following into consideration:
  ...
  * You must wait until the Cerby Support team grants you access to the Global Assets Manager app to continue. On the **Apps** page, the Global Assets Manager app must change its status from “Request sent” to active with the “Cerby, Inc. owns this” message.
...
<img src="../../../../../../.gitbook/assets/AD_4nXc2RyJPo2_-crNzOV38LP1-aTgEf6ILd-xfKy_cV4vYAELtE8xWVsFKLDxAoUIl5fmBCnyK_O-4udUdo76hlIlbyK2fc63kjSl3-bRjMRgYDLneSQklTdkANiwmuCw50DJU9bMG.png" alt="">

**Figure 2.** **Select app** page of the **Generate token** wizard

  4. Select the **Global Assets Manager** option from the **Select app** drop-down menu.
...
​**TIP:** Select the **Don’t show this again** option to skip this step the next time you connect a new business hub.
  ...
  6. Enter and select your app information in the corresponding fields:
     ...
     * **App Id:** It is the ID of the Global Assets Manager app to which you requested access previously: **1084910789409157**.
...
To claim the **Owner** role for your business hub, you complete the following steps:
  ...
  1. Select the **Business Hubs** option from the left menu. The **Business Hubs** page is displayed.
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1376309103/ce732ce8cd0407784ebc8e5928e7/AD_4nXfXuUnOmShgtXpsfPrlbhMbcNpSpI92eb95e3OXYs1Tl1BP47ScdETDHa10Q_TK_dvriew4wnJpI53pK_eKPZ8sq8wIOsfTvi5rLw5nENnKnnqou616GGdsRt9vcfVIAEVmEdwHCQ?expires=1770876000&signature=e907a5ab129329e19069acc89592289c3d4ff00a1eb63237dffda1263f320595&req=dSMgEMp%2BlIBfWvMW3Hu4gcGgQkirFyPcBUjA8vXkcHkg5mkj8xVBSQDVzWuI%0AyQ%3D%3D%0A" alt="">) icon of the Meta Business card. A drop-down menu is displayed.
...
To view the status of the imported app members, you must complete the following steps:
  ...
  2. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1376309103/ce732ce8cd0407784ebc8e5928e7/AD_4nXfXuUnOmShgtXpsfPrlbhMbcNpSpI92eb95e3OXYs1Tl1BP47ScdETDHa10Q_TK_dvriew4wnJpI53pK_eKPZ8sq8wIOsfTvi5rLw5nENnKnnqou616GGdsRt9vcfVIAEVmEdwHCQ?expires=1770876000&signature=e907a5ab129329e19069acc89592289c3d4ff00a1eb63237dffda1263f320595&req=dSMgEMp%2BlIBfWvMW3Hu4gcGgQkirFyPcBUjA8vXkcHkg5mkj8xVBSQDVzWuI%0AyQ%3D%3D%0A" alt="">) icon of the corresponding business hub card. A drop-down menu is displayed.
...
{% endhint %}
  ...
  1. Click the **More options** (<img src="https://downloads.intercomcdn.com/i/o/pc0ldyqu/1376309103/ce732ce8cd0407784ebc8e5928e7/AD_4nXfXuUnOmShgtXpsfPrlbhMbcNpSpI92eb95e3OXYs1Tl1BP47ScdETDHa10Q_TK_dvriew4wnJpI53pK_eKPZ8sq8wIOsfTvi5rLw5nENnKnnqou616GGdsRt9vcfVIAEVmEdwHCQ?expires=1770876000&signature=e907a5ab129329e19069acc89592289c3d4ff00a1eb63237dffda1263f320595&req=dSMgEMp%2BlIBfWvMW3Hu4gcGgQkirFyPcBUjA8vXkcHkg5mkj8xVBSQDVzWuI%0AyQ%3D%3D%0A" alt="">) icon of the corresponding user. A drop-down menu is displayed.
