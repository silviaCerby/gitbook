...
To create a new entry in Devolutions to extend your account, you must complete the following steps using RDM:
  ...
  4. Select the **Cerby** <img src="../../../../.gitbook/assets/unnamed_43.png" alt=""> option. The **Credentials** window opens.
  ...
  6. Log in to Cerby by completing the following steps:
    ...
    2. Click the three-dots (<img src="../../../../.gitbook/assets/unnamed_44.png" alt="">) icon on the right side of the **Account** field. The Cerby login page is displayed.
  ...
  **TIP:** You can use the search function to find and select the account entry you want to retrieve from Cerby.
  ...
  11. (Optional) Select the RDM folder where you want to locate the Cerby account:
    1. Click the three-dots (<img src="../../../../.gitbook/assets/unnamed_45.png" alt="">) icon on the right side of the **Folder** field. The **Folder** window opens.
