...
4. Click the **More options**(<img src="../../../.gitbook/assets/unnamed_41.png" alt="">) icon of the corresponding key. A drop-down list is displayed.
5. Select the **API key settings** option from the list. The API key details page is displayed.

{% hint style="danger" %}


**IMPORTANT:** Cerby does not display the API key because it was hashed and stored; you can only view its name, the dates when it was created and last used, and its expiration date. You can also [update its scopes](https://help.cerby.com/en/articles/9950704-update-the-scopes-of-an-api-key).
